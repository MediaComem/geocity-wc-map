 ...
 */
const Ir = window, Ua = Ir.ShadowRoot && (Ir.ShadyCSS === void 0 || Ir.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, su = Symbol(), th = /* @__PURE__ */ new WeakMap();
class kf {
  constructor(t, e, n) {
...
const yt = (i) => new kf(typeof i == "string" ? i : i + "", void 0, su), Gf = (i, t) => {
...
}, eh = Ua ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 */
var ko;
const Fr = window, ih = Fr.trustedTypes, $f = ih ? ih.emptyScript : "", nh = Fr.reactiveElementPolyfillSupport, aa = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? $f : null;
      break;
...
class vn extends HTMLElement {
  ...
  createRenderRoot() {
    ...
    return Gf(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
    var t;
 ...
 */
var $o;
const Dr = window, Fn = Dr.trustedTypes, sh = Fn ? Fn.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ei = `lit$${(Math.random() + "").slice(9)}$`, Wa = "?" + ei, Bf = `<${Wa}>`, Dn = document, Es = (i = "") => Dn.createComment(i), ws = (i) => i === null || typeof i != "object" && typeof i != "function", ou = Array.isArray, au = (i) => ou(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", ls = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, rh = /-->/g, oh = />/g, Fi = RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ah = /'/g, lh = /"/g, lu = /^(?:script|style|textarea|title)$/i, zf = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), Lt = zf(1), Si = Symbol.for("lit-noChange"), bt = Symbol.for("lit-nothing"), hh = /* @__PURE__ */ new WeakMap(), An = Dn.createTreeWalker(Dn, 129, null, !1), hu = (i, t) => {
  ...
  for (let l = 0; l < e; l++) {
    ...
    for (; f < h.length && (o.lastIndex = f, u = o.exec(h), u !== null); )
      f = o.lastIndex, o === ls ? u[1] === "!--" ? o = rh : u[1] !== void 0 ? o = oh : u[2] !== void 0 ? (lu.test(u[2]) && (s = RegExp("</" + u[2], "g")), o = Fi) : u[3] !== void 0 && (o = Fi) : o === Fi ? u[0] === ">" ? (o = s != null ? s : ls, d = -1) : u[1] === void 0 ? d = -2 : (d = o.lastIndex - u[2].length, c = u[1], o = u[3] === void 0 ? Fi : u[3] === '"' ? lh : ah) : o === lh || o === ah ? o = Fi : o === rh || o === oh ? o = ls : (o = Fi, s = void 0);
    const g = o === Fi && i[l + 1].startsWith("/>") ? " " : "";
    r += o === ls ? h + Bf : d >= 0 ? (n.push(c), h.slice(0, d) + "$lit$" + h.slice(d) + ei + g) : h + ei + (d === -2 ? (n.push(void 0), l) : g);
  }
...
class cu {
  ...
  v(t) {
    ...
    for (; h !== void 0; ) {
      if (a === h.index) {
        let c;
        h.type === 2 ? c = new Kn(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new gu(o, this, t)), this.u.push(c), h = s[++l];
      }
...
class Kn {
  ...
  _$AI(t, e = this) {
    t = ji(this, t, e), ws(t) ? t === bt || t == null || t === "" ? (this._$AH !== bt && this._$AR(), this._$AH = bt) : t !== this._$AH && t !== Si && this.g(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : au(t) ? this.k(t) : this.g(t);
  }
  O(t, e = this._$AB) {
  ...
  _$AC(t) {
    ...
    return e === void 0 && hh.set(t.strings, e = new Ss(t)), e;
  }
  k(t) {
    ...
    let n, s = 0;
    for (const r of t)
      s === e.length ? e.push(n = new Kn(this.O(Es()), this.O(Es()), this, this.options)) : n = e[s], n._$AI(r), s++;
...
const Zf = Fn ? Fn.emptyScript : "";
class du extends Zs {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== bt ? this.element.setAttribute(this.name, Zf) : this.element.removeAttribute(this.name);
  }
}
class fu extends Zs {
  constructor(t, e, n, s, r) {
...
const Vf = { P: "$lit$", A: ei, M: Wa, C: 1, L: hu, R: cu, D: au, V: ji, I: Kn, H: Zs, N: du, U: fu, B: uu, F: gu }, ch = Dr.litHtmlPolyfillSupport;
ch == null || ch(Ss, Kn), (($o = Dr.litHtmlVersions) !== null && $o !== void 0 ? $o : Dr.litHtmlVersions = []).push("2.5.0");
const mu = (i, t, e) => {
  var n, s;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Uf = (i, t) => t.kind === "method" && t.descriptor && !("value" in t.descriptor) ? { ...t, finisher(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Wf = ({ finisher: i, descriptor: t }) => (e, n) => {
  var s;
  if (n === void 0) {
...
let t0 = 0;
function rt(i) {
  return i.ol_uid || (i.ol_uid = String(++t0));
}
class dh extends ze {
  constructor(t, e, n) {
...
const Oe = s0, Ri = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", r0 = Ri.includes("firefox"), o0 = Ri.includes("safari") && !Ri.includes("chrom");
o0 && (Ri.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(Ri));
const a0 = Ri.includes("webkit") && !Ri.includes("edge"), l0 = Ri.includes("macintosh"), yu = typeof devicePixelRatio < "u" ? devicePixelRatio : 1, ja = typeof WorkerGlobalScope < "u" && typeof OffscreenCanvas < "u" && self instanceof WorkerGlobalScope, h0 = typeof Image < "u" && Image.prototype.decode, vu = function() {
  let i = !1;
  try {
...
function _0(i, t) {
  let e;
  return t === "bottom-left" ? e = go(i) : t === "bottom-right" ? e = mo(i) : t === "top-left" ? e = Pi(i) : t === "top-right" ? e = po(i) : X(!1, 13), e;
}
...
function vs(i, t, e) {
  const n = e || fe();
  return ie(i, t) ? (i[0] > t[0] ? n[0] = i[0] : n[0] = t[0], i[1] > t[1] ? n[1] = i[1] : n[1] = t[1], i[2] < t[2] ? n[2] = i[2] : n[2] = t[2], i[3] < t[3] ? n[3] = i[3] : n[3] = t[3]) : Us(n), n;
}
function Pi(i) {
  return [i[0], i[3]];
}
...
const w0 = /^#([a-f0-9]{3}|[a-f0-9]{4}(?:[a-f0-9]{2}){0,2})$/i, S0 = /^([a-z]*)$|^hsla?\(.*\)$/i;
function Tu(i) {
...
function Gr(i) {
  return Array.isArray(i) ? i : b0(i);
}
function L0(i) {
  let t, e, n, s, r;
  if (S0.exec(i) && (i = R0(i)), w0.exec(i)) {
    const o = i.length - 1;
    let a;
    o <= 4 ? a = 1 : a = 2;
    const l = o === 4 || o === 8;
    ...
    i.startsWith("rgba(") ? (r = i.slice(5, -1).split(",").map(Number), ph(r)) : i.startsWith("rgb(") ? (r = i.slice(4, -1).split(",").map(Number), r.push(1), ph(r)) : X(!1, 14);
  return r;
}
function ph(i) {
...
class P0 extends Xa {
  ...
  forEachFeatureAtCoordinate(t, e, n, s, r, o, a, l) {
    ...
    for (let x = 0; x < g.length; x++)
      for (let C = p - 1; C >= 0; --C) {
        ...
        if (w.hasRenderer() && Qa(E, c) && a.call(l, w)) {
  ...
  scheduleExpireIconCache(t) {
    $r.canExpireCache() && t.postRenderFunctions.push(O0);
  }
}
function O0(i, t) {
  $r.expire();
...
const Du = F0, pr = "ol-hidden", D0 = "ol-selectable", qn = "ol-unselectable", yh = "ol-unsupported", yo = "ol-control", vh = "ol-collapsed", k0 = new RegExp(
  [
...
const Bu = "10px sans-serif", si = "#000", Vr = "round", Ls = [], Ts = 0, $n = "round", Is = 10, As = "#000", Ps = "center", Ur = "middle", $i = [0, 0, 0, 0], Os = 1, qe = new Ce();
let xn = null, fa;
...
`)) ? (Vs(ga), xn = null, fa = void 0, qe.set(f, 100)) : (qe.set(f, qe.get(f) + 1, !0), h = !1));
    }
...
function U0(i, t, e, n, s, r, o, a, l, h, c) {
  i.save(), e !== 1 && (i.globalAlpha *= e), t && i.setTransform.apply(i, t), n.contextInstructions ? (i.translate(l, h), i.scale(c[0], c[1]), W0(n, i)) : c[0] < 0 || c[1] < 0 ? (i.translate(l, h), i.scale(c[0], c[1]), i.drawImage(
    n,
    s,
    r,
    o,
...
class H0 extends N0 {
  ...
  renderFrame(t) {
    ...
    B0(this.element_, this.children_), this.dispatchRenderEvent(Ei.POSTCOMPOSE, t), this.renderedVisible_ || (this.element_.style.display = "", this.renderedVisible_ = !0), this.scheduleExpireIconCache(t);
  }
}
const X0 = H0;
class vi extends ze {
...
class el extends Au {
  constructor(t) {
    ...
    delete e.layers;
    let n = t.layers;
    super(e), this.on, this.once, this.un, this.layersListenerKeys_ = [], this.listenerKeys_ = {}, this.addChangeListener(Vo.LAYERS, this.handleLayersChanged_), n ? Array.isArray(n) ? n = new Oe(n.slice(), { unique: !0 }) : X(typeof n.getArray == "function", 43) : n = new Oe(void 0, { unique: !0 }), this.setLayers(n);
  }
  handleLayerChange_() {
    this.changed();
  }
...
const nl = sg, Ws = 6378137, Sn = Math.PI * Ws, rg = [-Sn, -Sn, Sn, Sn], og = [-180, -85, 180, 85], _r = Ws * Math.log(Math.tan(Math.PI / 2));
class gn extends nl {
  constructor(t) {
    super({
      code: t,
...
const hg = 6378137, Eh = [-180, -90, 180, 90], cg = Math.PI * hg / 180;
class Di extends nl {
  constructor(t, e) {
    super({
      code: t,
...
function Wu(i) {
  dg(i.getCode(), i), zn(i, i, sl);
}
function gg(i) {
  i.forEach(Wu);
}
function q(i) {
  return typeof i == "string" ? ug(i) : i || null;
}
function Xr(i, t, e, n) {
  i = q(i);
  let s;
...
function Og(i, t, e, n, s, r, o, a, l, h, c) {
  c = c || [NaN, NaN];
  for (let u = 0, d = e.length; u < d; ++u) {
    const f = e[u];
    h = fl(
...
function ml(i, t, e, n, s, r, o) {
  ...
  for (; h.length > 0; ) {
    ...
    for (let y = d + n; y < u; y += n) {
      const v = i[y], x = i[y + 1], C = M0(v, x, g, m, p, _);
      C > f && (c = y, f = C);
    }
...
function Mo(i, t, e, n, s) {
  ...
  return ie(s, r) ? xi(s, r) || r[0] >= s[0] && r[2] <= s[2] || r[1] >= s[1] && r[3] <= s[3] ? !0 : id(
    i,
    t,
    e,
    n,
...
function Ma(i, t, e, n, s) {
  ...
  for (let r = 0, o = e.length; r < o; ++r) {
    ...
    (r === 0 ? s && l || !s && !l : s && !l || !s && l) && Wg(i, t, a, n), t = a;
  }
  return t;
}
...
class Zn extends on {
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), Ma(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, Fs(e, 0, this.ends_, this.stride);
  }
  getEnds() {
    return this.ends_;
  }
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      od(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = Ma(
...
class Yg extends Ce {
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = ol(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && Uu(), t.center && (t.center = Je(t.center, this.projection_)), t.extent && (t.extent = Bi(t.extent, this.projection_)), this.applyOptions_(t);
  }
  applyOptions_(t) {
    const e = Object.assign({}, t);
    for (const a in Ee)
    ...
    const s = jg(t), r = n.constraint, o = qg(t);
    this.constraints_ = {
      center: s,
      resolution: r,
      rotation: o
  ...
  animateInternal(t) {
    ...
    for (; s < e; ++s) {
      ...
      Jg(u) ? u.complete = !0 : r += u.duration, h.push(u);
    }
  ...
  calculateExtentInternal(t) {
    ...
    return X(s !== void 0, 3), ua(e, n, s, t);
  }
  getMaxResolution() {
  ...
  fit(t, e) {
    ...
    if (X(
      ...
      n = Fh(s), n.rotate(this.getRotation(), Li(s));
    } else
      n = t;
...
function Kg(i) {
  ...
  if (!h && !m && d.isGlobal() && (g = !1, m = f), i.resolutions !== void 0) {
    ...
    e = p[o], n = p[a] !== void 0 ? p[a] : p[p.length - 1], i.constrainResolution ? t = xg(
      p,
      c,
      !g && m,
      u
    ...
    const _ = (f ? Math.max(mt(f), Ge(f)) : 360 * Bn.degrees / d.getMetersPerUnit()) / il / Math.pow(2, Uo), y = _ / Math.pow(2, 28 - Uo);
    ...
    ), n = e / Math.pow(l, a - o), i.constrainResolution ? t = Cg(
      l,
      e,
      n,
      c,
...
function qg(i) {
  if (i.enableRotation !== void 0 ? i.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? Eg() : e === !1 ? Ih : typeof e == "number" ? Mg(e) : Ih;
  } else
    return hl;
}
function Jg(i) {
...
class t1 extends kt {
  constructor(t) {
    ...
    const h = e + " " + qn + " " + yo + (this.collapsed_ && this.collapsible_ ? " " + vh : "") + (this.collapsible_ ? "" : " ol-uncollapsible"), c = this.element;
...
class i1 extends kt {
  constructor(t) {
    ...
    const a = e + " " + qn + " " + yo, l = this.element;
...
class s1 extends kt {
  constructor(t) {
    ...
    const d = e + " " + qn + " " + yo, f = this.element;
...
function r1(i) {
  i = i || {};
  const t = new Oe();
  return (i.zoom !== void 0 ? i.zoom : !0) && t.push(new ad(i.zoomOptions)), (i.rotate !== void 0 ? i.rotate : !0) && t.push(new n1(i.rotateOptions)), (i.attribution !== void 0 ? i.attribution : !0) && t.push(new e1(i.attributionOptions)), t;
}
const Dh = {
  ACTIVE: "active"
};
...
const u1 = function(i) {
  ...
  return i.map.getTargetElement().hasAttribute("tabindex") ? d1(i) : !0;
}, f1 = Rs, hd = function(i) {
  const t = i.originalEvent;
...
class p1 extends Xs {
  constructor(t) {
    ...
    const e = t.condition ? t.condition : Ea(cd, m1);
    this.condition_ = t.onFocusOnly ? Ea(ld, e) : e, this.noKinetic_ = !1;
  }
  handleDragEvent(t) {
    ...
    if (e.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(n[0], n[1]), this.lastCentroid) {
        ...
        Ou(s, o.getResolution()), tl(s, o.getRotation()), o.adjustCenterInternal(s);
      }
    } else
...
class y1 extends Xs {
  constructor(t) {
    t = t || {}, super({
      stopDown: lo
    }), this.condition_ = t.condition ? t.condition : u1, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  handleDragEvent(t) {
    if (!Ho(t))
      return;
...
class w1 extends E1 {
  constructor(t) {
    t = t || {};
    const e = t.condition ? t.condition : g1;
    super({
      condition: e,
  ...
  handleEvent(t) {
    ...
    if (t.type == H.KEYDOWN) {
      ...
      if (this.condition_(t) && (s == ki.DOWN || s == ki.LEFT || s == ki.RIGHT || s == ki.UP)) {
        ...
        const c = [l, h];
        tl(c, o.getRotation()), a1(o, c, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class P1 extends Hs {
  constructor(t) {
    ...
    const e = t.condition ? t.condition : f1;
    this.condition_ = t.onFocusOnly ? Ea(ld, e) : e, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300;
  }
  endInteraction_() {
  ...
  handleEvent(t) {
    ...
    let r;
    if (t.type == H.WHEEL && (r = s.deltaY, r0 && s.deltaMode === WheelEvent.DOM_DELTA_PIXEL && (r /= yu), s.deltaMode === WheelEvent.DOM_DELTA_LINE && (r *= 40)), r === 0)
      return !1;
    this.lastDelta_ = r;
    const o = Date.now();
...
function G1(i) {
  i = i || {};
  const t = new Oe(), e = new A1(-5e-3, 0.05, 100);
  return (i.altShiftDragRotate !== void 0 ? i.altShiftDragRotate : !0) && t.push(new v1()), (i.doubleClickZoom !== void 0 ? i.doubleClickZoom : !0) && t.push(
    new h1({
      delta: i.zoomDelta,
  ...
  ), (i.pinchRotate !== void 0 ? i.pinchRotate : !0) && t.push(new F1()), (i.pinchZoom !== void 0 ? i.pinchZoom : !0) && t.push(
    new k1({
      duration: i.zoomDuration
    })
  ), (i.keyboard !== void 0 ? i.keyboard : !0) && (t.push(new b1()), t.push(
    new T1({
      delta: i.zoomDelta,
      duration: i.zoomDuration
    })
...
class B1 extends Ce {
  ...
  handleMapBrowserEvent(t) {
    ...
    if (n === ma.POINTERDOWN || n === H.WHEEL || n === H.KEYDOWN) {
  ...
  handleTargetChanged_() {
    ...
    if (!t)
      ...
      t.appendChild(this.viewport_), this.renderer_ || (this.renderer_ = new X0(this)), this.mapBrowserEventHandler_ = new q0(
        this,
        this.moveTolerance_
      );
      for (const s in Mt)
  ...
  renderFrame_(t) {
    ...
    ), s && (!this.previousExtent_ || !Ja(this.previousExtent_) && !bs(r.extent, this.previousExtent_)) && (this.dispatchEvent(
      new Cn(Qe.MOVESTART, this, s)
    ), this.previousExtent_ = Us(this.previousExtent_)), this.previousExtent_ && !r.viewHints[Zt.ANIMATING] && !r.viewHints[Zt.INTERACTING] && !bs(r.extent, this.previousExtent_) && (this.dispatchEvent(
...
class xl extends Ce {
  ...
  setStyle(t) {
    this.style_ = t, this.styleFunction_ = t ? V1(t) : void 0, this.changed();
  }
  setId(t) {
...
class Rl {
  constructor(t) {
    t = t || {}, this.font_ = t.font, this.rotation_ = t.rotation, this.rotateWithView_ = t.rotateWithView, this.scale_ = t.scale, this.scaleArray_ = ce(t.scale !== void 0 ? t.scale : 1), this.text_ = t.text, this.textAlign_ = t.textAlign, this.justify_ = t.justify, this.textBaseline_ = t.textBaseline, this.fill_ = t.fill !== void 0 ? t.fill : new Yt({ color: K1 }), this.maxAngle_ = t.maxAngle !== void 0 ? t.maxAngle : Math.PI / 4, this.placement_ = t.placement !== void 0 ? t.placement : "point", this.overflow_ = !!t.overflow, this.stroke_ = t.stroke !== void 0 ? t.stroke : null, this.offsetX_ = t.offsetX !== void 0 ? t.offsetX : 0, this.offsetY_ = t.offsetY !== void 0 ? t.offsetY : 0, this.backgroundFill_ = t.backgroundFill ? t.backgroundFill : null, this.backgroundStroke_ = t.backgroundStroke ? t.backgroundStroke : null, this.padding_ = t.padding === void 0 ? null : t.padding;
  }
  clone() {
    const t = this.getScale();
    return new Rl({
...
class vd {
  ...
  _chooseSubtree(t, e, n, s) {
    for (; s.push(e), !(e.leaf || s.length - 1 === n); ) {
      ...
      for (let l = 0; l < e.children.length; l++) {
        const h = e.children[l], c = jo(h), u = im(t, h) - c;
  ...
  _chooseSplitIndex(t, e, n) {
    let s, r = 1 / 0, o = 1 / 0;
    for (let a = e; a <= n - e; a++) {
      const l = fs(t, 0, a, this.toBBox), h = fs(t, a, n, this.toBBox), c = nm(l, h), u = jo(l) + jo(h);
      c < r ? (r = c, s = a, o = u < o ? u : o) : c === r && u < o && (o = u, s = a);
    }
    return s || n - e;
  }
  _chooseSplitAxis(t, e, n) {
    const s = t.leaf ? this.compareMinX : tm, r = t.leaf ? this.compareMinY : em, o = this._allDistMargin(t, e, n, s), a = this._allDistMargin(t, e, n, r);
...
function xd(i, t, e) {
  ...
  let s = !0, r = !1, o = !1;
  const a = [
    kr(n, H.LOAD, function() {
      o = !0, r || t();
    })
  ];
  return n.src && h0 ? (r = !0, n.decode().then(function() {
    s && t();
  }).catch(function(l) {
    s && (o ? t() : e());
  })) : a.push(kr(n, H.ERROR, e)), function() {
    s = !1, a.forEach(pt);
  };
}
let cs = null;
...
function rm(i, t, e, n, s, r) {
  let o = $r.get(t, n, r);
  return o || (o = new sm(i, t, e, n, s, r), $r.set(t, n, r, o)), o;
}
class bl extends pd {
  constructor(t) {
    t = t || {};
    ...
    this.color_ = t.color !== void 0 ? Gr(t.color) : null, this.iconImage_ = rm(
      o,
      a,
...
class lm extends _o {
  ...
  setStyle(t) {
    ...
    if (t === void 0)
      ...
      e = Bh(t);
    this.style_ = e, this.styleFunction_ = t === null ? void 0 : Y1(this.style_), this.changed();
  }
}
const hm = lm, Ys = {
  BEGIN_GEOMETRY: 0,
  ...
  SET_STROKE_STYLE: 11,
  STROKE: 12
}, Mr = [Ys.FILL], Mi = [Ys.STROKE], Zi = [Ys.BEGIN_PATH], Zh = [Ys.CLOSE_PATH], V = Ys;
class cm {
  drawCustom(t, e, n, s) {
  }
  drawGeometry(t) {
...
class um extends Cd {
  ...
  appendFlatLineCoordinates(t, e, n, s, r, o) {
    ...
    let f = !0, g, m, p;
    for (g = e + s; g < n; g += s)
      d[0] = t[g], d[1] = t[g + 1], p = ha(h, d), p !== m ? (f && (a[l++] = c, a[l++] = u, f = !1), a[l++] = d[0], a[l++] = d[1]) : p === Ft.INTERSECTING ? (a[l++] = d[0], a[l++] = d[1], f = !1) : f = !0, c = d[0], u = d[1], m = p;
  ...
  reverseHitDetectionInstructions() {
    ...
    let s, r, o = -1;
    for (e = 0; e < n; ++e)
      s = t[e], r = s[0], r == V.END_GEOMETRY ? o = e : r == V.BEGIN_GEOMETRY && (s[2] = e, jf(this.hitDetectionInstructions, o, e), o = -1);
  }
  setFillStrokeStyle(t, e) {
    const n = this.state;
    if (t) {
...
class ym extends js {
  ...
  setTextStyle(t, e) {
    ...
    if (!t)
      ...
      n.overflow = t.getOverflow(), n.font = l, n.maxAngle = t.getMaxAngle(), n.placement = t.getPlacement(), n.textAlign = t.getTextAlign(), n.justify = t.getJustify(), n.textBaseline = t.getTextBaseline() || Ur, n.backgroundFill = t.getBackgroundFill(), n.backgroundStroke = t.getBackgroundStroke(), n.padding = t.getPadding() || $i, n.scale = h === void 0 ? [1, 1] : h;
...
const Md = wm;
function Sm(i, t, e, n, s, r, o, a, l, h, c, u) {
...
function Xh(i, t) {
  return (t === "start" || t === "end") && !Rm.test(i) && (t = t === "start" ? "left" : "right"), Cs[t];
}
function bm(i, t, e) {
  return e > 0 && i.push(`
`, ""), i.push(t, ""), i;
...
class Lm {
  ...
  createLabel(t, e, n, s) {
    ...
    const o = s ? this.strokeStates[s] : null, a = n ? this.fillStates[n] : null, l = this.textStates[e], h = this.pixelRatio, c = [
      l.scale[0] * h,
      l.scale[1] * h
    ], u = Array.isArray(t), d = l.justify ? Cs[l.justify] : Xh(
      Array.isArray(t) ? t[0] : t,
      l.textAlign || Ps
    ), f = s && o.lineWidth ? o.lineWidth : 0, g = u ? t : t.split(`
`).reduce(bm, []), { width: m, height: p, widths: _, heights: y, lineWidths: v } = V0(
      l,
      g
...
`) {
  ...
  drawLabelWithPointPlacement_(t, e, n, s) {
    const r = this.textStates[e], o = this.createLabel(t, e, s, n), a = this.strokeStates[n], l = this.pixelRatio, h = Xh(
      Array.isArray(t) ? t[0] : t,
      r.textAlign || Ps
    ), c = Cs[r.textBaseline || Ur], u = a && a.lineWidth ? a.lineWidth : 0, d = o.width / l - 2 * r.scale[0], f = h * d + 2 * (0.5 - h) * u, g = c * o.height / l + 2 * (0.5 - c) * u;
    return {
      label: o,
      anchorX: f,
      anchorY: g
  ...
  execute_(t, e, n, s, r, o, a, l) {
    ...
    for (; c < u; ) {
      ...
      switch (b[0]) {
        ...
        case V.CIRCLE:
          d = b[1];
          const at = h[d], ft = h[d + 1], hi = h[d + 2], Ie = h[d + 3], $t = hi - at, Ue = Ie - ft, ln = Math.sqrt($t * $t + Ue * Ue);
        ...
        case V.DRAW_IMAGE:
            ...
            if (l) {
              ...
              if (me === "obstacle") {
                ...
                if (Me) {
                  ...
                  if (pe = Me[he], delete Me[he], He = Hh(pe), l.collides(He))
                    continue;
                }
          ...
          break;
        case V.DRAW_CHARS:
          const cr = b[1], Ht = b[2], No = b[3], Nf = b[4];
          R = b[5];
          const Ff = b[6], jl = b[7], Kl = b[8];
          w = b[9];
          const Fo = b[10];
          C = b[11], E = b[12];
          const ql = [
            b[13],
            b[13]
          ], Do = this.textStates[E], rs = Do.font, os = [
            Do.scale[0] * jl,
            Do.scale[1] * jl
          ];
          let as;
          rs in this.widths_ ? as = this.widths_[rs] : (as = {}, this.widths_[rs] = as);
          const Jl = md(h, cr, Ht, 2), Ql = Math.abs(os[0]) * Ch(rs, C, as);
          if (Nf || Ql <= Jl) {
            const le = this.textStates[E].textAlign, fn = (Jl - Ql) * Cs[le], pe = Sm(
              h,
              cr,
              Ht,
              2,
              ...
              if (pe) {
                ...
                if (w)
                  for (he = 0, ur = pe.length; he < ur; ++he) {
                    _e = pe[he], dr = _e[4], Qt = this.createLabel(dr, E, "", w), g = _e[2] + (os[0] < 0 ? -Fo : Fo), m = No * Qt.height + (0.5 - No) * 2 * Fo * os[1] / os[0] - Kl;
                ...
                if (R)
                  for (he = 0, ur = pe.length; he < ur; ++he) {
                    _e = pe[he], dr = _e[4], Qt = this.createLabel(dr, E, R, ""), g = _e[2], m = No * Qt.height - Kl;
                    const Xe = this.calculateImageOrLabelDimensions_(
                      Qt.width,
                      Qt.height,
                      _e[0],
                ...
                l && l.load(He.map(Hh));
                for (let Xe = 0, Df = He.length; Xe < Df; ++Xe)
...
const Tm = Lm, qo = ["Polygon", "Circle", "LineString", "Image", "Text", "Default"];
class Im {
  constructor(t, e, n, s, r, o) {
...
class Hm extends Md {
  ...
  releaseCompositionContext_() {
    if (this.opacity_ !== 1) {
      ...
      this.context.globalAlpha = this.opacity_, this.context.drawImage(this.compositionContext_.canvas, 0, 0), this.context.globalAlpha = t, Gu(this.compositionContext_), Wh.push(this.compositionContext_.canvas), this.compositionContext_ = null;
    }
  }
  renderDeclutter(t) {
  ...
  renderFrame(t, e) {
    ...
    f0(this.pixelTransform, 1 / n, 1 / n), Ka(this.inversePixelTransform, this.pixelTransform);
  ...
  prepareFrame(t) {
    ...
    let E;
    this.getLayer().getDeclutter() && (E = new Uh(
      Ra(u, d),
      _,
      u,
      d
    ...
    }.bind(this), Z = Yu(_), L = n.getFeaturesInExtent(Z);
    m && L.sort(m);
    for (let N = 0, D = L.length; N < D; ++N)
      k(L[N]);
    this.renderedFeatures_ = L, this.ready = A;
    const G = C.finish(), dt = new Yh(
      _,
      u,
      d,
      n.getOverlaps(),
    ...
    return E && (this.declutterExecutorGroup = new Yh(
      _,
      u,
      d,
      n.getOverlaps(),
...
function Qm(i, t, e, n, s, r, o) {
  ...
  a.open(
    ...
    !0
  ), t.getType() == "arraybuffer" && (a.responseType = "arraybuffer"), a.withCredentials = Jm, a.onload = function(l) {
...
class t2 extends bd {
  constructor(t) {
    ...
    }), this.on, this.once, this.un, this.loader_ = qi, this.format_ = t.format, this.overlaps_ = t.overlaps === void 0 ? !0 : t.overlaps, this.url_ = t.url, t.loader !== void 0 ? this.loader_ = t.loader : this.url_ !== void 0 && (X(this.format_, 7), this.loader_ = Jh(
      this.url_,
      this.format_
  ...
  setUrl(t) {
    X(this.format_, 7), this.url_ = t, this.setLoader(Jh(t, this.format_));
  }
}
const Qn = t2;
function e2(i) {
...
class n2 extends Td {
  ...
  handleImageError_() {
    this.state = B.ERROR, this.unlistenImage_(), this.image_ = s2(), this.changed();
  }
  handleImageLoad_() {
    const t = this.image_;
  ...
  load() {
    this.state == B.ERROR && (this.state = B.IDLE, this.image_ = new Image(), this.crossOrigin_ !== null && (this.image_.crossOrigin = this.crossOrigin_)), this.state == B.IDLE && (this.state = B.LOADING, this.changed(), this.tileLoadFunction_(this, this.src_), this.unlisten_ = xd(
      this.image_,
      this.handleImageLoad_.bind(this),
      this.handleImageError_.bind(this)
    ));
...
class d2 extends l2 {
  ...
  pruneExceptNewestZ() {
    if (this.getCount() === 0)
      return;
    const t = this.peekFirstKey(), n = h2(t)[0];
    this.forEach(
      function(s) {
...
class f2 extends kt {
  constructor(t) {
    ...
    this.button_ = document.createElement("button"), this.button_.title = s, this.button_.setAttribute("type", "button"), this.button_.appendChild(this.labelNode_), this.button_.addEventListener(
      ...
      this.handleClick_.bind(this),
      !1
    ), this.setClassName_(this.button_, this.isInFullscreen_), this.element.className = `${this.cssClassName_} ${qn} ${yo}`, this.element.appendChild(this.button_);
  }
  handleClick_(t) {
  ...
  handleFullScreen_() {
    ...
    if (!!ic(e))
      if (nc(e))
        ...
        let n;
        this.source_ ? n = typeof this.source_ == "string" ? e.getElementById(this.source_) : this.source_ : n = t.getTargetElement(), this.keys_ ? g2(n) : Fd(n);
      }
  }
...
const p2 = f2, Qo = "units", _2 = [1, 2, 5], us = 25.4 / 0.28;
class y2 extends kt {
  constructor(t) {
    t = t || {};
  ...
  updateElement_() {
    ...
    for (; ; ) {
      ...
      if (d = _2[(u % 3 + 3) % 3] * v, f = Math.round(d / o), isNaN(f)) {
...
const v2 = y2, x2 = 0.5, C2 = 10, sc = 0.25;
class M2 {
  constructor(t, e, n, s, r, o) {
    ...
    const h = Pi(n), c = po(n), u = mo(n), d = go(n), f = this.transformInv_(h), g = this.transformInv_(c), m = this.transformInv_(u), p = this.transformInv_(d), _ = C2 + (o ? Math.max(
      0,
      Math.ceil(
        Math.log2(
          ca(n) / (o * o * 256 * 256)
...
function R2(i, t, e, n, s, r, o, a, l, h, c, u) {
  const d = ge(
    Math.round(e * i),
    Math.round(e * t),
    Dd
...
class b2 extends Td {
  constructor(t, e, n, s, r, o, a, l, h, c, u, d) {
    ...
    const x = c !== void 0 ? c : x2;
    if (this.triangulation_ = new E2(
      t,
      n,
      p,
      m,
...
class T2 {
  constructor(t) {
    ...
    n !== void 0 && !this.origin_ && !this.origins_ && (this.origin_ = Pi(n)), X(
      ...
      18
    ), this.tileSizes_ = null, t.tileSizes !== void 0 && (this.tileSizes_ = t.tileSizes, X(this.tileSizes_.length == this.resolutions_.length, 19)), this.tileSize_ = t.tileSize !== void 0 ? t.tileSize : this.tileSizes_ ? null : il, X(
  ...
  getTileCoordForXYAndResolution_(t, e, n, s, r) {
    ...
    return s ? (c = mr(c, pi) - 1, u = mr(u, pi) - 1) : (c = gr(c, pi), u = gr(u, pi)), Qh(o, c, u, r);
  }
  getTileCoordForXYAndZ_(t, e, n, s, r) {
    ...
    return s ? (h = mr(h, pi) - 1, c = mr(c, pi) - 1) : (h = gr(h, pi), c = gr(c, pi)), Qh(n, h, c, r);
  }
...
function Gd(i) {
  ...
  return t || (t = O2(i), i.setDefaultTileGrid(t)), t;
}
function I2(i, t, e) {
...
function P2(i, t, e, n) {
  t = t !== void 0 ? t : ng, e = ce(e !== void 0 ? e : il);
  const s = Ge(i), r = mt(i);
...
class N2 extends bd {
  ...
  forEachLoadedTile(t, e, n, s) {
    ...
    for (let c = n.minX; c <= n.maxX; ++c)
      for (let u = n.minY; u <= n.maxY; ++u)
        l = wo(e, c, u), h = !1, r.containsKey(l) && (a = r.get(l), h = a.getState() === B.LOADED, h && (h = s(a) !== !1)), h || (o = !1);
    return o;
  }
  ...
  getTilePixelSize(t, e, n) {
    ...
    return r == 1 ? o : $1(o, r, this.tmpSize);
  }
  getTileCoordForTileUrlFunction(t, e) {
    e = e !== void 0 ? e : this.getProjection();
    const n = this.getTileGridForProjection(e);
    return this.getWrapX() && e.isGlobal() && (t = I2(n, t, e)), u2(t, n) ? t : null;
  }
  clear() {
...
class Ll extends D2 {
  ...
  handleTileChange(t) {
    ...
    let r;
    s == B.LOADING ? (this.tileLoadingKeys_[n] = !0, r = ia.TILELOADSTART) : n in this.tileLoadingKeys_ && (delete this.tileLoadingKeys_[n], r = s == B.ERROR ? ia.TILELOADERROR : s == B.LOADED ? ia.TILELOADEND : void 0), r != null && this.dispatchEvent(new F2(r, e));
  }
  ...
  setUrls(t) {
    ...
    const e = t.join(`
`);
    this.generateTileUrlFunction_ ? this.setTileUrlFunction(G2(t, this.tileGrid), e) : this.setKey(e);
  }
...
class B2 extends $2 {
  constructor(t) {
    super({
      ...
      state: t.state,
      tileGrid: t.tileGrid,
      tileLoadFunction: t.tileLoadFunction ? t.tileLoadFunction : z2,
      tilePixelRatio: t.tilePixelRatio,
...
class X2 extends Md {
  ...
  getData(t) {
    ...
    for (let d = c.getZForResolution(l.resolution); d >= c.getMinZoom(); --d) {
      ...
      if (!(g instanceof Id || g instanceof ba) || g instanceof ba && g.getState() === B.EMPTY)
        return null;
  ...
  renderFrame(t, e) {
      ...
      for (let at = A.minY; at <= A.maxY; ++at) {
        ...
        if (this.isDrawableTile(ft)) {
          ...
          if (ft.getState() == B.LOADED) {
            ...
            let Ue = ft.inTransition($t);
            Ue && n.opacity !== 1 && (ft.endTransition($t), Ue = !1), !this.newTiles_ && (Ue || !this.renderedTiles.includes(ft)) && (this.newTiles_ = !0);
          }
    ...
    const D = xu(this.pixelTransform);
    this.useContainer(e, D, this.getBackground(t));
    const I = this.context, Q = I.canvas;
    Ka(this.inversePixelTransform, this.pixelTransform), bi(
      this.tempTransform,
      v / 2,
      x / 2,
      N,
    ...
    for (let ae = Ct.length - 1; ae >= 0; --ae) {
      const at = Ct[ae], ft = u.getTilePixelSize(
        ...
        h,
        r
      ), Ie = f.getResolution(at) / m, $t = ft[0] * Ie * N, Ue = ft[1] * Ie * N, ln = f.getTileCoordForCoordAndZ(
        Pi(R),
        at
      ...
      for (const ss in ci) {
        const ui = ci[ss], ar = ui.tileCoord, lr = ln[1] - ar[1], hr = Math.round(hn[0] - (lr - 1) * $t), cn = ln[2] - ar[2], Oo = Math.round(hn[1] - (cn - 1) * Ue), Jt = Math.round(hn[0] - lr * $t), me = Math.round(hn[1] - cn * Ue), Me = hr - Jt, We = Oo - me, un = g === at, Ni = un && ui.getAlpha(rt(this), t.time) !== 1;
        let di = !1;
        if (!Ni)
          if (_t) {
...
class Kr extends on {
  ...
  getCoordinateAtM(t, e, n) {
    return this.layout != "XYM" && this.layout != "XYZM" || this.flatCoordinates.length === 0 ? null : (e = e !== void 0 ? e : !1, n = n !== void 0 ? n : !1, X1(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
...
class qr extends on {
  ...
  closestPointXY(t, e, n, s) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), Og(
      this.getOrientedFlatCoordinates(),
      0,
      this.endss_,
      this.stride,
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      const t = this.flatCoordinates;
      Hg(t, 0, this.endss_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = Nh(
        this.orientedFlatCoordinates_,
        0,
        this.endss_,
        this.stride
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: xp } = Vf, Sr = (i, t) => t === void 0 ? (i == null ? void 0 : i._$litType$) !== void 0 : (i == null ? void 0 : i._$litType$) === t, hc = () => document.createComment(""), cc = (i, t, e) => {
  var n;
  const s = i._$AA.parentNode, r = t === void 0 ? i._$AB : t._$AA;
  if (e === void 0) {
    const o = s.insertBefore(hc(), r), a = s.insertBefore(hc(), r);
    e = new xp(o, a, i, i.options);
  } else {
  ...
  return e;
}, Cp = {}, uc = (i, t = Cp) => i._$AH = t, dc = (i) => i._$AH, Mp = (i) => {
  i._$AR();
};
/**
 * @license
...
st.stack = `
  ...
  `;
var wp = Object.defineProperty, Sp = Object.getOwnPropertyDescriptor, Ro = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? Sp(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
  return n && s && wp(t, e, s), s;
};
let Ji = class extends Pt {
  constructor(i) {
    ...
    Wt.registerBorderConstaintMapEvent("change:center", () => this.setCenterChange(), t, e), window.addEventListener("open-select-create-box", (n) => {
      Hd.getAddressFromCoordinate(n.detail).then((s) => {
  ...
  readFeature(t, e) {
    if (t)
      if (typeof t == "string") {
        ...
        return Vi(t) ? this.readFeatureFromDocument(
          t,
          e
  ...
  readFeatures(t, e) {
    if (t)
      if (typeof t == "string") {
        ...
        return Vi(t) ? this.readFeaturesFromDocument(
          t,
          e
  ...
  readGeometry(t, e) {
    if (t)
      if (typeof t == "string") {
        ...
        return Vi(t) ? this.readGeometryFromDocument(
          t,
          e
  ...
  readProjection(t) {
    if (t)
      if (typeof t == "string") {
        ...
        return Vi(t) ? this.readProjectionFromDocument(t) : this.readProjectionFromNode(t);
    else
      return null;
  }
...
const Jd = Ip, ri = "http://www.opengis.net/gml", Ap = /^\s*$/;
class St extends Jd {
  constructor(t) {
  ...
  readFeatureElementInternal(t, e, n) {
    ...
    for (let o = t.firstElementChild; o; o = o.nextElementSibling) {
      let a;
      const l = o.localName;
      o.childNodes.length === 0 || o.childNodes.length === 1 && (o.firstChild.nodeType === 3 || o.firstChild.nodeType === 4) ? (a = Qi(o, !1), Ap.test(a) && (a = void 0)) : (n && (a = l === "boundedBy" ? this.readExtentElement(o, e) : this.readGeometryElement(o, e)), a ? l !== "boundedBy" && (s = l) : a = this.readFeatureElementInternal(o, e, !1));
    ...
    if (n) {
      ...
      const a = t.getAttribute("fid") || bp(t, this.namespace, "id");
...
const Np = ri + " http://schemas.opengis.net/gml/2.1.2/feature.xsd", Fp = {
...
class it extends K {
  constructor(t) {
    ...
    ), this.schemaLocation = t.schemaLocation ? t.schemaLocation : Np;
  }
...
const qs = it, Dp = ri + " http://schemas.opengis.net/gml/3.1.1/profiles/gmlsfProfile/1.0.0/gmlsf.xsd", kp = {
  MultiLineString: "lineStringMember",
  MultiCurve: "curveMember",
  MultiPolygon: "polygonMember",
  MultiSurface: "surfaceMember"
...
class F extends K {
  constructor(t) {
    t = t || {}, super(t), this.surface_ = t.surface !== void 0 ? t.surface : !1, this.curve_ = t.curve !== void 0 ? t.curve : !1, this.multiCurve_ = t.multiCurve !== void 0 ? t.multiCurve : !0, this.multiSurface_ = t.multiSurface !== void 0 ? t.multiSurface : !0, this.schemaLocation = t.schemaLocation ? t.schemaLocation : Dp, this.hasZ = t.hasZ !== void 0 ? t.hasZ : !1;
  }
  readMultiCurve(t, e) {
    const n = $(
      [],
...
function Wp(i) {
  ...
  return new (Function.prototype.bind.apply(Zp, t))();
}
function Hp(i, t, e) {
  return new Up(i, t, e);
}
...
}, ef = "feature", kl = "http://www.w3.org/2000/xmlns/", Gl = {
...
class qp extends Jd {
  constructor(t) {
    super(), t = t || {}, this.version_ = t.version ? t.version : Kp, this.featureType_ = t.featureType, this.featureNS_ = t.featureNS, this.gmlFormat_ = t.gmlFormat ? t.gmlFormat : new Bl[this.version_](), this.schemaLocation_ = t.schemaLocation ? t.schemaLocation : gc[this.version_];
  }
  getFeatureType() {
  ...
  readTransactionResponse(t) {
    if (t)
      if (typeof t == "string") {
        ...
        return Vi(t) ? this.readTransactionResponseFromDocument(
          t
  ...
  readFeatureCollectionMetadata(t) {
    if (t)
      if (typeof t == "string") {
        ...
        return Vi(t) ? this.readFeatureCollectionMetadataFromDocument(
          t
...
function Jp(i, t, e, n) {
  const s = n.featurePrefix ? n.featurePrefix : ef;
  let r;
...
function yc(i, t, e) {
  ...
  i.appendChild(a), o === 2 ? qs.prototype.writeFeatureElement(a, t, e) : o === 3 ? J.prototype.writeFeatureElement(a, t, e) : Dl.prototype.writeFeatureElement(a, t, e);
}
function nf(i, t, e) {
  const s = e[e.length - 1].version, r = Gl[s], o = j(r, "Filter"), a = j(r, "FeatureId");
...
function Cc(i, t, e) {
  ...
  if (i.appendChild(o), Tt(o, t.name), t.value !== void 0 && t.value !== null) {
    const l = j(r, "Value");
    i.appendChild(l), t.value && typeof t.value.getSimplifiedGeometry == "function" ? a === 2 ? qs.prototype.writeGeometryElement(l, t.value, e) : a === 3 ? J.prototype.writeGeometryElement(l, t.value, e) : Dl.prototype.writeGeometryElement(l, t.value, e) : Tt(l, t.value);
  }
}
function Mc(i, t, e) {
...
function Ec(i, t, e) {
  ...
  const d = n.filter;
  if (d) {
    const f = j(Lo(s), "Filter");
    i.appendChild(f), e_(f, d, e);
  }
}
function e_(i, t, e) {
...
class Oc {
  constructor(t, e, n) {
    this.vectorLayer = new Un(), this.store = n, this.states = e, this.renderUtils = t;
    const s = this.store.getMap(), r = this.store.getOptions();
    if (!r || !s)
      throw new Error("Missing map or options");
    this.options = r, this.map = s, this.control = new Fl(this.store), this.vectorLayer = new Un(), this.vectorSource = sf.getSource(r.wfs.url, "", !1), this.vectorSource.on("featuresloadend", () => {
  ...
  removeSelectedItem(t) {
    this.removeItem(t), this.control.hide(), tt.sendEvent("rule-validation", void 0), Xd.setCustomStyleWithouInfoBox(this.store);
  }
  removeItem(t) {
  ...
  read(t) {
    if (t)
      if (typeof t == "string") {
        ...
        return Vi(t) ? this.readFromDocument(t) : this.readFromNode(t);
    else
      return null;
  }
  readFromDocument(t) {
...
const rf = s_, r_ = "http://www.w3.org/1999/xlink";
function Zl(i) {
  return i.getAttributeNS(r_, "href");
}
const re = [null, "http://www.opengis.net/ows/1.1"], o_ = ct(re, {
  ServiceIdentification: O(A_),
  ServiceProvider: O(O_),
  OperationsMetadata: O(T_)
});
class a_ extends rf {
  constructor() {
    super();
...
function L_(i, t) {
  const e = i.getAttribute("name"), n = $({}, g_, i, t);
  if (!n)
    return;
...
const F_ = a_, Ze = [null, "http://www.opengis.net/wmts/1.0"], es = [null, "http://www.opengis.net/ows/1.1"], D_ = ct(Ze, {
  Contents: O(Y_)
});
class k_ extends rf {
  constructor() {
    super(), this.owsParser_ = new F_();
  }
  readFromNode(t) {
...
const G_ = ct(Ze, {
  ...
  TileMatrixSet: O(nt),
  TileMatrixSetLimits: O(ny)
}), Z_ = ct(Ze, {
  TileMatrixLimits: W(sy)
}), V_ = ct(Ze, {
  TileMatrix: O(nt),
  MinTileRow: O(ne),
  MaxTileRow: O(ne),
  ...
  constructor(t) {
    ...
    Promise.all(n.wmts.map((r) => {
      fetch(r.capability).then((o) => o.text()).then(function(o) {
        ...
        h && (a.setSource(new tp(h)), a.setVisible(r.layer == n.wmts[0].layer), s.push(a), (c = t.getMap()) == null || c.getLayers().insertAt(0, a), t.getBorderConstraint() && a.setExtent((d = (u = t.getBorderConstraint()) == null ? void 0 : u.getSource()) == null ? void 0 : d.getExtent()), a.on("postrender", function(f) {
          var p, _;
          const g = e2(f), m = f.context;
...
class dy {
  constructor(t) {
    var s;
    if (this.validZoomConstraint = !0, this.validAreaConstraint = !0, this.validBorderContraint = !0, this.validMaxElementConstraint = !0, this.displayMaxElementConstraint = !1, this.outputFormat = new uy(), !t)
...
class yy {
  constructor(t) {
    ...
    this.vectorSource = sf.getSource(e.inclusionArea.url, e.inclusionArea.filter, !0);
    const n = new Un({
...
`;
var vy = Object.defineProperty, xy = Object.getOwnPropertyDescriptor, Cy = (i, t, e, n) => {
...
var Ey = Object.defineProperty, wy = Object.getOwnPropertyDescriptor, Sy = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? wy(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
  return n && s && Ey(t, e, s), s;
};
...
var Iy = Object.defineProperty, Ay = Object.getOwnPropertyDescriptor, Py = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? Ay(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
  return n && s && Iy(t, e, s), s;
};
...
class Oy extends kt {
  constructor(t, e, n) {
    ...
    super({
      element: s
    }), this.informationIsOpen = !0, s.addEventListener("click", this.toogleInformationBox.bind(this), !1), window.addEventListener("close-information-box", this.closeInformationBox.bind(this), !1), this.control = new Ty(e), n.addControl(this.control), this.openInformationBox(), this.setTarget(t);
  }
  closeInformationBox() {
    ...
    return Lt`
      ...
      (i, t) => Lt`<li tabindex="0" @click=${() => this.selectLayer(i, t)}>
                          <div class="image-container">
                            <img class=${Ny({ "selected-layer": this._currentSelectedIndex === t })} src="${i.thumbnail}"/>
                          </div>
                          <p>${i.name}</p>
                        </li>`
    )}
...
var Gy = Object.defineProperty, $y = Object.getOwnPropertyDescriptor, By = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? $y(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
  return n && s && Gy(t, e, s), s;
};
...
class zy extends kt {
  constructor(t, e, n) {
    ...
    super({
      element: s
    }), this.isOpen = !1, this.layerSelection = new ky(n), this.layerSelection.disable(), e.addControl(this.layerSelection), s.addEventListener("click", () => {
...
class Zy {
  static setupIcon(t, e) {
    ...
    if (!r)
      throw new Error("Missing map!");
    const o = new Fc("left-buttons-control-container");
    r.addControl(o);
    const a = new Fc("right-buttons-control-container");
    r.addControl(a), s || r.addControl(new Oy(a.div, e, r)), n != null && n.interaction.fullscreen && r.addControl(
      new p2({
    ...
    ), r.addControl(new zy(a.div, r, (l = n == null ? void 0 : n.wmts) != null ? l : [])), n != null && n.interaction.displayZoom && r.addControl(
      new ad({
    ...
    ), (n == null ? void 0 : n.interaction.enableCenterButton) && !s && r.addControl(new My(o.div)), n != null && n.interaction.enableRotation && Wt.registerBorderConstaintMapEvent(
      "change:rotation",
      (h) => Vy(r, h, o.div),
      r,
      n
...
function Vy(i, t, e) {
  ...
  }), t.target.getRotation() !== 0 && i.addControl(new Nc(e, i));
}
var Uy = Object.defineProperty, Wy = Object.getOwnPropertyDescriptor, Hy = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? Wy(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
...
let Ti = class extends Pt {
  ...
  searchAddress(i) {
    Hd.getAddressFromCoordinate(i).then((t) => {
...
var en = 1, nn = 2, Ar = 3, tv = 4, Ba = 5, kc = 6378137, ev = 6356752314e-3, Gc = 0.0066943799901413165, Ms = 484813681109536e-20, S = Math.PI / 2, iv = 0.16666666666666666, nv = 0.04722222222222222, sv = 0.022156084656084655, T = 1e-10, Bt = 0.017453292519943295, Fe = 57.29577951308232, lt = Math.PI / 4, $s = Math.PI * 2, Rt = 3.14159265359, oe = {};
oe.greenwich = 0;
...
var Bs = 1, hf = 2, cf = 3, io = 4, uf = 5, Ul = -1, ov = /\s/, av = /[A-Za-z]/, lv = /[A-Za-z84_]/, Ao = /[,\]]/, df = /[\d\.E\-\+]/;
function li(i) {
  if (typeof i != "string")
...
li.prototype.afterItem = function(i) {
  ...
  if (i === "]") {
    this.level--, this.word !== null && (this.currentObject.push(this.word), this.word = null), this.state = Bs, this.currentObject = this.stack.pop(), this.currentObject || (this.state = Ul);
    return;
  }
};
...
function ff(i) {
  ...
  var s = {};
  return bn(t, s), dv(s), s;
}
function Xt(i) {
  var t = this;
  if (arguments.length === 2) {
    var e = arguments[1];
    typeof e == "string" ? e.charAt(0) === "+" ? Xt[i] = za(arguments[1]) : Xt[i] = ff(arguments[1]) : Xt[i] = e;
...
var mv = ["PROJECTEDCRS", "PROJCRS", "GEOGCS", "GEOCCS", "PROJCS", "LOCAL_CS", "GEODCRS", "GEODETICCRS", "GEODETICDATUM", "ENGCRS", "ENGINEERINGCRS"];
function pv(i) {
  return mv.some(function(t) {
    return i.indexOf(t) > -1;
  });
}
var _v = ["3857", "900913", "3785", "102113"];
function yv(i) {
  var t = Ii(i, "authority");
  if (!!t) {
    var e = Ii(t, "epsg");
    return e && _v.indexOf(e) > -1;
  }
}
function vv(i) {
...
var Sv = ["Mercator", "Popular Visualisation Pseudo Mercator", "Mercator_1SP", "Mercator_Auxiliary_Sphere", "merc"];
const Rv = {
  init: Mv,
  forward: Ev,
  inverse: wv,
...
function Fv(i, t, e, n) {
  ...
  n ? (i *= 1 - o * (iv + o * (nv + o * sv)), s = i * i, o = 0) : a = Math.sqrt(o);
  var l = (s - r) / r;
  return {
    es: o,
    e: a,
...
function Dv(i, t, e, n, s) {
  if (!i) {
    var r = Ii(Y, n);
    r || (r = Nv), i = r.a, t = r.b, e = r.rf;
  }
...
function Vv(i, t, e) {
  for (var n = 176, s = [], r = 0; r < t.nSubgrids; r++) {
    var o = Wv(i, n, e), a = Hv(i, n, o, e), l = Math.round(
...
function ke(i, t) {
  ...
  var r = Dv(e.a, e.b, e.rf, e.ellps, e.sphere), o = Fv(r.a, r.b, r.rf, e.R_A), a = $v(e.nadgrids), l = e.datum || kv(
    e.datumCode,
    e.datum_params,
    r.a,
    r.b,
...
function Kv(i, t, e) {
  if (Xv(i, t) || i.datum_type === Ba || t.datum_type === Ba)
    return e;
  var n = i.a, s = i.es;
  if (i.datum_type === Ar) {
    var r = Vc(i, !1, e);
  ...
  if (t.datum_type === Ar && (o = kc, a = ev, l = Gc), s === l && n === o && !Lr(i.datum_type) && !Lr(t.datum_type))
    return e;
  if (e = pf(e, s, n), Lr(i.datum_type) && (e = Yv(e, i.datum_type, i.datum_params)), Lr(t.datum_type) && (e = jv(e, t.datum_type, t.datum_params)), e = _f(e, l, o, a), t.datum_type === Ar) {
    var h = Vc(t, !0, e);
    if (h !== 0)
      return;
  }
...
function so(i, t, e, n) {
  var s;
  if (Array.isArray(e) && (e = yf(e)), Jv(e), i.datum && t.datum && Qv(i, t) && (s = new ke("WGS84"), e = so(i, s, e, n), i = s), n && i.axis !== "enu" && (e = Wc(i, !1, e)), i.projName === "longlat")
    e = {
      x: e.x * Bt,
      y: e.y * Bt,
      z: e.z || 0
    ...
    return;
  if (i.from_greenwich && (e.x += i.from_greenwich), e = Kv(i.datum, t.datum, e), !!e)
...
function se(i, t, e) {
  i = Yc(i);
  var n = !1, s;
  return typeof t > "u" ? (t = i, i = Xc, n = !0) : (typeof t.x < "u" || Array.isArray(t)) && (e = t, t = i, i = Xc, n = !0), t = Yc(t), e ? ra(i, t, e) : (s = {
...
var jc = 6, vf = "AJSAJS", xf = "AFAFAF", Tn = 65, te = 73, ve = 79, ms = 86, ps = 90;
const tx = {
  forward: Cf,
  inverse: ex,
  toPoint: Mf
...
function sx(i, t) {
  ...
  return i.zoneNumber + i.zoneLetter + rx(i.easting, i.northing, i.zoneNumber) + e.substr(e.length - 5, t) + n.substr(n.length - 5, t);
}
function rx(i, t, e) {
  var n = Ef(e), s = Math.floor(i / 1e5), r = Math.floor(t / 1e5) % 20;
  return ox(s, r, n);
}
function Ef(i) {
  var t = i % jc;
...
function ox(i, t, e) {
  var n = e - 1, s = vf.charCodeAt(n), r = xf.charCodeAt(n), o = s + i - 1, a = r + t, l = !1;
...
function wf(i) {
  ...
  e = i.substring(r, r += 2);
  for (var l = Ef(o), h = ax(e.charAt(0), l), c = lx(e.charAt(1), l); c < hx(a); )
    c += 2e6;
  var u = t - r;
  if (u % 2 !== 0)
...
function ax(i, t) {
  for (var e = vf.charCodeAt(t - 1), n = 1e5, s = !1; e !== i.charCodeAt(0); ) {
...
function lx(i, t) {
  ...
  for (var e = xf.charCodeAt(t - 1), n = 0, s = !1; e !== i.charCodeAt(0); ) {
...
Xn.prototype.toMGRS = function(i) {
  return Cf([this.x, this.y], i);
};
var cx = 1, ux = 0.25, qc = 0.046875, Jc = 0.01953125, Qc = 0.01068115234375, dx = 0.75, fx = 0.46875, gx = 0.013020833333333334, mx = 0.007120768229166667, px = 0.3645833333333333, _x = 0.005696614583333333, yx = 0.3076171875;
function Sf(i) {
  var t = [];
  t[0] = cx - i * (ux + i * (qc + i * (Jc + i * Qc))), t[1] = i * (dx - i * (qc + i * (Jc + i * Qc)));
  var e = i * i;
  return t[2] = e * (fx - i * (gx + i * mx)), e *= i, t[3] = e * (px - i * _x), t[4] = e * i * yx, t;
}
function Po(i, t, e, n) {
...
function Rf(i, t, e) {
  for (var n = 1 / (1 - t), s = i, r = vx; r; --r) {
    ...
    if (a = (Po(s, o, Math.cos(s), e) - i) * (a * Math.sqrt(a)) * n, s -= a, Math.abs(a) < T)
      return s;
  }
  return s;
}
function xx() {
  this.x0 = this.x0 !== void 0 ? this.x0 : 0, this.y0 = this.y0 !== void 0 ? this.y0 : 0, this.long0 = this.long0 !== void 0 ? this.long0 : 0, this.lat0 = this.lat0 !== void 0 ? this.lat0 : 0, this.es && (this.en = Sf(this.es), this.ml0 = Po(this.lat0, Math.sin(this.lat0), Math.cos(this.lat0), this.en));
}
function Cx(i) {
...
function Mx(i) {
  ...
  if (this.es)
    if (t = this.ml0 + o / this.k0, e = Rf(t, this.es, this.en), Math.abs(e) < S) {
...
var Ex = ["Fast_Transverse_Mercator", "Fast Transverse Mercator"];
const Or = {
  init: xx,
  forward: Cx,
  inverse: Mx,
...
function Sx(i) {
  var t = Math.abs(i);
  return t = wx(t * (1 + t / (Se(1, t) + 1))), i < 0 ? -t : t;
}
function Hl(i, t) {
...
function Lf(i, t, e) {
  for (var n = Math.sin(t), s = Math.cos(t), r = bf(e), o = bx(e), a = 2 * s * o, l = -2 * n * r, h = i.length - 1, c = i[h], u = 0, d = 0, f = 0, g, m; --h >= 0; )
...
function Lx() {
  ...
  this.Zb = -this.Qn * (n + Rx(this.gtu, 2 * n));
}
function Tx(i) {
  var t = P(i.x - this.long0), e = i.y;
  e = Hl(this.cbg, e);
  var n = Math.sin(e), s = Math.cos(e), r = Math.sin(t), o = Math.cos(t);
  e = Math.atan2(n, o * s), t = Math.atan2(r * s, Se(n, s * o)), t = Sx(Math.tan(t));
...
function Ix(i) {
  ...
  if (Math.abs(t) <= 2.623395162778) {
    ...
    e = e + r[0], t = t + r[1], t = Math.atan(bf(t));
    var o = Math.sin(e), a = Math.cos(e), l = Math.sin(t), h = Math.cos(t);
    e = Math.atan2(o * h, Se(l, h * a)), t = Math.atan2(l, h * a), n = P(t + this.long0), s = Hl(this.cgb, e);
  } else
    n = 1 / 0, s = 1 / 0;
  return i.x = n, i.y = s, i;
}
...
function Gx() {
  ...
  t *= t, this.rc = Math.sqrt(1 - this.es) / (1 - this.es * i * i), this.C = Math.sqrt(1 + this.es * t * t / (1 - this.es)), this.phic0 = Math.asin(i / this.C), this.ratexp = 0.5 * this.C * this.e, this.K = Math.tan(0.5 * this.phic0 + lt) / (Math.pow(Math.tan(0.5 * this.lat0 + lt), this.C) * Xl(this.e * i, this.ratexp));
}
function $x(i) {
  var t = i.x, e = i.y;
  return i.y = 2 * Math.atan(this.K * Math.pow(Math.tan(0.5 * e + lt), this.C) * Xl(this.e * Math.sin(e), this.ratexp)) - S, i.x = this.C * t, i;
}
function Bx(i) {
  for (var t = 1e-14, e = i.x / this.C, n = i.y, s = Math.pow(Math.tan(0.5 * n + lt) / this.K, 1 / this.C), r = kx; r > 0 && (n = 2 * Math.atan(s * Xl(this.e * Math.sin(i.y), -0.5 * this.e)) - S, !(Math.abs(n - i.y) < t)); --r)
    i.y = n;
...
function Vx(i) {
  var t, e, n, s;
  return i.x = P(i.x - this.long0), Yl.forward.apply(this, [i]), t = Math.sin(i.y), e = Math.cos(i.y), n = Math.cos(i.x), s = this.k0 * this.R2 / (1 + this.sinc0 * t + this.cosc0 * e * n), i.x = s * e * Math.sin(i.x), i.y = s * (this.cosc0 * t - this.sinc0 * e * n), i.x = this.a * i.x + this.x0, i.y = this.a * i.y + this.y0, i;
}
function Ux(i) {
  var t, e, n, s, r;
  if (i.x = (i.x - this.x0) / this.a, i.y = (i.y - this.y0) / this.a, i.x /= this.k0, i.y /= this.k0, r = Math.sqrt(i.x * i.x + i.y * i.y)) {
    ...
    s = this.phic0, n = 0;
  return i.x = n, i.y = s, Yl.inverse.apply(this, [i]), i.x = P(i.x + this.long0), i;
}
var Wx = ["Stereographic_North_Pole", "Oblique_Stereographic", "Polar_Stereographic", "sterea", "Oblique Stereographic Alternative", "Double_Stereographic"];
const Hx = {
  init: Zx,
  forward: Vx,
  inverse: Ux,
...
function r3() {
  ...
  this.no_off = s3(this), this.no_rot = "no_rot" in this;
  var y = !1;
  "alpha" in this && (y = !0);
  var v = !1;
...
var l3 = ["Hotine_Oblique_Mercator", "Hotine Oblique Mercator", "Hotine_Oblique_Mercator_Azimuth_Natural_Origin", "Hotine_Oblique_Mercator_Two_Point_Natural_Origin", "Hotine_Oblique_Mercator_Azimuth_Center", "Oblique_Mercator", "omerc"];
const h3 = {
  init: r3,
  forward: o3,
  inverse: a3,
...
var E3 = ["Cassini", "Cassini_Soldner", "cass"];
const w3 = {
  init: x3,
  forward: C3,
  inverse: M3,
...
function T3() {
  ...
  if (Math.abs(i - S) < T ? this.mode = this.lat0 < 0 ? this.S_POLE : this.N_POLE : Math.abs(i) < T ? this.mode = this.EQUIT : this.mode = this.OBLIQ, this.es > 0) {
    var t;
    switch (this.qp = wi(this.e, 1), this.mmf = 0.5 / (1 - this.es), this.apa = G3(this.es), this.mode) {
      case this.N_POLE:
        this.dd = 1;
        break;
      case this.S_POLE:
...
function A3(i) {
  ...
  if (this.sphere) {
    ...
    n = Math.atan2(t, e), s = $3(Math.asin(h), this.apa);
  }
  return i.x = P(this.long0 + n), i.y = s, i;
}
var P3 = 0.3333333333333333, O3 = 0.17222222222222222, N3 = 0.10257936507936508, F3 = 0.06388888888888888, D3 = 0.0664021164021164, k3 = 0.016415012942191543;
function G3(i) {
  var t, e = [];
  return e[0] = i * P3, t = i * i, e[0] += t * O3, e[1] = t * F3, t *= i, e[0] += t * N3, e[1] += t * D3, e[2] = t * k3, e;
}
function $3(i, t) {
  var e = i + i;
...
var H3 = ["Albers_Conic_Equal_Area", "Albers", "aea"];
const X3 = {
  init: Z3,
  forward: V3,
  inverse: U3,
...
function iC(i) {
  i.x -= this.x0, i.y -= this.y0;
  var t, e;
  return this.sphere ? (t = P(this.long0 + i.x / this.a / Math.cos(this.lat_ts)), e = Math.asin(i.y / this.a * Math.cos(this.lat_ts))) : (e = Q3(this.e, 2 * i.y * this.k0 / this.a), t = P(this.long0 + i.x / (this.a * this.k0))), i.x = t, i.y = e, i;
}
var nC = ["cea"];
const sC = {
  init: tC,
...
var lC = ["Equirectangular", "Equidistant_Cylindrical", "eqc"];
const hC = {
  init: rC,
  forward: oC,
  inverse: aC,
...
var yC = ["New_Zealand_Map_Grid", "nzmg"];
const vC = {
  init: mC,
  forward: pC,
  inverse: _C,
...
var SC = 20;
function RC() {
  this.sphere ? (this.n = 1, this.m = 0, this.es = 0, this.C_y = Math.sqrt((this.m + 1) / this.n), this.C_x = this.C_y / (this.m + 1)) : this.en = Sf(this.es);
}
function bC(i) {
  var t, e, n = i.x, s = i.y;
  if (n = P(n - this.long0), this.sphere) {
    if (!this.m)
      ...
      for (var r = this.n * Math.sin(s), o = SC; o; --o) {
...
function GC(i) {
  ...
  return n = ro(o, this.e0, this.e1, this.e2, this.e3), s = P(this.long0 + r / this.ns), i.x = s, i.y = n, i;
}
var $C = ["Equidistant_Conic", "eqdc"];
const BC = {
  init: DC,
  forward: kC,
  inverse: GC,
...
var UC = ["Van_der_Grinten_I", "VanDerGrinten", "vandg"];
const WC = {
  init: zC,
  forward: ZC,
  inverse: VC,
...
var rM = ["Quadrilateralized Spherical Cube", "Quadrilateralized_Spherical_Cube", "qsc"];
const oM = {
  init: iM,
  forward: nM,
  inverse: sM,
...
], Tf = 0.8487, If = 1.3523, Af = Fe / 5, aM = 1 / Af, In = 18, oo = function(i, t) {
...
function uM(i) {
  var t = P(i.x - this.long0), e = Math.abs(i.y), n = Math.floor(e * Af);
  n < 0 ? n = 0 : n >= In && (n = In - 1), e = Fe * (e - aM * n);
  var s = {
    x: oo(Va[n], e) * t,
    y: oo(_s[n], e)
  };
  return i.y < 0 && (s.y = -s.y), s.x = s.x * this.a * Tf + this.x0, s.y = s.y * this.a * If + this.y0, s;
}
function dM(i) {
  var t = {
    x: (i.x - this.x0) / (this.a * Tf),
    y: Math.abs(i.y - this.y0) / (this.a * If)
  };
  if (t.y >= 1)
    t.x /= Va[In][0], t.y = i.y < 0 ? -S : S;
  else {
    ...
    s = hM(function(r) {
      return (oo(n, r) - t.y) / lM(n, r);
    }, s, T, 100), t.x /= oo(Va[e], s), t.y = (5 * e + s) * Bt, i.y < 0 && (t.y = -t.y);
  }
  return t.x = P(t.x + this.long0), t;
}
var fM = ["Robinson", "robin"];
const gM = {
  init: cM,
  forward: uM,
  inverse: dM,
...
function pM(i) {
  var t = pf(i, this.es, this.a);
  return t;
}
function _M(i) {
  var t = _f(i, this.es, this.a, this.b);
  return t;
}
var yM = ["Geocentric", "geocentric", "geocent", "Geocent"];
const vM = {
  init: mM,
  forward: pM,
  inverse: _M,
...
function xM() {
  ...
  }.bind(this)), Math.abs(Math.abs(this.lat0) - S) < T ? this.mode = this.lat0 < 0 ? Vt.S_POLE : Vt.N_POLE : Math.abs(this.lat0) < T ? this.mode = Vt.EQUIT : (this.mode = Vt.OBLIQ, this.sinph0 = Math.sin(this.lat0), this.cosph0 = Math.cos(this.lat0)), this.pn1 = this.h / this.a, this.pn1 <= 0 || this.pn1 > 1e10)
...
var EM = ["Tilted_Perspective", "tpers"];
const wM = {
  init: xM,
  forward: CM,
  inverse: MM,
...
var LM = ["Geostationary Satellite View", "Geostationary_Satellite", "geos"];
const TM = {
  init: SM,
  forward: RM,
  inverse: bM,
...
function IM(i) {
  i.Proj.projections.add(Or), i.Proj.projections.add(Nr), i.Proj.projections.add(Dx), i.Proj.projections.add(Hx), i.Proj.projections.add(Jx), i.Proj.projections.add(n3), i.Proj.projections.add(h3), i.Proj.projections.add(g3), i.Proj.projections.add(v3), i.Proj.projections.add(w3), i.Proj.projections.add(z3), i.Proj.projections.add(X3), i.Proj.projections.add(J3), i.Proj.projections.add(sC), i.Proj.projections.add(hC), i.Proj.projections.add(gC), i.Proj.projections.add(vC), i.Proj.projections.add(wC), i.Proj.projections.add(IC), i.Proj.projections.add(FC), i.Proj.projections.add(BC), i.Proj.projections.add(WC), i.Proj.projections.add(KC), i.Proj.projections.add(eM), i.Proj.projections.add(oM), i.Proj.projections.add(gM), i.Proj.projections.add(vM), i.Proj.projections.add(wM), i.Proj.projections.add(TM);
}
...
class eu {
  constructor(t, e, n, s, r) {
    ...
    if (!o)
      throw new Error("Missing map");
    this.map = o, this.control = new Fl(this.store), this.vectorSource = new Qn(), this.setupMapForCreation(o, this.vectorSource), this.states.readonly || (window.addEventListener("authorize-created", (l) => {
  ...
  deleteElement(t) {
    ...
    e && (this.remove(t, e), tt.sendEvent("rule-validation", void 0), Xd.setCustomStyleWithouInfoBox(this.store)), this.map.get("target").className = `${this.store.getTargetBoxSize()} ${gt.getTheme()}`;
  }
...
let jn = class extends Pt {
  ...
  selectAddress(i, t) {
    var e;
    (e = this.map) == null || e.getView().setCenter(_g([i[0], i[1]], "EPSG:2056")), this._results = [], tt.sendEvent("address_selected", t);
  }
  render() {
    return Lt`
                <ul>
...
class DM {
  constructor(t) {
    var n, s;
    this.vectorLayer = new Un(), this.vectorSource = new Qn(), this.map = t;
...
const kM = `.loader-element{position:absolute;top:calc(50% - 52px);background-color:var(--information-box-background-color);box-shadow:#0003 0 1px 4px;padding:15px;border-radius:10px;border:1px solid var(--information-box-background-color);z-index:10;max-width:302px;width:100%;left:calc(50% - 167px)}.loader-text{display:flex;justify-content:center;margin-top:10px;color:var(--information-box-title-color)}.loader-container{display:flex;justify-content:center}.loader{width:48px;height:48px;border:4px solid #008c6f;border-bottom-color:transparent;border-radius:50%;display:inline-block;box-sizing:border-box;animation:rotation 1s linear infinite}@keyframes rotation{0%{transform:rotate(0)}to{transform:rotate(360deg)}}
`;
var GM = Object.defineProperty, $M = Object.getOwnPropertyDescriptor, Of = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? $M(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
...
class zM {
  ...
  constructor(t) {
    ...
    this.overlay = new o2({ element: n, position: Pi(s), className: "ol-overlay-container ol-selectable overlay-index" }), this.loaderBox = new BM("Chargement des donn\xE9es GPS"), this.map.addControl(this.loaderBox), this.checkGeolocation();
  }
}
class iu {
  static getStates(t) {
...
class VM {
  ...
  setupAndLoadLayer(t) {
    ...
    e.setStyle((r) => nu.setupCircles(r, this.getDefaultZoomFactor()));
    const n = this.store.getMap();
    if (!n)
      return;
    n == null || n.addLayer(e);
...
var UM = Object.defineProperty, WM = Object.getOwnPropertyDescriptor, Oi = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? WM(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
  return n && s && UM(t, e, s), s;
};
let Be = class extends Pt {
  constructor() {
    super(), this.modeControllers = [], this.inclusionArea = void 0, this.options = {}, this.states = {}, this.store = new gt(), this.renderUtils = new VM(this.store);
  }
  connectedCallback() {
    super.connectedCallback();
  }
  ...
  firstUpdated() {
    const i = py.webComponentOptions(this.options);
    ...
    this.store.setMap(n), Zy.setupIcon(t, this.store), i.interaction.enableGeolocation && !e && (gt.setGeolocation(new H1({
      trackingOptions: {
        enableHighAccuracy: !0
      },
      projection: this.view.getProjection()
    })), new zM(n)), i.search.displaySearch && i.mode.type !== "target" && !e && n.addControl(new NM(this.store, n)), i.mode.type === "target" && (this.modeControllers.push(new ZM(this.renderUtils)), e || (n.addControl(new Yy(this.store)), i.geolocationInformation.displayBox && n.addControl(
      new Jy(this.store)
    ))), i.wmts.length > 0 && new oy(this.store), i.interaction.displayScaleLine && n.addControl(new v2({ units: "metric" })), i.border.url !== "" && new FM(this.store), i.inclusionArea.url !== "" && (this.inclusionArea = new yy(this.store)), i.mode.type === "select" && i.wfs.url != "" && this.modeControllers.push(new Oc(this.renderUtils, t, this.store)), i.mode.type === "create" && this.modeControllers.push(new eu(this.mapElement, this.inclusionArea, this.renderUtils, t, this.store)), i.mode.type === "mix" && i.wfs.url != "" && (this.modeControllers.push(new Oc(this.renderUtils, t, this.store)), this.modeControllers.push(new eu(this.mapElement, this.inclusionArea, this.renderUtils, t, this.store))), e || new dy(this.store), Wt.setCursorEvent(n);
  }
  updated(i) {
    var t, e, n;
    if (i.has("states") && this.states) {
      const s = iu.getStates(this.states);
...
Be.styles = [yt(ay), yt(ly), yt(To), yt(af), yt(fy), yt(gy), yt(my)];
Oi([
  Ha("#map")
