 ...
 */
const qs = window, Zo = qs.ShadowRoot && (qs.ShadyCSS === void 0 || qs.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, kl = Symbol(), oh = /* @__PURE__ */ new WeakMap();
class ku {
  constructor(t, e, n) {
    if (this._$cssResult$ = !0, n !== kl)
  ...
  get styleSheet() {
    ...
    if (Zo && t === void 0) {
      ...
      n && (t = oh.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), n && oh.set(e, t));
    }
    return t;
  }
  toString() {
...
const ci = (i) => new ku(typeof i == "string" ? i : i + "", void 0, kl), Gu = (i, t) => {
  Zo ? i.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet) : t.forEach((e) => {
...
}, ah = Zo ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 */
var Hr;
const tr = window, hh = tr.trustedTypes, $u = hh ? hh.emptyScript : "", lh = tr.reactiveElementPolyfillSupport, So = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? $u : null;
      break;
  ...
  return e;
} }, Gl = (i, t) => t !== i && (t == t || i == i), Zr = { attribute: !0, type: String, converter: So, reflect: !1, hasChanged: Gl };
class Xi extends HTMLElement {
  ...
  createRenderRoot() {
    ...
    return Gu(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
    var t;
  ...
  _$EO(t, e, n = Zr) {
    ...
    if (r !== void 0 && n.reflect === !0) {
      const o = (((s = n.converter) === null || s === void 0 ? void 0 : s.toAttribute) !== void 0 ? n.converter : So).toAttribute(e, n.type);
  ...
  _$AK(t, e) {
    ...
    if (r !== void 0 && this._$El !== r) {
      const o = s.getPropertyOptions(r), a = typeof o.converter == "function" ? { fromAttribute: o.converter } : ((n = o.converter) === null || n === void 0 ? void 0 : n.fromAttribute) !== void 0 ? o.converter : So;
      this._$El = r, this[r] = a.fromAttribute(e, o.type), this._$El = null;
    }
  }
  requestUpdate(t, e, n) {
    let s = !0;
    t !== void 0 && (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || Gl)(this[t], e) ? (this._$AL.has(t) || this._$AL.set(t, e), n.reflect === !0 && this._$El !== t && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t, n))) : s = !1), !this.isUpdatePending && s && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
Xi.finalized = !0, Xi.elementProperties = /* @__PURE__ */ new Map(), Xi.elementStyles = [], Xi.shadowRootOptions = { mode: "open" }, lh == null || lh({ ReactiveElement: Xi }), ((Hr = tr.reactiveElementVersions) !== null && Hr !== void 0 ? Hr : tr.reactiveElementVersions = []).push("1.5.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Jr;
const er = window, ln = er.trustedTypes, ch = ln ? ln.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, We = `lit$${(Math.random() + "").slice(9)}$`, $l = "?" + We, zu = `<${$l}>`, cn = document, Un = (i = "") => cn.createComment(i), Xn = (i) => i === null || typeof i != "object" && typeof i != "function", zl = Array.isArray, Bu = (i) => zl(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", In = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, uh = /-->/g, dh = />/g, oi = RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), fh = /'/g, gh = /"/g, Bl = /^(?:script|style|textarea|title)$/i, Wu = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), Jo = Wu(1), un = Symbol.for("lit-noChange"), pt = Symbol.for("lit-nothing"), _h = /* @__PURE__ */ new WeakMap(), rn = cn.createTreeWalker(cn, 129, null, !1), ju = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; f < l.length && (o.lastIndex = f, u = o.exec(l), u !== null); )
      f = o.lastIndex, o === In ? u[1] === "!--" ? o = uh : u[1] !== void 0 ? o = dh : u[2] !== void 0 ? (Bl.test(u[2]) && (s = RegExp("</" + u[2], "g")), o = oi) : u[3] !== void 0 && (o = oi) : o === oi ? u[0] === ">" ? (o = s != null ? s : In, d = -1) : u[1] === void 0 ? d = -2 : (d = o.lastIndex - u[2].length, c = u[1], o = u[3] === void 0 ? oi : u[3] === '"' ? gh : fh) : o === gh || o === fh ? o = oi : o === uh || o === dh ? o = In : (o = oi, s = void 0);
    const g = o === oi && i[h + 1].startsWith("/>") ? " " : "";
    r += o === In ? l + zu : d >= 0 ? (n.push(c), l.slice(0, d) + "$lit$" + l.slice(d) + We + g) : l + We + (d === -2 ? (n.push(void 0), h) : g);
  }
  const a = r + (i[e] || "<?>") + (t === 2 ? "</svg>" : "");
  if (!Array.isArray(i) || !i.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return [ch !== void 0 ? ch.createHTML(a) : a, n];
};
class Yn {
  constructor({ strings: t, _$litType$: e }, n) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const a = t.length - 1, h = this.parts, [l, c] = ju(t, e);
    if (this.el = Yn.createElement(l, n), rn.currentNode = this.el.content, e === 2) {
      const u = this.el.content, d = u.firstChild;
      d.remove(), u.append(...d.childNodes);
    }
    for (; (s = rn.nextNode()) !== null && h.length < a; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) {
          const u = [];
          for (const d of s.getAttributeNames())
            if (d.endsWith("$lit$") || d.startsWith(We)) {
              ...
              if (u.push(d), f !== void 0) {
                ...
                h.push({ type: 1, index: r, name: _[2], strings: g, ctor: _[1] === "." ? Xu : _[1] === "?" ? Vu : _[1] === "@" ? qu : Rr });
              } else
...
class Uu {
  ...
  v(t) {
    ...
    rn.currentNode = r;
    let o = rn.nextNode(), a = 0, h = 0, l = s[0];
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new hs(o, o.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (c = new Ku(o, this, t)), this.u.push(c), l = s[++h];
      }
      a !== (l == null ? void 0 : l.index) && (o = rn.nextNode(), a++);
    }
    return r;
  }
  p(t) {
...
class hs {
  ...
  _$AI(t, e = this) {
    t = dn(this, t, e), Xn(t) ? t === pt || t == null || t === "" ? (this._$AH !== pt && this._$AR(), this._$AH = pt) : t !== this._$AH && t !== un && this.g(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Bu(t) ? this.k(t) : this.g(t);
  }
  O(t, e = this._$AB) {
  ...
  $(t) {
    ...
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === r)
      ...
      const o = new Uu(r, this), a = o.v(this.options);
      o.p(n), this.T(a), this._$AH = o;
    }
  }
  _$AC(t) {
    let e = _h.get(t.strings);
    return e === void 0 && _h.set(t.strings, e = new Yn(t)), e;
  }
  k(t) {
    zl(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let n, s = 0;
    for (const r of t)
...
const Yu = ln ? ln.emptyScript : "";
class Vu extends Rr {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== pt ? this.element.setAttribute(this.name, Yu) : this.element.removeAttribute(this.name);
  }
}
class qu extends Rr {
  constructor(t, e, n, s, r) {
...
const mh = er.litHtmlPolyfillSupport;
mh == null || mh(Yn, hs), ((Jr = er.litHtmlVersions) !== null && Jr !== void 0 ? Jr : er.litHtmlVersions = []).push("2.5.0");
const Hu = (i, t, e) => {
  var n, s;
...
class _i extends Xi {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Hu(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
_i.finalized = !0, _i._$litElement$ = !0, (Qr = globalThis.litElementHydrateSupport) === null || Qr === void 0 || Qr.call(globalThis, { LitElement: _i });
const yh = globalThis.litElementPolyfillSupport;
yh == null || yh({ LitElement: _i });
((to = globalThis.litElementVersions) !== null && to !== void 0 ? to : globalThis.litElementVersions = []).push("3.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Qo = (i) => (t) => typeof t == "function" ? ((e, n) => (customElements.define(e, n), n))(i, t) : ((e, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Zu = (i, t) => t.kind === "method" && t.descriptor && !("value" in t.descriptor) ? { ...t, finisher(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ju = ({ finisher: i, descriptor: t }) => (e, n) => {
  var s;
  if (n === void 0) {
 ...
 */
var eo;
((eo = window.HTMLSlotElement) === null || eo === void 0 ? void 0 : eo.prototype.assignedElements) != null;
class td {
  constructor(t) {
...
class od extends ea {
  ...
  removeEventListener(t, e) {
    ...
    if (n) {
      const s = n.indexOf(e);
      s !== -1 && (this.pendingRemovals_ && t in this.pendingRemovals_ ? (n[s] = Ci, ++this.pendingRemovals_[t]) : (n.splice(s, 1), n.length === 0 && delete this.listeners_[t]));
    }
  }
}
const Ir = od, z = {
...
let hd = 0;
function j(i) {
  return i.ol_uid || (i.ol_uid = String(++hd));
}
class ph extends Kt {
  constructor(t, e, n) {
...
class ld extends Wl {
  ...
  notify(t, e) {
    let n;
    n = `change:${t}`, this.hasListener(n) && this.dispatchEvent(new ph(n, t, e)), n = fn.PROPERTYCHANGE, this.hasListener(n) && this.dispatchEvent(new ph(n, t, e));
  }
...
class dd extends ie {
  ...
  updateLength_() {
    this.set(xh.LENGTH, this.array_.length);
  }
  assertUnique_(t, e) {
    for (let n = 0, s = this.array_.length; n < s; ++n)
...
const qt = dd, Ze = typeof navigator < "u" && typeof navigator.userAgent < "u" ? navigator.userAgent.toLowerCase() : "", fd = Ze.includes("firefox"), gd = Ze.includes("safari") && !Ze.includes("chrom");
gd && (Ze.includes("version/15.4") || /cpu (os|iphone os) 15_4 like mac os x/.test(Ze));
const _d = Ze.includes("webkit") && !Ze.includes("edge"), md = Ze.includes("macintosh"), Ul = typeof devicePixelRatio < "u" ? devicePixelRatio : 1, na = typeof WorkerGlobalScope < "u" && typeof OffscreenCanvas < "u" && self instanceof WorkerGlobalScope, yd = typeof Image < "u" && Image.prototype.decode, Xl = function() {
  let i = !1;
  try {
...
function Yl(i) {
  ...
  if (na)
    return t;
  const e = vh || (vh = document.createElement("div"));
...
function oa(i, t) {
  let e;
  return e = t(Or(i)), e || (e = t(Fr(i)), e) || (e = t(Dr(i)), e) || (e = t(Oi(i)), e) ? e : !1;
}
function To(i) {
  let t = 0;
  return aa(i) || (t = ot(i) * ue(i)), t;
}
function Or(i) {
  return [i[0], i[1]];
}
...
function Sd(i, t) {
  let e;
  return t === "bottom-left" ? e = Or(i) : t === "bottom-right" ? e = Fr(i) : t === "top-left" ? e = Oi(i) : t === "top-right" ? e = Dr(i) : Y(!1, 13), e;
}
function Ro(i, t, e, n, s) {
  const [r, o, a, h, l, c, u, d] = bo(
    i,
    t,
    e,
    n
...
function As(i, t) {
  return Math.floor(ha(i, t));
}
function Ps(i, t) {
  return Math.ceil(ha(i, t));
}
const Pd = /^#([a-f0-9]{3}|[a-f0-9]{4}(?:[a-f0-9]{2}){0,2})$/i, Ld = /^([a-z]*)$|^hsla?\(.*\)$/i;
function Jl(i) {
  return typeof i == "string" ? i : Ql(i);
}
function Od(i) {
...
function nr(i) {
  return Array.isArray(i) ? i : Fd(i);
}
function Dd(i) {
  let t, e, n, s, r;
  if (Ld.exec(i) && (i = Od(i)), Pd.exec(i)) {
    const o = i.length - 1;
    let a;
    o <= 4 ? a = 1 : a = 2;
    const h = o === 4 || o === 8;
    ...
    i.startsWith("rgba(") ? (r = i.slice(5, -1).split(",").map(Number), Ch(r)) : i.startsWith("rgb(") ? (r = i.slice(4, -1).split(",").map(Number), r.push(1), Ch(r)) : Y(!1, 14);
  return r;
}
function Ch(i) {
...
function ec(i, t) {
  if (t.canWrapX()) {
    const e = ot(t.getExtent()), n = jd(i, t, e);
    n && (i[0] -= n * e);
  }
  return i;
}
...
class Ud extends ea {
  ...
  forEachFeatureAtCoordinate(t, e, n, s, r, o, a, h) {
    ...
    const d = c.projection, f = ec(t.slice(), d), g = [[0, 0]];
    if (d.canWrapX() && s) {
    ...
    for (let v = 0; v < g.length; v++)
      for (let M = m - 1; M >= 0; --M) {
        ...
        if (S.hasRenderer() && la(C, c) && a.call(h, S)) {
  ...
  scheduleExpireIconCache(t) {
    sr.canExpireCache() && t.postRenderFunctions.push(Xd);
  }
}
function Xd(i, t) {
  sr.expire();
...
const ic = Vd, Ls = "ol-hidden", Mn = "ol-unselectable", Sh = "ol-unsupported", kr = "ol-control", wh = "ol-collapsed", qd = new RegExp(
  [
...
function jt(i, t, e, n) {
  let s;
  return e && e.length ? s = e.shift() : na ? s = new OffscreenCanvas(i || 300, t || 300) : s = document.createElement("canvas"), i && (s.width = i), t && (s.height = t), s.getContext("2d", n);
}
function sc(i) {
  const t = i.canvas;
...
const rc = "10px sans-serif", Ie = "#000", ar = "round", qn = [], Kn = 0, _n = "round", Hn = 10, Zn = "#000", Jn = "center", hr = "middle", di = [0, 0, 0, 0], Qn = 1, Ce = new ie();
let Yi = null, Ao;
const Po = {}, Zd = function() {
...
`)) ? (ls(Po), Yi = null, Ao = void 0, Ce.set(f, 100)) : (Ce.set(f, Ce.get(f) + 1, !0), l = !1));
    }
...
function oc(i, t) {
  return Yi || (Yi = jt(1, 1)), i != Ao && (Yi.font = i, Ao = Yi.font), Yi.measureText(t);
}
function lr(i, t) {
  return oc(i, t).width;
}
...
function tf(i, t, e, n, s, r, o, a, h, l, c) {
  i.save(), e !== 1 && (i.globalAlpha *= e), t && i.setTransform.apply(i, t), n.contextInstructions ? (i.translate(h, l), i.scale(c[0], c[1]), ef(n, i)) : c[0] < 0 || c[1] < 0 ? (i.translate(h, l), i.scale(c[0], c[1]), i.drawImage(
    n,
    s,
    r,
    o,
...
class nf extends Yd {
  ...
  renderFrame(t) {
    ...
    Hd(this.element_, this.children_), this.dispatchRenderEvent(Ke.POSTCOMPOSE, t), this.renderedVisible_ || (this.element_.style.display = "", this.renderedVisible_ = !0), this.scheduleExpireIconCache(t);
  }
}
const sf = nf;
class Be extends Kt {
...
class da extends tc {
  constructor(t) {
    ...
    delete e.layers;
    let n = t.layers;
    super(e), this.on, this.once, this.un, this.layersListenerKeys_ = [], this.listenerKeys_ = {}, this.addChangeListener(io.LAYERS, this.handleLayersChanged_), n ? Array.isArray(n) ? n = new qt(n.slice(), { unique: !0 }) : Y(typeof n.getArray == "function", 43) : n = new qt(void 0, { unique: !0 }), this.setLayers(n);
  }
  handleLayerChange_() {
    this.changed();
  }
...
class af extends Ir {
  ...
  handlePointerDown_(t) {
    ...
    for (const n in t) {
      const s = t[n];
      this.down_[n] = typeof s == "function" ? Ci : s;
    }
...
const ac = _f, us = 6378137, Zi = Math.PI * us, mf = [-Zi, -Zi, Zi, Zi], yf = [-180, -85, 180, 85], Os = us * Math.log(Math.tan(Math.PI / 2));
class Bi extends ac {
  constructor(t) {
    super({
      code: t,
...
const bh = [
  ...
  new Bi("EPSG:102113"),
  new Bi("EPSG:900913"),
  new Bi("http://www.opengis.net/def/crs/EPSG/0/3857"),
  new Bi("http://www.opengis.net/gml/srs/epsg.xml#3857")
];
function pf(i, t, e) {
  const n = i.length;
...
function xf(i, t, e) {
  ...
  e = e > 1 ? e : 2, t === void 0 && (e > 2 ? t = i.slice() : t = new Array(n));
  for (let s = 0; s < n; s += e)
    t[s] = 180 * i[s] / Zi, t[s + 1] = 360 * Math.atan(Math.exp(i[s + 1] / us)) / Math.PI - 90;
  return t;
}
const vf = 6378137, Ih = [-180, -90, 180, 90], Mf = Math.PI * vf / 180;
class ai extends ac {
  constructor(t, e) {
    super({
      code: t,
...
let Oo = {};
function Cf(i) {
  return Oo[i] || Oo[i.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, "EPSG:$3")] || null;
}
function Ef(i, t) {
  Oo[i] = t;
}
...
function Ph(i, t, e) {
  e = e || hc;
  const n = mi(i[1]), s = mi(t[1]), r = (s - n) / 2, o = mi(t[0] - i[0]) / 2, a = Math.sin(r) * Math.sin(r) + Math.sin(o) * Math.sin(o) * Math.cos(n) * Math.cos(s);
  return 2 * e * Math.atan2(Math.sqrt(a), Math.sqrt(1 - a));
}
function wf(i, t, e, n) {
  n = n || hc;
  const s = mi(i[1]), r = mi(i[0]), o = t / n, a = Math.asin(
...
function Rf(i) {
  Ef(i.getCode(), i), ur(i, i, ga);
}
function bf(i) {
  i.forEach(Rf);
}
function st(i) {
  return typeof i == "string" ? Cf(i) : i || null;
}
function dr(i, t, e, n) {
  i = st(i);
  let s;
  ...
  if (r) {
    ...
    if (o == "degrees" && !n || n == "degrees")
      ...
      if (a === _a && o !== "degrees")
        ...
        l = a(l, l, 2);
        const c = Ph(l.slice(0, 2), l.slice(2, 4)), u = Ph(l.slice(4, 6), l.slice(6, 8));
        s = (c + u) / 2;
      }
...
function we(i, t) {
  ...
  return (i.getCode() === t.getCode() || $r(i, t) === ga) && e;
}
function $r(i, t) {
...
function Pf(i, t, e, n) {
  const s = ts(t, e);
  return Rd(i, s, void 0, n);
}
function yn(i, t) {
  return i;
}
function rt(i, t) {
  return Fo && !Jt(i, [0, 0]) && i[0] >= -180 && i[0] <= 180 && i[1] >= -90 && i[1] <= 90 && (Fo = !1, console.warn(
...
function Ff(i, t, e, n) {
  return t = t !== void 0 ? t : !0, function(s, r, o, a) {
    if (s !== void 0) {
      const h = i[0], l = i[i.length - 1], c = e ? pa(
        h,
        e,
        o,
        n
      ...
      const u = Math.min(c, s), d = Math.floor(ia(i, u, r));
      return i[d] > c && d < i.length - 1 ? i[d + 1] : i[d];
    } else
      return;
  };
}
function Df(i, t, e, n, s, r) {
...
class Bf extends ie {
  constructor() {
    super(), this.extent_ = Wt(), this.extentRevision_ = -1, this.simplifiedGeometryMaxMinSquaredTolerance = 0, this.simplifiedGeometryRevision = 0, this.simplifyTransformedInternal = rd(function(t, e, n) {
      if (!n)
...
class Wf extends uc {
  ...
  scale(t, e, n) {
    e === void 0 && (e = t), n || (n = Ei(this.getExtent()));
...
function Ca(i, t, e, n, s) {
  let r = i[t], o = i[t + 1];
  for (t += n; t < e; t += n) {
    const a = i[t], h = i[t + 1], l = Re(r, o, a, h);
    l > s && (s = l), r = a, o = h;
  }
  return s;
}
...
function Xf(i, t, e, n, s) {
  for (let r = 0, o = e.length; r < o; ++r) {
    const a = e[r];
    s = Ea(i, t, a, n, s), t = a[a.length - 1];
  }
  return s;
}
function Sa(i, t, e, n, s, r, o, a, h, l, c) {
  if (t == e)
    return l;
  let u, d;
  if (s === 0)
...
function wa(i, t, e, n, s, r, o, a, h, l, c) {
  c = c || [NaN, NaN];
...
function Yf(i, t, e, n, s, r, o, a, h, l, c) {
  c = c || [NaN, NaN];
  for (let u = 0, d = e.length; u < d; ++u) {
    const f = e[u];
    l = wa(
...
function Ra(i, t, e, n, s, r, o) {
  ...
  for (; l.length > 0; ) {
    ...
    for (let p = d + n; p < u; p += n) {
      const x = i[p], v = i[p + 1], M = Id(x, v, g, _, m, y);
      M > f && (c = p, f = M);
    }
...
class gr extends ni {
  ...
  closestPointXY(t, e, n, s) {
    ...
    ), this.maxDeltaRevision_ = this.getRevision()), Sa(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
  ...
  setCoordinates(t, e) {
    this.setLayout(e, t, 1), this.flatCoordinates || (this.flatCoordinates = []), this.flatCoordinates.length = zr(
      this.flatCoordinates,
      0,
      t,
      this.stride
...
class ba extends ni {
  ...
  clone() {
    const t = new ba(this.flatCoordinates.slice(), this.layout);
  ...
  intersectsExtent(t) {
    return ra(t, this.flatCoordinates[0], this.flatCoordinates[1]);
  }
  setCoordinates(t, e) {
...
function Ia(i, t, e, n, s, r) {
  if (e.length === 0 || !fi(i, t, e[0], n, s, r))
    return !1;
  for (let o = 1, a = e.length; o < a; ++o)
    if (fi(i, e[o - 1], e[o], n, s, r))
      return !1;
  return !0;
}
...
function mc(i, t, e, n, s, r, o) {
  ...
  let m = NaN, y = -1 / 0;
  for (_.sort(vi), c = _[0], a = 1, h = _.length; a < h; ++a) {
    u = _[a];
    const p = Math.abs(u - c);
    p > y && (l = (c + u) / 2, Ia(i, t, e, n, l, g) && (m = l, y = p)), c = u;
  }
...
function Br(i, t, e, n, s) {
  ...
  return At(s, r) ? ui(s, r) || r[0] >= s[0] && r[2] <= s[2] || r[1] >= s[1] && r[3] <= s[3] ? !0 : yc(
    i,
    t,
    e,
    n,
...
function No(i, t, e, n, s) {
  ...
  for (let r = 0, o = e.length; r < o; ++r) {
    ...
    (r === 0 ? s && h || !s && !h : s && !h || !s && h) && ng(i, t, a, n), t = a;
  }
  return t;
}
...
class Si extends ni {
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), No(e, 0, this.ends_, this.stride, t)) : e = this.flatCoordinates, es(e, 0, this.ends_, this.stride);
  }
  getEnds() {
    return this.ends_;
  }
  getFlatInteriorPoint() {
    if (this.flatInteriorPointRevision_ != this.getRevision()) {
      const t = Ei(this.getExtent());
      this.flatInteriorPoint_ = mc(
        this.getOrientedFlatCoordinates(),
        0,
        this.ends_,
        this.stride,
  ...
  getLinearRing(t) {
    return t < 0 || this.ends_.length <= t ? null : new Gh(
      this.flatCoordinates.slice(
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      Mc(t, 0, this.ends_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = No(
...
function rg(i, t, e, n) {
  ...
  for (let r = 0; r < e; ++r)
    ae(
      s,
      wf(i, t, 2 * Math.PI * r / e, n)
    );
  return s.push(s[0], s[1]), new Si(s, "XY", [s.length]);
}
function zh(i) {
...
function og(i, t, e) {
  ...
  const h = [a.length], l = new Si(a, s, h);
  return ag(l, r, i.getRadius(), e), l;
}
function ag(i, t, e, n) {
  const s = i.getFlatCoordinates(), r = i.getStride(), o = s.length / r - 1, a = n || 0;
  for (let h = 0; h <= o; ++h) {
    const l = h * r, c = a + yi(h, o) * 2 * Math.PI / o;
...
class hg extends ie {
  constructor(t) {
    super(), this.on, this.once, this.un, t = Object.assign({}, t), this.hints_ = [0, 0], this.animations_ = [], this.updateAnimationKey_, this.projection_ = ma(t.projection, "EPSG:3857"), this.viewportSize_ = [100, 100], this.targetCenter_ = null, this.targetResolution_, this.targetRotation_, this.nextCenter_ = null, this.nextResolution_, this.nextRotation_, this.cancelAnchor_ = void 0, t.projection && Tf(), t.center && (t.center = rt(t.center, this.projection_)), t.extent && (t.extent = Ue(t.extent, this.projection_)), this.applyOptions_(t);
  }
  applyOptions_(t) {
    const e = Object.assign({}, t);
    for (const a in Zt)
    ...
    const s = lg(t), r = n.constraint, o = ug(t);
    this.constraints_ = {
      center: s,
      resolution: r,
      rotation: o
  ...
  animateInternal(t) {
    ...
    for (; s < e; ++s) {
      ...
      if (c.center && (u.sourceCenter = o, u.targetCenter = c.center.slice(), o = u.targetCenter), c.zoom !== void 0 ? (u.sourceResolution = a, u.targetResolution = this.getResolutionForZoom(c.zoom), a = u.targetResolution) : c.resolution && (u.sourceResolution = a, u.targetResolution = c.resolution, a = u.targetResolution), c.rotation !== void 0) {
        u.sourceRotation = h;
        const d = yi(c.rotation - h + Math.PI, 2 * Math.PI) - Math.PI;
        u.targetRotation = h + d, h = u.targetRotation;
      }
      dg(u) ? u.complete = !0 : r += u.duration, l.push(u);
    }
    ...
    for (let n = this.animations_.length - 1; n >= 0; --n) {
      ...
      for (let o = 0, a = s.length; o < a; ++o) {
        ...
        if (h.sourceRotation !== void 0 && h.targetRotation !== void 0) {
          const d = u === 1 ? yi(h.targetRotation + Math.PI, 2 * Math.PI) - Math.PI : h.sourceRotation + u * (h.targetRotation - h.sourceRotation);
          if (h.anchor) {
  ...
  calculateCenterRotate(t, e) {
    ...
    return s !== void 0 && (n = [s[0] - e[0], s[1] - e[1]], ua(n, t - this.getRotation()), $d(n, e)), n;
  }
  ...
  calculateExtent(t) {
    ...
    return ya(e, this.getProjection());
  }
  calculateExtentInternal(t) {
    ...
    return Y(s !== void 0, 3), Ro(e, n, s, t);
  }
  getMaxResolution() {
  ...
  getZoomForResolution(t) {
    ...
    if (this.resolutions_) {
      const r = ia(this.resolutions_, t, 1);
  ...
  fit(t, e) {
    ...
    if (Y(
      ...
      n = zh(s), n.rotate(this.getRotation(), Ei(s));
    } else
      n = t;
  ...
  fitInternal(t, e) {
    ...
    const l = this.getRotation(), c = Math.sin(l), u = Math.cos(l), d = Ei(a);
    d[0] += (s[1] - s[3]) / 2 * h, d[1] += (s[0] - s[2]) / 2 * h;
    const f = d[0] * u - d[1] * c, g = d[1] * u + d[0] * c, _ = this.getConstrainedCenter([f, g], h), m = e.callback ? e.callback : Ci;
  ...
  calculateCenterShift(t, e, n, s) {
    ...
    if (o && t) {
      const a = this.getViewportSizeMinusPadding_(-n), h = so(
        t,
        s,
        [a[0] / 2 + o[3], a[1] / 2 + o[0]],
        e,
...
function lg(i) {
  if (i.extent !== void 0) {
    ...
    return Oh(i.extent, i.constrainOnlyCenter, e);
  }
  const t = ma(i.projection, "EPSG:3857");
  if (i.multiWorld !== !0 && t.isGlobal()) {
    const e = t.getExtent().slice();
    return e[0] = -1 / 0, e[2] = 1 / 0, Oh(e, !1, !1);
  }
  return Of;
}
function cg(i) {
  let t, e, n, o = i.minZoom !== void 0 ? i.minZoom : no, a = i.maxZoom !== void 0 ? i.maxZoom : 28;
  const h = i.zoomFactor !== void 0 ? i.zoomFactor : 2, l = i.multiWorld !== void 0 ? i.multiWorld : !1, c = i.smoothResolutionConstraint !== void 0 ? i.smoothResolutionConstraint : !0, u = i.showFullExtent !== void 0 ? i.showFullExtent : !1, d = ma(i.projection, "EPSG:3857"), f = d.getExtent();
  let g = i.constrainOnlyCenter, _ = i.extent;
  if (!l && !_ && d.isGlobal() && (g = !1, _ = f), i.resolutions !== void 0) {
    const m = i.resolutions;
    e = m[o], n = m[a] !== void 0 ? m[a] : m[m.length - 1], i.constrainResolution ? t = Ff(
      m,
      c,
      !g && _,
      u
    ...
    const y = (f ? Math.max(ot(f), ue(f)) : 360 * mn.degrees / d.getMetersPerUnit()) / fa / Math.pow(2, no), p = y / Math.pow(2, 28 - no);
    ...
    ), n = e / Math.pow(h, a - o), i.constrainResolution ? t = Df(
      h,
      e,
      n,
      c,
...
function ug(i) {
  if (i.enableRotation !== void 0 ? i.enableRotation : !0) {
    ...
    return e === void 0 || e === !0 ? kf() : e === !1 ? Dh : typeof e == "number" ? Nf(e) : Dh;
  } else
    return va;
}
function dg(i) {
...
class fg extends ie {
  ...
  disposeInternal() {
    Io(this.element), super.disposeInternal();
  }
  getMap() {
    return this.map_;
  }
  setMap(t) {
    this.map_ && Io(this.element);
    for (let e = 0, n = this.listenerKeys.length; e < n; ++e)
      et(this.listenerKeys[e]);
    this.listenerKeys.length = 0, this.map_ = t, t && ((this.target_ ? this.target_ : t.getOverlayContainerStopEvent()).appendChild(this.element), this.render !== Ci && this.listenerKeys.push(
...
class gg extends fe {
  constructor(t) {
    ...
    const l = e + " " + Mn + " " + kr + (this.collapsed_ && this.collapsible_ ? " " + wh : "") + (this.collapsible_ ? "" : " ol-uncollapsible"), c = this.element;
  ...
  handleToggle_() {
    this.element.classList.toggle(wh), this.collapsed_ ? or(this.collapseLabel_, this.label_) : or(this.label_, this.collapseLabel_), this.collapsed_ = !this.collapsed_, this.toggleButton_.setAttribute("aria-expanded", String(!this.collapsed_));
  }
  getCollapsible() {
...
class mg extends fe {
  constructor(t) {
    ...
    const a = e + " " + Mn + " " + kr, h = this.element;
...
class pg extends fe {
  constructor(t) {
    ...
    const d = e + " " + Mn + " " + kr, f = this.element;
...
function xg(i) {
  i = i || {};
  const t = new qt();
  return (i.zoom !== void 0 ? i.zoom : !0) && t.push(new Cc(i.zoomOptions)), (i.rotate !== void 0 ? i.rotate : !0) && t.push(new yg(i.rotateOptions)), (i.attribution !== void 0 ? i.attribution : !0) && t.push(new _g(i.attributionOptions)), t;
}
const ko = {
  ACTIVE: "active"
};
...
class Cg extends ds {
  ...
  handleEvent(t) {
    ...
    if (t.type == V.DBLCLICK) {
      ...
      Aa(a, o, r, this.duration_), n.preventDefault(), e = !0;
    }
    return !e;
  }
}
...
const wg = function(i) {
  ...
  return i.map.getTargetElement().hasAttribute("tabindex") ? Rg(i) : !0;
}, _r = Mi, Sc = function(i) {
  const t = i.originalEvent;
  return t.button == 0 && !(_d && md && t.ctrlKey);
}, bg = Pi, Ig = function(i) {
...
class Ag extends si {
  constructor(t) {
    ...
    const e = t.condition ? t.condition : Go(La, Rc);
    this.condition_ = t.onFocusOnly ? Go(Ec, e) : e, this.noKinetic_ = !1;
  }
  handleDragEvent(t) {
    this.panning_ || (this.panning_ = !0, this.getMap().getView().beginInteraction());
    const e = this.targetPointers, n = Pa(e);
    if (e.length == this.lastPointersCount_) {
      if (this.kinetic_ && this.kinetic_.update(n[0], n[1]), this.lastCentroid) {
        ...
        Bd(s, o.getResolution()), ua(s, o.getRotation()), o.adjustCenterInternal(s);
      }
    } else
...
class Lg extends si {
  constructor(t) {
    t = t || {}, super({
      stopDown: Pi
    }), this.condition_ = t.condition ? t.condition : Tg, this.lastAngle_ = void 0, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  handleDragEvent(t) {
    if (!ro(t))
      return;
    const e = t.map, n = e.getView();
    if (n.getConstraints().rotation === va)
      return;
  ...
  handleUpEvent(t) {
    return ro(t) ? (t.map.getView().endInteraction(this.duration_), !1) : !0;
  }
  handleDownEvent(t) {
    return ro(t) && Sc(t) && this.condition_(t) ? (t.map.getView().beginInteraction(), this.lastAngle_ = void 0, !0) : !1;
  }
}
const Og = Lg;
class Fg extends ea {
...
class Gg extends kg {
  constructor(t) {
    t = t || {};
    const e = t.condition ? t.condition : wc;
    super({
      condition: e,
  ...
  handleEvent(t) {
    ...
    if (t.type == z.KEYDOWN) {
      ...
      if (this.condition_(t) && (s == hi.DOWN || s == hi.LEFT || s == hi.RIGHT || s == hi.UP)) {
        ...
        const c = [h, l];
        ua(c, o.getRotation()), Mg(o, c, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class Wg extends ds {
  constructor(t) {
    super(), t = t || {}, this.condition_ = t.condition ? t.condition : Tc, this.delta_ = t.delta ? t.delta : 1, this.duration_ = t.duration !== void 0 ? t.duration : 100;
  }
  handleEvent(t) {
    let e = !1;
    if (t.type == z.KEYDOWN || t.type == z.KEYPRESS) {
      ...
      if (this.condition_(t) && (s == "+".charCodeAt(0) || s == "-".charCodeAt(0))) {
        ...
        Aa(a, o, void 0, this.duration_), n.preventDefault(), e = !0;
      }
    }
    return !e;
  }
...
class Yg extends ds {
  constructor(t) {
    ...
    this.condition_ = t.onFocusOnly ? Go(Ec, e) : e, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_, this.mode_ = void 0, this.trackpadEventGap_ = 400, this.trackpadTimeoutId_, this.deltaPerZoom_ = 300;
  }
  endInteraction_() {
  ...
  handleEvent(t) {
    ...
    let r;
    if (t.type == z.WHEEL && (r = s.deltaY, fd && s.deltaMode === WheelEvent.DOM_DELTA_PIXEL && (r /= Ul), s.deltaMode === WheelEvent.DOM_DELTA_LINE && (r *= 40)), r === 0)
      return !1;
    this.lastDelta_ = r;
    const o = Date.now();
  ...
  handleWheelZoom_(t) {
    ...
    (e.getConstrainResolution() || this.constrainResolution_) && (n = n ? n > 0 ? 1 : -1 : 0), Aa(e, n, this.lastAnchor_, this.duration_), this.mode_ = void 0, this.totalDelta_ = 0, this.lastAnchor_ = null, this.startTime_ = void 0, this.timeoutId_ = void 0;
  }
  setMouseAnchor(t) {
...
class qg extends si {
  constructor(t) {
    t = t || {};
    const e = t;
    e.stopDown || (e.stopDown = Pi), super(e), this.anchor_ = null, this.lastAngle_ = void 0, this.rotating_ = !1, this.rotationDelta_ = 0, this.threshold_ = t.threshold !== void 0 ? t.threshold : 0.3, this.duration_ = t.duration !== void 0 ? t.duration : 250;
  }
  handleDragEvent(t) {
    let e = 0;
    ...
    if (a.getConstraints().rotation === va)
      return;
    const h = o.getViewport().getBoundingClientRect(), l = Pa(this.targetPointers);
...
class Hg extends si {
  constructor(t) {
    t = t || {};
    const e = t;
    e.stopDown || (e.stopDown = Pi), super(e), this.anchor_ = null, this.duration_ = t.duration !== void 0 ? t.duration : 400, this.lastDistance_ = void 0, this.lastScaleDelta_ = 1;
  }
  handleDragEvent(t) {
    let e = 1;
    ...
    const c = h.getViewport().getBoundingClientRect(), u = Pa(this.targetPointers);
...
function Jg(i) {
  i = i || {};
  const t = new qt(), e = new Xg(-5e-3, 0.05, 100);
  return (i.altShiftDragRotate !== void 0 ? i.altShiftDragRotate : !0) && t.push(new Og()), (i.doubleClickZoom !== void 0 ? i.doubleClickZoom : !0) && t.push(
    new Eg({
      delta: i.zoomDelta,
  ...
  ), (i.pinchRotate !== void 0 ? i.pinchRotate : !0) && t.push(new Kg()), (i.pinchZoom !== void 0 ? i.pinchZoom : !0) && t.push(
    new Zg({
      duration: i.zoomDuration
    })
  ), (i.keyboard !== void 0 ? i.keyboard : !0) && (t.push(new Bg()), t.push(
    new jg({
      delta: i.zoomDelta,
      duration: i.zoomDuration
    })
...
function bc(i) {
  ...
  i instanceof Gr && i.getLayers().forEach(bc);
}
function Ic(i, t) {
  if (i instanceof Nr) {
    i.setMapInternal(t);
...
class t_ extends ie {
  constructor(t) {
    ...
    const e = e_(t);
    this.renderComplete_, this.loaded_ = !0, this.boundHandleBrowserEvent_ = this.handleBrowserEvent.bind(this), this.maxTilesLoading_ = t.maxTilesLoading !== void 0 ? t.maxTilesLoading : 16, this.pixelRatio_ = t.pixelRatio !== void 0 ? t.pixelRatio : Ul, this.postRenderTimeoutHandle_, this.animationDelayKey_, this.animationDelay_ = this.animationDelay_.bind(this), this.coordinateToPixelTransform_ = he(), this.pixelToCoordinateTransform_ = he(), this.frameIndex_ = 0, this.frameState_ = null, this.previousExtent_ = null, this.viewPropertyListenerKey_ = null, this.viewChangeListenerKey_ = null, this.layerGroupPropertyListenerKeys_ = null, this.viewport_ = document.createElement("div"), this.viewport_.className = "ol-viewport" + ("ontouchstart" in window ? " ol-touch" : ""), this.viewport_.style.position = "relative", this.viewport_.style.overflow = "hidden", this.viewport_.style.width = "100%", this.viewport_.style.height = "100%", this.overlayContainer_ = document.createElement("div"), this.overlayContainer_.style.position = "absolute", this.overlayContainer_.style.zIndex = "0", this.overlayContainer_.style.width = "100%", this.overlayContainer_.style.height = "100%", this.overlayContainer_.style.pointerEvents = "none", this.overlayContainer_.className = "ol-overlaycontainer", this.viewport_.appendChild(this.overlayContainer_), this.overlayContainerStopEvent_ = document.createElement("div"), this.overlayContainerStopEvent_.style.position = "absolute", this.overlayContainerStopEvent_.style.zIndex = "0", this.overlayContainerStopEvent_.style.width = "100%", this.overlayContainerStopEvent_.style.height = "100%", this.overlayContainerStopEvent_.style.pointerEvents = "none", this.overlayContainerStopEvent_.className = "ol-overlaycontainer-stopevent", this.viewport_.appendChild(this.overlayContainerStopEvent_), this.mapBrowserEventHandler_ = null, this.moveTolerance_ = t.moveTolerance, this.keyboardEventTarget_ = e.keyboardEventTarget, this.targetChangeHandlerKeys_ = null, this.controls = e.controls || xg(), this.interactions = e.interactions || Jg({
      onFocusOnly: !0
    }), this.overlays_ = e.overlays, this.overlayIdIndex_ = {}, this.renderer_ = null, this.postRenderFunctions_ = [], this.tileQueue_ = new df(
  ...
  forEachFeatureAtPixel(t, e, n) {
    ...
    n = n !== void 0 ? n : {};
    const r = n.hitTolerance !== void 0 ? n.hitTolerance : 0, o = n.layerFilter !== void 0 ? n.layerFilter : Mi, a = n.checkWrapped !== !1;
  ...
  getAllLayers() {
    ...
    function e(n) {
      n.forEach(function(s) {
        s instanceof Gr ? e(s.getLayers()) : t.push(s);
      });
    }
  ...
  hasFeatureAtPixel(t, e) {
    ...
    e = e !== void 0 ? e : {};
    const s = e.layerFilter !== void 0 ? e.layerFilter : Mi, r = e.hitTolerance !== void 0 ? e.hitTolerance : 0, o = e.checkWrapped !== !1;
  ...
  handleMapBrowserEvent(t) {
    ...
    if (n === Lo.POINTERDOWN || n === z.WHEEL || n === z.KEYDOWN) {
  ...
  handlePostRender() {
    ...
    t && this.renderer_ && !t.animate && (this.renderComplete_ === !0 ? (this.hasListener(Ke.RENDERCOMPLETE) && this.renderer_.dispatchRenderEvent(
      ...
      new Vi(ze.LOADEND, this, t)
    ))) : this.loaded_ === !0 && (this.loaded_ = !1, this.dispatchEvent(
      new Vi(ze.LOADSTART, this, t)
    )));
  ...
  handleTargetChanged_() {
    if (this.mapBrowserEventHandler_) {
      ...
      this.targetChangeHandlerKeys_ = null, this.viewport_.removeEventListener(
        ...
        z.WHEEL,
        this.boundHandleBrowserEvent_
      ), this.mapBrowserEventHandler_.dispose(), this.mapBrowserEventHandler_ = null, Io(this.viewport_);
    }
    const t = this.getTargetElement();
    if (!t)
      this.renderer_ && (clearTimeout(this.postRenderTimeoutHandle_), this.postRenderTimeoutHandle_ = void 0, this.postRenderFunctions_.length = 0, this.renderer_.dispose(), this.renderer_ = null), this.animationDelayKey_ && (cancelAnimationFrame(this.animationDelayKey_), this.animationDelayKey_ = void 0);
    else {
      t.appendChild(this.viewport_), this.renderer_ || (this.renderer_ = new sf(this)), this.mapBrowserEventHandler_ = new hf(
        this,
        this.moveTolerance_
      );
      for (const s in V)
  ...
  renderFrame_(t) {
    ...
    this.frameState_ = r, this.renderer_.renderFrame(r), r && (r.animate && this.render(), Array.prototype.push.apply(
    ...
    ), s && (!this.previousExtent_ || !aa(this.previousExtent_) && !Vn(r.extent, this.previousExtent_)) && (this.dispatchEvent(
      new Vi(ze.MOVESTART, this, s)
      ...
      new Vi(ze.MOVEEND, this, r)
    ), Vl(r.extent, this.previousExtent_))), this.dispatchEvent(new Vi(ze.POSTRENDER, this, r)), this.renderComplete_ = this.hasListener(ze.LOADSTART) || this.hasListener(ze.LOADEND) || this.hasListener(Ke.RENDERCOMPLETE) ? !this.tileQueue_.getTilesLoading() && !this.tileQueue_.getCount() && !this.getLoadingOrNotReady() : void 0, this.postRenderTimeoutHandle_ || (this.postRenderTimeoutHandle_ = setTimeout(() => {
  ...
  updateSize() {
    ...
    if (t) {
      ...
      !isNaN(s) && !isNaN(r) && (e = [s, r], !Bh(e) && !!(t.offsetWidth || t.offsetHeight || t.getClientRects().length) && console.warn(
...
function e_(i) {
  ...
  const e = {}, n = i.layers && typeof i.layers.getLayers == "function" ? i.layers : new Gr({
    layers: i.layers
  });
...
class Oa extends ie {
  ...
  clone() {
    const t = new Oa(this.hasProperties() ? this.getProperties() : null);
  ...
  setStyle(t) {
    this.style_ = t, this.styleFunction_ = t ? n_(t) : void 0, this.changed();
  }
  setId(t) {
...
class r_ extends ie {
  ...
  positionChange_(t) {
    ...
    this.set(ht.ACCURACY, e.accuracy), this.set(
      ...
      ht.HEADING,
      e.heading === null ? void 0 : mi(e.heading)
...
function Ac(i, t, e, n, s, r, o) {
  ...
  if (l === 1)
    ...
    const g = s * d, _ = id(f, g);
    _ < 0 ? (h = (g - f[-_ - 2]) / (f[-_ - 1] - f[-_ - 2]), a = t + (-_ - 2) * n) : a = t + _ * n;
  }
  o = o > 1 ? o : 2, r = r || new Array(o);
  for (let c = 0; c < o; ++c)
    r[c] = a === void 0 ? NaN : h === void 0 ? i[a + c] : Se(i[a + c], i[a + n + c], h);
  return r;
}
function $o(i, t, e, n, s, r) {
  if (e == t)
    return null;
  let o;
  if (s < i[t + n - 1])
...
class mr extends ni {
  ...
  getCoordinateAtM(t, e) {
    return this.layout != "XYM" && this.layout != "XYZM" ? null : (e = e !== void 0 ? e : !1, $o(
      this.flatCoordinates,
      0,
      this.flatCoordinates.length,
      this.stride,
...
class ka extends Lc {
  ...
  clone() {
    const t = this.getScale(), e = new ka({
  ...
  draw_(t, e, n) {
    if (e.scale(n, n), e.translate(t.size / 2, t.size / 2), this.createPath_(e), this.fill_) {
      ...
      s === null && (s = Ie), e.fillStyle = re(s), e.fill();
    }
  ...
  drawHitDetectionCanvas_(t, e) {
    e.translate(t.size / 2, t.size / 2), this.createPath_(e), e.fillStyle = Ie, e.fill(), this.stroke_ && (e.strokeStyle = t.strokeStyle, e.lineWidth = t.strokeWidth, t.lineDash && (e.setLineDash(t.lineDash), e.lineDashOffset = t.lineDashOffset), e.lineJoin = t.lineJoin, e.miterLimit = t.miterLimit, e.stroke());
  }
}
const Oc = ka;
class Ga extends Oc {
  ...
  clone() {
    const t = this.getScale(), e = new Ga({
      fill: this.getFill() ? this.getFill().clone() : void 0,
      stroke: this.getStroke() ? this.getStroke().clone() : void 0,
      radius: this.getRadius(),
      scale: Array.isArray(t) ? t.slice() : t,
...
class Ye {
  constructor(t) {
    t = t || {}, this.geometry_ = null, this.geometryFunction_ = Wh, t.geometry !== void 0 && this.setGeometry(t.geometry), this.fill_ = t.fill !== void 0 ? t.fill : null, this.image_ = t.image !== void 0 ? t.image : null, this.renderer_ = t.renderer !== void 0 ? t.renderer : null, this.hitDetectionRenderer_ = t.hitDetectionRenderer !== void 0 ? t.hitDetectionRenderer : null, this.stroke_ = t.stroke !== void 0 ? t.stroke : null, this.text_ = t.text !== void 0 ? t.text : null, this.zIndex_ = t.zIndex;
  }
  clone() {
  ...
  setGeometry(t) {
    typeof t == "function" ? this.geometryFunction_ = t : typeof t == "string" ? this.geometryFunction_ = function(e) {
      ...
      return t;
    }) : this.geometryFunction_ = Wh, this.geometry_ = t;
  }
  setZIndex(t) {
    this.zIndex_ = t;
  }
...
class $a {
  constructor(t) {
    t = t || {}, this.font_ = t.font, this.rotation_ = t.rotation, this.rotateWithView_ = t.rotateWithView, this.scale_ = t.scale, this.scaleArray_ = zt(t.scale !== void 0 ? t.scale : 1), this.text_ = t.text, this.textAlign_ = t.textAlign, this.justify_ = t.justify, this.textBaseline_ = t.textBaseline, this.fill_ = t.fill !== void 0 ? t.fill : new Qe({ color: c_ }), this.maxAngle_ = t.maxAngle !== void 0 ? t.maxAngle : Math.PI / 4, this.placement_ = t.placement !== void 0 ? t.placement : "point", this.overflow_ = !!t.overflow, this.stroke_ = t.stroke !== void 0 ? t.stroke : null, this.offsetX_ = t.offsetX !== void 0 ? t.offsetX : 0, this.offsetY_ = t.offsetY !== void 0 ? t.offsetY : 0, this.backgroundFill_ = t.backgroundFill ? t.backgroundFill : null, this.backgroundStroke_ = t.backgroundStroke ? t.backgroundStroke : null, this.padding_ = t.padding === void 0 ? null : t.padding;
  }
  clone() {
    const t = this.getScale();
    return new $a({
...
class Nc {
  ...
  search(t) {
    ...
    for (; e; ) {
      for (let o = 0; o < e.children.length; o++) {
        ...
        ks(t, h) && (e.leaf ? n.push(a) : lo(t, h) ? this._all(a, n) : r.push(a));
      }
      e = r.pop();
    }
    return n;
  ...
  remove(t, e) {
    ...
    for (; n || r.length; ) {
      if (n || (n = r.pop(), h = r[r.length - 1], a = o.pop(), l = !0), n.leaf) {
        const c = g_(t, n.children, e);
        if (c !== -1)
          return n.children.splice(c, 1), r.push(n), this._condense(r), this;
      }
      !l && !n.leaf && lo(n, s) ? (r.push(n), o.push(a), a = 0, h = n, n = n.children[0]) : h ? (a++, n = h.children[a], l = !1) : n = null;
    }
    return this;
  }
  toBBox(t) {
  ...
  _build(t, e, n, s) {
    ...
    if (r <= o)
      return a = qi(t.slice(e, n + 1)), Wi(a, this.toBBox), a;
    s || (s = Math.ceil(Math.log(r) / Math.log(o)), o = Math.ceil(r / Math.pow(o, s - 1))), a = qi([]), a.leaf = !1, a.height = s;
    const h = Math.ceil(r / o), l = h * Math.ceil(Math.sqrt(o));
    jh(t, e, n, l, this.compareMinX);
    for (let c = e; c <= n; c += l) {
      const u = Math.min(c + l - 1, n);
      jh(t, c, u, h, this.compareMinY);
      for (let d = c; d <= u; d += h) {
        const f = Math.min(d + h - 1, u);
        a.children.push(this._build(t, d, f, s - 1));
      }
    }
    return Wi(a, this.toBBox), a;
  }
  _chooseSubtree(t, e, n, s) {
    for (; s.push(e), !(e.leaf || s.length - 1 === n); ) {
      let r = 1 / 0, o = 1 / 0, a;
      for (let h = 0; h < e.children.length; h++) {
        const l = e.children[h], c = ho(l), u = y_(t, l) - c;
  ...
  _split(t, e) {
    ...
    const o = this._chooseSplitIndex(n, r, s), a = qi(n.children.splice(o, n.children.length - o));
    a.height = n.height, a.leaf = n.leaf, Wi(n, this.toBBox), Wi(a, this.toBBox), e ? t[e - 1].children.push(a) : this._splitRoot(n, a);
  }
  _splitRoot(t, e) {
    this.data = qi([t, e]), this.data.height = t.height + 1, this.data.leaf = !1, Wi(this.data, this.toBBox);
  }
  _chooseSplitIndex(t, e, n) {
    let s, r = 1 / 0, o = 1 / 0;
    for (let a = e; a <= n - e; a++) {
      const h = Fn(t, 0, a, this.toBBox), l = Fn(t, a, n, this.toBBox), c = p_(h, l), u = ho(h) + ho(l);
      c < r ? (r = c, s = a, o = u < o ? u : o) : c === r && u < o && (o = u, s = a);
    }
    return s || n - e;
  }
  _chooseSplitAxis(t, e, n) {
    const s = t.leaf ? this.compareMinX : __, r = t.leaf ? this.compareMinY : m_, o = this._allDistMargin(t, e, n, s), a = this._allDistMargin(t, e, n, r);
  ...
  _condense(t) {
    for (let e = t.length - 1, n; e >= 0; e--)
      t[e].children.length === 0 ? e > 0 ? (n = t[e - 1].children, n.splice(n.indexOf(t[e]), 1)) : this.clear() : Wi(t[e], this.toBBox);
  }
}
function g_(i, t, e) {
  if (!e)
...
function Fn(i, t, e, n, s) {
  s || (s = qi(null)), s.minX = 1 / 0, s.minY = 1 / 0, s.maxX = -1 / 0, s.maxY = -1 / 0;
  for (let r = t; r < e; r++) {
...
function kc(i, t, e) {
  ...
  return n.src && yd ? (r = !0, n.decode().then(function() {
    s && t();
  }).catch(function(h) {
    s && (o ? t() : e());
...
class x_ extends Ir {
  ...
  replaceColor_(t) {
    ...
    s.scale(t, t), s.drawImage(e, 0, 0), s.globalCompositeOperation = "multiply", s.fillStyle = Jl(this.color_), s.fillRect(0, 0, n.width / t, n.height / t), s.globalCompositeOperation = "destination-in", s.drawImage(e, 0, 0), this.canvas_[t] = n;
  }
  unlistenImage_() {
...
function v_(i, t, e, n, s, r) {
  let o = sr.get(t, n, r);
  return o || (o = new x_(i, t, e, n, s, r), sr.set(t, n, r, o)), o;
}
class za extends Lc {
  constructor(t) {
    t = t || {};
    ...
    this.color_ = t.color !== void 0 ? nr(t.color) : null, this.iconImage_ = v_(
      o,
      a,
...
class E_ extends Nr {
  ...
  getRenderOrder() {
    return this.get(Xh.RENDER_ORDER);
  }
  getStyle() {
    return this.style_;
  }
  ...
  renderDeclutter(t) {
    t.declutterTree || (t.declutterTree = new Nc(9)), this.getRenderer().renderDeclutter(t);
  }
  setRenderOrder(t) {
    this.set(Xh.RENDER_ORDER, t);
  }
  setStyle(t) {
    let e;
    if (t === void 0)
      ...
      for (let r = 0; r < n; ++r) {
        const o = t[r];
        o instanceof wi ? s[r] = o : s[r] = Uh(o);
      }
      e = s;
    } else
      e = Uh(t);
    this.style_ = e, this.styleFunction_ = t === null ? void 0 : h_(this.style_), this.changed();
  }
}
const S_ = E_, fs = {
  BEGIN_GEOMETRY: 0,
  ...
  SET_STROKE_STYLE: 11,
  STROKE: 12
}, Gs = [fs.FILL], Ve = [fs.STROKE], gi = [fs.BEGIN_PATH], Yh = [fs.CLOSE_PATH], $ = fs;
class w_ {
  drawCustom(t, e, n, s) {
  }
  drawGeometry(t) {
...
class T_ extends $c {
  ...
  appendFlatPointCoordinates(t, e) {
    ...
    for (let a = 0, h = t.length; a < h; a += e)
      s[0] = t[a], s[1] = t[a + 1], Lr(n, s) && (r[o++] = s[0], r[o++] = s[1]);
    return o;
  }
  appendFlatLineCoordinates(t, e, n, s, r, o) {
    ...
    let f = !0, g, _, m;
    for (g = e + s; g < n; g += s)
      d[0] = t[g], d[1] = t[g + 1], m = wo(l, d), m !== _ ? (f && (a[h++] = c, a[h++] = u, f = !1), a[h++] = d[0], a[h++] = d[1]) : m === mt.INTERSECTING ? (a[h++] = d[0], a[h++] = d[1], f = !1) : f = !0, c = d[0], u = d[1], _ = m;
  ...
  reverseHitDetectionInstructions() {
    ...
    let s, r, o = -1;
    for (e = 0; e < n; ++e)
      s = t[e], r = s[0], r == $.END_GEOMETRY ? o = e : r == $.BEGIN_GEOMETRY && (s[2] = e, nd(this.hitDetectionInstructions, o, e), o = -1);
  }
  setFillStrokeStyle(t, e) {
    const n = this.state;
    if (t) {
  ...
  getBufferedMaxExtent() {
    if (!this.bufferedMaxExtent_ && (this.bufferedMaxExtent_ = Vl(this.maxExtent), this.maxLineWidth > 0)) {
      const t = this.resolution * (this.maxLineWidth + 1) / 2;
      Pr(this.bufferedMaxExtent_, t, this.bufferedMaxExtent_);
    }
...
class I_ extends gs {
  ...
  applyStroke(t) {
    t.lastStroke != null && t.lastStroke != this.coordinates.length && (this.instructions.push(Ve), t.lastStroke = this.coordinates.length), t.lastStroke = 0, super.applyStroke(t), this.instructions.push(gi);
  }
}
const A_ = I_;
class P_ extends gs {
  ...
  drawFlatCoordinatess_(t, e, n, s) {
    ...
    for (let l = 0; l < h; ++l) {
      ...
      this.instructions.push(f), this.hitDetectionInstructions.push(f), a && (this.instructions.push(Yh), this.hitDetectionInstructions.push(Yh)), e = c;
    }
  ...
  drawCircle(t, e) {
    ...
    const l = [$.CIRCLE, h];
    this.instructions.push(gi, l), this.hitDetectionInstructions.push(gi, l), n.fillStyle !== void 0 && (this.instructions.push(Gs), this.hitDetectionInstructions.push(Gs)), n.strokeStyle !== void 0 && (this.instructions.push(Ve), this.hitDetectionInstructions.push(Ve)), this.endGeometry(e);
  }
  drawPolygon(t, e) {
    const n = this.state, s = n.fillStyle, r = n.strokeStyle;
    if (s === void 0 && r === void 0)
...
class O_ extends gs {
  ...
  drawText(t, e) {
    ...
    if (r.placement === "line" && (h == "LineString" || h == "MultiLineString" || h == "Polygon" || h == "MultiPolygon")) {
      ...
      let f = r.padding;
      if (f != di && (r.scale[0] < 0 || r.scale[1] < 0)) {
  ...
  setTextStyle(t, e) {
    ...
    if (!t)
      ...
      n = this.textState_;
      const h = t.getFont() || rc;
      Zd(h);
      const l = t.getScaleArray();
      n.overflow = t.getOverflow(), n.font = h, n.maxAngle = t.getMaxAngle(), n.placement = t.getPlacement(), n.textAlign = t.getTextAlign(), n.justify = t.getJustify(), n.textBaseline = t.getTextBaseline() || hr, n.backgroundFill = t.getBackgroundFill(), n.backgroundStroke = t.getBackgroundStroke(), n.padding = t.getPadding() || di, n.scale = l === void 0 ? [1, 1] : l;
...
function G_() {
  ...
  i.width = 1, i.height = 1, Ki = i.getContext("2d");
}
class $_ extends k_ {
  constructor(t) {
  ...
  getImageData(t, e, n) {
    Ki || G_(), Ki.clearRect(0, 0, 1, 1);
    let s;
    try {
      Ki.drawImage(t, e, n, 1, 1, 0, 0, 1, 1), s = Ki.getImageData(0, 0, 1, 1).data;
    } catch {
      return Ki = null, null;
    }
    return s;
  ...
  clipUnrotated(t, e, n) {
    const s = Oi(n), r = Dr(n), o = Fr(n), a = Or(n);
...
const zc = $_;
function z_(i, t, e, n, s, r, o, a, h, l, c, u) {
  ...
  while (t < e - n && y + m < r);
  let x = m === 0 ? 0 : (r - y) / m;
  const v = Se(g, d, x), M = Se(_, f, x), C = t - n, S = y, T = r + a * h(l, s, c);
  for (; t < e - n && y + m < T; )
    p();
  x = m === 0 ? 0 : (T - y) / m;
  const P = Se(g, d, x), F = Se(_, f, x);
  let G;
  if (u) {
    const O = [v, M, P, F];
    Ma(O, 0, 4, 2, u, O, O), G = O[0] > O[2];
  } else
    G = v > P;
  ...
  for (let O = 0, I = s.length; O < I; ) {
    ...
    x = m === 0 ? 0 : (r + nt / 2 - y) / m;
    const w = Se(g, d, x), kt = Se(_, f, x);
    D.push([w, kt, nt / 2, X, gt]), r += nt;
  }
  return D;
}
const ji = Wt(), Ne = [], xe = [], ve = [], ke = [];
function Hh(i) {
...
function Zh(i, t) {
  return (t === "start" || t === "end") && !B_.test(i) && (t = t === "start" ? "left" : "right"), Bn[t];
}
function W_(i, t, e) {
  return e > 0 && i.push(`
`, ""), i.push(t, ""), i;
...
class j_ {
  ...
  createLabel(t, e, n, s) {
    ...
    const o = s ? this.strokeStates[s] : null, a = n ? this.fillStates[n] : null, h = this.textStates[e], l = this.pixelRatio, c = [
      h.scale[0] * l,
      h.scale[1] * l
    ], u = Array.isArray(t), d = h.justify ? Bn[h.justify] : Zh(
      Array.isArray(t) ? t[0] : t,
      h.textAlign || Jn
    ), f = s && o.lineWidth ? o.lineWidth : 0, g = u ? t : t.split(`
`).reduce(W_, []), { width: _, height: m, widths: y, heights: p, lineWidths: x } = Qd(
      h,
      g
    ), v = _ + f, M = [], C = (v + 2) * c[0], S = (m + f) * c[1], T = {
...
`) {
    ...
    return Array.prototype.push.apply(M, G), Array.prototype.push.apply(M, R), this.labels_[r] = T, T;
  }
  ...
  calculateImageOrLabelDimensions_(t, e, n, s, r, o, a, h, l, c, u, d, f, g, _, m) {
    a *= d[0], h *= d[1];
    let y = n - a, p = s - h;
    const x = r + l > t ? t - l : r, v = o + c > e ? e - c : o, M = g[3] + x * d[0] + g[1], C = g[0] + v * d[1] + g[2], S = y - g[3], T = p - g[0];
    (_ || u !== 0) && (Ne[0] = S, ke[0] = S, Ne[1] = T, xe[1] = T, xe[0] = S + M, ve[0] = xe[0], ve[1] = T + C, ke[1] = ve[1]);
    let P;
    return u !== 0 ? (P = Je(
      he(),
      n,
      ...
      -n,
      -s
    ), yt(P, Ne), yt(P, xe), yt(P, ve), yt(P, ke), ee(
      Math.min(Ne[0], xe[0], ve[0], ke[0]),
      Math.min(Ne[1], xe[1], ve[1], ke[1]),
      Math.max(Ne[0], xe[0], ve[0], ke[0]),
      Math.max(Ne[1], xe[1], ve[1], ke[1]),
      ji
    )) : ee(
      Math.min(S, S + M),
      Math.min(T, T + C),
  ...
  drawLabelWithPointPlacement_(t, e, n, s) {
    const r = this.textStates[e], o = this.createLabel(t, e, s, n), a = this.strokeStates[n], h = this.pixelRatio, l = Zh(
      Array.isArray(t) ? t[0] : t,
      r.textAlign || Jn
  ...
  execute_(t, e, n, s, r, o, a, h) {
    let l;
    this.pixelCoordinates_ && ii(n, this.renderedTransform_) ? l = this.pixelCoordinates_ : (this.pixelCoordinates_ || (this.pixelCoordinates_ = []), l = pi(
      this.coordinates,
      0,
    ...
    let c = 0;
    const u = s.length;
    let d = 0, f, g, _, m, y, p, x, v, M, C, S, T, P = 0, F = 0, G = null, R = null;
    ...
    for (; c < u; ) {
      ...
      switch (w[0]) {
        ...
        case $.CIRCLE:
          d = w[1];
          const K = l[d], it = l[d + 1], Le = l[d + 2], ne = l[d + 3], Mt = Le - K, _e = ne - it, Di = Math.sqrt(Mt * Mt + _e * _e);
          t.moveTo(K + Di, it), t.arc(K, it, Di, 0, 2 * Math.PI, !0), ++c;
          break;
        case $.CLOSE_PATH:
          t.closePath(), ++c;
          break;
        case $.CUSTOM:
          d = w[1], f = w[2];
          const Ms = w[3], Ni = w[4], Cs = w.length == 6 ? w[5] : void 0;
          O.geometry = Ms, O.feature = X, c in D || (D[c] = []);
          const Oe = D[c];
          Cs ? Cs(l, d, f, 2, Oe) : (Oe[0] = l[d], Oe[1] = l[d + 1], Oe.length = 2), Ni(Oe, O), ++c;
          break;
        case $.DRAW_IMAGE:
          d = w[1], f = w[2], v = w[3], g = w[4], _ = w[5];
          let wn = w[6];
          const Fe = w[7], Es = w[8], Ss = w[9], ws = w[10];
          let ki = w[11];
          const Yr = w[12];
          let Lt = w[13];
          const Ut = w[14], Ht = w[15];
          if (!v && w.length >= 20) {
            M = w[19], C = w[20], S = w[21], T = w[22];
            ...
            v = Gt.label, w[3] = v;
            const zi = w[23];
            g = (Gt.anchorX - zi) * this.pixelRatio, w[4] = g;
            const Xt = w[24];
            _ = (Gt.anchorY - Xt) * this.pixelRatio, w[5] = _, wn = v.height, w[6] = wn, Lt = v.width, w[13] = Lt;
          }
          let me;
          w.length > 25 && (me = w[25]);
          let Gi, ri, De;
          w.length > 17 ? (Gi = w[16], ri = w[17], De = w[18]) : (Gi = di, ri = !1, De = !1), ws && L ? ki += tt : !ws && !L && (ki -= tt);
          let $i = 0;
          for (; d < f; d += 2) {
            if (me && me[$i++] < Lt / this.pixelRatio)
              continue;
            ...
            if (h) {
              ...
              if (Ut === "obstacle") {
                ...
                if (Ht) {
                  ...
                  if (Xt = Ht[$t], delete Ht[$t], ye = Hh(Xt), h.collides(ye))
                    continue;
                }
                if (h.collides(Gt.declutterBox))
                  continue;
                Xt && (h.insert(ye), this.replayImageOrLabel_.apply(this, Xt)), h.insert(Gt.declutterBox);
              }
            }
          ...
          break;
        case $.DRAW_CHARS:
          const Ts = w[1], Rt = w[2], Vr = w[3], Fu = w[4];
          T = w[5];
          const Du = w[6], eh = w[7], ih = w[8];
          S = w[9];
          const qr = w[10];
          M = w[11], C = w[12];
          const nh = [
            w[13],
            w[13]
          ], Kr = this.textStates[C], Tn = Kr.font, Rn = [
            Kr.scale[0] * eh,
            Kr.scale[1] * eh
          ];
          let bn;
          Tn in this.widths_ ? bn = this.widths_[Tn] : (bn = {}, this.widths_[Tn] = bn);
          const sh = Pc(l, Ts, Rt, 2), rh = Math.abs(Rn[0]) * Rh(Tn, M, bn);
          if (Fu || rh <= sh) {
            const Gt = this.textStates[C].textAlign, zi = (sh - rh) * Bn[Gt], Xt = z_(
              l,
              Ts,
              Rt,
              2,
              ...
              if (Xt) {
                ...
                if (S)
                  for ($t = 0, Rs = Xt.length; $t < Rs; ++$t) {
                    Yt = Xt[$t], bs = Yt[4], Ot = this.createLabel(bs, C, "", S), g = Yt[2] + (Rn[0] < 0 ? -qr : qr), _ = Vr * Ot.height + (0.5 - Vr) * 2 * qr * Rn[1] / Rn[0] - ih;
                    ...
                    if (h && h.collides(pe.declutterBox))
                      break t;
                    ye.push([
                      t,
                      e,
                ...
                if (T)
                  for ($t = 0, Rs = Xt.length; $t < Rs; ++$t) {
                    Yt = Xt[$t], bs = Yt[4], Ot = this.createLabel(bs, C, T, ""), g = Yt[2], _ = Vr * Ot.height - ih;
                    const pe = this.calculateImageOrLabelDimensions_(
                      Ot.width,
                      Ot.height,
                      Yt[0],
                ...
                h && h.load(ye.map(Hh));
                for (let pe = 0, Nu = ye.length; pe < Nu; ++pe)
                  this.replayImageOrLabel_.apply(this, ye[pe]);
              }
          }
          ++c;
          break;
...
const U_ = j_, co = ["Polygon", "Circle", "LineString", "Image", "Text", "Default"];
class X_ {
  constructor(t, e, n, s, r, o) {
  ...
  forEachFeatureAtCoordinate(t, e, n, s, r, o) {
    ...
    let u;
    this.renderBuffer_ !== void 0 && (u = Wt(), $n(u, t), Pr(
      u,
      ...
      for (let T = 0, P = d.length; T < P; T++)
        if (S[d[T]] > 0) {
          if (!o || f !== "Image" && f !== "Text" || o.includes(M)) {
            const F = (d[T] - 3) / 4, G = s - F % a, R = s - (F / a | 0), D = r(M, C, G * G + R * R);
            if (D)
              return D;
          }
          c.clearRect(0, 0, a, a);
    ...
    for (m = _.length - 1; m >= 0; --m) {
      ...
      for (p = this.executorsByZIndex_[M], y = co.length - 1; y >= 0; --y)
        if (f = co[y], x = p[f], x !== void 0 && (v = x.executeHitDetection(
          c,
          h,
          n,
          g,
  ...
  execute(t, e, n, s, r, o, a) {
    ...
    h.sort(vi), this.maxExtent_ && (t.save(), this.clip(t, n)), o = o || co;
    let l, c, u, d, f, g;
...
function K_(i, t, e, n, s, r, o) {
  ...
  for (let m = 1; m <= d; ++m) {
    ...
    for (let C = 0, S = x.length; C < S; ++C) {
      const T = x[C], P = T.getGeometryFunction()(y);
...
class l0 extends zc {
  ...
  releaseCompositionContext_() {
    if (this.opacity_ !== 1) {
      ...
      this.context.globalAlpha = this.opacity_, this.context.drawImage(this.compositionContext_.canvas, 0, 0), this.context.globalAlpha = t, sc(this.compositionContext_), Kh.push(this.compositionContext_.canvas), this.compositionContext_ = null;
    }
  }
  renderDeclutter(t) {
  ...
  renderFrame(t, e) {
    ...
    vd(this.pixelTransform, 1 / n, 1 / n), sa(this.inversePixelTransform, this.pixelTransform);
    ...
    if (s.extent && this.clipping) {
      const _ = Ue(s.extent);
      g = At(_, t.extent), f = g && !ui(_, t.extent), f && this.clipUnrotated(this.compositionContext_, t, _);
    }
    ...
    return new Promise(
      function(e) {
        if (!this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
          ...
          if (f.getWrapX() && a.canWrapX() && !ui(g, h)) {
            let _ = h[0];
            const m = ot(g);
            let y = 0, p;
            for (; _ < g[0]; )
          ...
          this.hitDetectionImageData_ = K_(
            n,
            c,
        ...
        e(
          H_(t, this.renderedFeatures_, this.hitDetectionImageData_)
        );
      }.bind(this)
    );
  }
  ...
  prepareFrame(t) {
    ...
    _ === void 0 && (_ = J_);
    const m = l.center.slice(), y = Pr(
      h,
      g * u
    ), p = y.slice(), x = [y.slice()], v = c.getExtent();
    if (n.getWrapX() && c.canWrapX() && !ui(v, t.extent)) {
      const L = ot(v), O = Math.max(ot(y) / 2, L);
      y[0] = v[0] - O, y[2] = v[2] + O, ec(m, c);
      const I = Zl(x[0], c);
    ...
    if (this.ready && this.renderedResolution_ == u && this.renderedRevision_ == f && this.renderedRenderOrder_ == _ && ui(this.wrappedRenderedExtent_, y))
    ...
    let C;
    this.getLayer().getDeclutter() && (C = new qh(
      zo(u, d),
      y,
      u,
      d
    ...
    }.bind(this), G = ya(y), R = n.getFeaturesInExtent(G);
    _ && R.sort(_);
    for (let L = 0, O = R.length; L < O; ++L)
      F(R[L]);
    this.renderedFeatures_ = R, this.ready = P;
    const D = M.finish(), tt = new Jh(
      y,
      u,
      d,
      n.getOverlaps(),
    ...
    return C && (this.declutterExecutorGroup = new Jh(
      y,
      u,
      d,
      n.getOverlaps(),
...
class d0 {
  constructor(t) {
    this.rbush_ = new Nc(t), this.items_ = {};
  }
  insert(t, e) {
    const n = {
      minX: t[0],
...
class f0 extends ie {
  constructor(t) {
    super(), this.projection = st(t.projection), this.attributions_ = tl(t.attributions), this.attributionsCollapsible_ = t.attributionsCollapsible !== void 0 ? t.attributionsCollapsible : !0, this.loading = !1, this.state_ = t.state !== void 0 ? t.state : "ready", this.wrapX_ = t.wrapX !== void 0 ? t.wrapX : !1, this.interpolate_ = !!t.interpolate, this.viewResolver = null, this.viewRejector = null;
    const e = this;
...
function m0(i, t, e, n, s, r, o) {
  ...
  a.open(
    ...
    !0
  ), t.getType() == "arraybuffer" && (a.responseType = "arraybuffer"), a.withCredentials = _0, a.onload = function(h) {
...
class y0 extends jc {
  constructor(t) {
    ...
    }), this.on, this.once, this.un, this.loader_ = Ci, this.format_ = t.format, this.overlaps_ = t.overlaps === void 0 ? !0 : t.overlaps, this.url_ = t.url, t.loader !== void 0 ? this.loader_ = t.loader : this.url_ !== void 0 && (Y(this.format_, 7), this.loader_ = el(
      this.url_,
      this.format_
    )), this.strategy_ = t.strategy !== void 0 ? t.strategy : g0;
  ...
  getClosestFeatureToCoordinate(t, e) {
    ...
    return e = e || Mi, this.featuresRtree_.forEachInExtent(
      h,
      function(l) {
        if (e(l)) {
  ...
  setUrl(t) {
    Y(this.format_, 7), this.url_ = t, this.setLoader(el(t, this.format_));
  }
}
const Ri = y0;
class p0 extends Ir {
  ...
  getAlpha(t, e) {
    ...
    if (!n)
      ...
      return 1;
    const s = e - n + 1e3 / 60;
    return s >= this.transition_ ? 1 : lc(s / this.transition_);
  }
  inTransition(t) {
...
class x0 extends Uc {
  ...
  handleImageError_() {
    this.state = k.ERROR, this.unlistenImage_(), this.image_ = v0(), this.changed();
  }
  handleImageLoad_() {
    const t = this.image_;
  ...
  load() {
    this.state == k.ERROR && (this.state = k.IDLE, this.image_ = new Image(), this.crossOrigin_ !== null && (this.image_.crossOrigin = this.crossOrigin_)), this.state == k.IDLE && (this.state = k.LOADING, this.changed(), this.tileLoadFunction_(this, this.src_), this.unlisten_ = kc(
      this.image_,
      this.handleImageLoad_.bind(this),
      this.handleImageError_.bind(this)
    ));
...
class T0 extends C0 {
  ...
  pruneExceptNewestZ() {
    if (this.getCount() === 0)
      return;
    const t = this.peekFirstKey(), n = E0(t)[0];
    this.forEach(
      function(s) {
        s.tileCoord[0] !== n && (this.remove(Yc(s.tileCoord)), s.release());
      }.bind(this)
    );
  }
}
...
function Ui(i, t, e, n, s) {
  return s !== void 0 ? (s.minX = i, s.maxX = t, s.minY = e, s.maxY = n, s) : new qc(i, t, e, n);
}
const Kc = qc, nl = [
  "fullscreenchange",
...
class R0 extends fe {
  constructor(t) {
    ...
    this.button_ = document.createElement("button"), this.button_.title = s, this.button_.setAttribute("type", "button"), this.button_.appendChild(this.labelNode_), this.button_.addEventListener(
      ...
      this.handleClick_.bind(this),
      !1
    ), this.setClassName_(this.button_, this.isInFullscreen_), this.element.className = `${this.cssClassName_} ${Mn} ${kr}`, this.element.appendChild(this.button_);
  }
  handleClick_(t) {
  ...
  handleFullScreen_() {
    ...
    if (!!rl(e))
      if (ol(e))
        ...
        let n;
        this.source_ ? n = typeof this.source_ == "string" ? e.getElementById(this.source_) : this.source_ : n = t.getTargetElement(), this.keys_ ? b0(n) : Hc(n);
      }
  }
  handleFullScreenChange_() {
    ...
    this.isInFullscreen_ = ol(t.getOwnerDocument()), e !== this.isInFullscreen_ && (this.setClassName_(this.button_, this.isInFullscreen_), this.isInFullscreen_ ? (or(this.labelActiveNode_, this.labelNode_), this.dispatchEvent(sl.ENTERFULLSCREEN)) : (or(this.labelNode_, this.labelActiveNode_), this.dispatchEvent(sl.LEAVEFULLSCREEN)), t.updateSize());
  }
  setClassName_(t, e) {
  ...
  handleMapTargetChange_() {
    ...
    if (e) {
      ...
      rl(n) ? this.element.classList.remove(Sh) : this.element.classList.add(Sh);
      for (let s = 0, r = nl.length; s < r; ++s)
        t.push(
          U(n, nl[s], this.handleFullScreenChange_, this)
        );
...
function b0(i) {
  i.webkitRequestFullscreen ? i.webkitRequestFullscreen() : Hc(i);
}
function I0(i) {
  i.exitFullscreen ? i.exitFullscreen() : i.webkitExitFullscreen && i.webkitExitFullscreen();
}
const A0 = R0, fo = "units", P0 = [1, 2, 5], Ln = 25.4 / 0.28;
class L0 extends fe {
  constructor(t) {
    t = t || {};
    ...
    this.innerElement_ = document.createElement("div"), this.innerElement_.className = n + "-inner", this.element.className = n + " " + Mn, this.element.appendChild(this.innerElement_), this.viewState_ = null, this.minWidth_ = t.minWidth !== void 0 ? t.minWidth : 64, this.maxWidth_ = t.maxWidth, this.renderedVisible_ = !1, this.renderedWidth_ = void 0, this.renderedHTML_ = "", this.addChangeListener(fo, this.handleUnitsChanged_), this.setUnits(t.units || "metric"), this.scaleBar_ = t.bar || !1, this.scaleBarSteps_ = t.steps || 4, this.scaleBarText_ = t.text || !1, this.dpi_ = t.dpi || void 0;
  }
  getUnits() {
    return this.get(fo);
  }
  ...
  updateElement_() {
    ...
    for (; ; ) {
      ...
      if (d = P0[(u % 3 + 3) % 3] * x, f = Math.round(d / o), isNaN(f)) {
...
class jr extends ni {
  ...
  intersectsExtent(t) {
    ...
    if (At(t, e)) {
      const n = this.getCenter();
      return t[0] <= n[0] && t[2] >= n[0] || t[1] <= n[1] && t[3] >= n[1] ? !0 : oa(t, this.intersectsCoordinate.bind(this));
    }
    return !1;
  }
  setCenter(t) {
  ...
  rotate(t, e) {
    ...
    this.setCenter(
      Ma(n, 0, n.length, s, t, e, n)
    ), this.changed();
  }
  translate(t, e) {
    const n = this.getCenter(), s = this.getStride();
    this.setCenter(
      cc(n, 0, n.length, s, t, e, n)
    ), this.changed();
  }
}
jr.prototype.transform;
const D0 = jr;
class pr extends uc {
  constructor(t) {
...
class xr extends ni {
  ...
  getCoordinateAtM(t, e, n) {
    return this.layout != "XYM" && this.layout != "XYZM" || this.flatCoordinates.length === 0 ? null : (e = e !== void 0 ? e : !1, n = n !== void 0 ? n : !1, a_(
      this.flatCoordinates,
      0,
      this.ends_,
      this.stride,
  ...
  getLineString(t) {
    return t < 0 || this.ends_.length <= t ? null : new xi(
      this.flatCoordinates.slice(
        t === 0 ? 0 : this.ends_[t - 1],
        this.ends_[t]
      ),
...
class vr extends ni {
  ...
  getCoordinates(t) {
    let e;
    return t !== void 0 ? (e = this.getOrientedFlatCoordinates().slice(), $h(
      e,
      0,
      this.endss_,
      this.stride,
      t
    )) : e = this.flatCoordinates, Do(
      e,
      0,
      this.endss_,
      this.stride
  ...
  getInteriorPoints() {
    return new ja(this.getFlatInteriorPoints().slice(), "XYM");
  }
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      const t = this.flatCoordinates;
      sg(t, 0, this.endss_, this.stride) ? this.orientedFlatCoordinates_ = t : (this.orientedFlatCoordinates_ = t.slice(), this.orientedFlatCoordinates_.length = $h(
        this.orientedFlatCoordinates_,
        0,
        this.endss_,
        this.stride
...
function Ws(i, t, e) {
  ...
  if (r > o) {
    const h = Qi(i, n), l = Qi(i, s);
    return Bs(h, l);
  }
  let a = 0;
  if (n < r) {
    const h = Qi(i, n), l = Ji(i, r);
    a += Bs(h, l);
  }
  if (o < s) {
    const h = Ji(i, o), l = Qi(i, s);
    a += Bs(h, l);
  }
  for (let h = r; h < o - 1; ++h) {
    const l = Ji(i, h), c = Ji(i, h + 1);
    a += Bs(l, c);
  }
  return a;
}
...
function G0(i, t, e, n) {
  ...
  for (let u = 0; u < t.targets.length; ++u) {
    ...
    for (let m = 0; m < f.length - 1; ++m) {
      const y = f[m], p = f[m + 1], x = Qc(s, r, y, p);
  ...
  return go.index = a, go.endIndex = h, go;
}
function js(i, t, e, n) {
  const s = i[0], r = i[1];
  for (let o = 0, a = t.length - 1; o < a; ++o) {
    const h = t[o], l = t[o + 1], c = Qc(s, r, h, l);
...
const _o = { along: 0, squaredDistance: 0 };
function Qc(i, t, e, n) {
  const s = e[0], r = e[1], o = n[0], a = n[1], h = o - s, l = a - r;
  let c = 0, u = s, d = r;
  return (h !== 0 || l !== 0) && (c = dt(((i - s) * h + (t - r) * l) / (h * h + l * l), 0, 1), u += h * c, d += l * c), _o.along = c, _o.squaredDistance = ha(Re(i, t, u, d), 10), _o;
}
function Qi(i, t) {
  const e = i.length;
  let n = Math.floor(t);
...
class $0 extends si {
  constructor(t) {
    const e = t;
    e.stopDown || (e.stopDown = Pi), super(e), this.on, this.once, this.un, this.shouldHandle_ = !1, this.downPx_ = null, this.downTimeout_, this.lastDragTime_, this.pointerType_, this.freehand_ = !1, this.source_ = t.source ? t.source : null, this.features_ = t.features ? t.features : null, this.snapTolerance_ = t.snapTolerance ? t.snapTolerance : 12, this.type_ = t.type, this.mode_ = B0(this.type_), this.stopClick_ = !!t.stopClick, this.minPoints_ = t.minPoints ? t.minPoints : this.mode_ === "Polygon" ? 3 : 2, this.maxPoints_ = this.mode_ === "Circle" ? 2 : t.maxPoints ? t.maxPoints : 1 / 0, this.finishCondition_ = t.finishCondition ? t.finishCondition : Mi, this.geometryLayout_ = t.geometryLayout ? t.geometryLayout : "XY";
    let n = t.geometryFunction;
    if (!n) {
      const s = this.mode_;
      if (s === "Circle")
        n = function(r, o, a) {
          const h = o || new D0([NaN, NaN]), l = rt(r[0]), c = be(
            l,
            rt(r[r.length - 1])
          );
        ...
        let r;
        s === "Point" ? r = le : s === "LineString" ? r = xi : s === "Polygon" && (r = pn), n = function(o, a, h) {
    ...
    this.geometryFunction_ = n, this.dragVertexDelay_ = t.dragVertexDelay !== void 0 ? t.dragVertexDelay : 500, this.finishCoordinate_ = null, this.sketchFeature_ = null, this.sketchPoint_ = null, this.sketchCoords_ = null, this.sketchLine_ = null, this.sketchLineCoords_ = null, this.squaredClickTolerance_ = t.clickTolerance ? t.clickTolerance * t.clickTolerance : 36, this.overlay_ = new Ti({
      source: new Ri({
        useSpatialIndex: !1,
        wrapX: t.wrapX ? t.wrapX : !1
      }),
      style: t.style ? t.style : z0(),
      updateWhileInteracting: !0
    }), this.geometryName_ = t.geometryName, this.condition_ = t.condition ? t.condition : La, this.freehandCondition_, t.freehand ? this.freehandCondition_ = _r : this.freehandCondition_ = t.freehandCondition ? t.freehandCondition : wc, this.traceCondition_, this.setTrace(t.trace || !1), this.traceState_ = { active: !1 }, this.traceSource_ = t.traceSource || t.source || null, this.addChangeListener(ko.ACTIVE, this.updateState_);
  }
  setTrace(t) {
    let e;
    t ? t === !0 ? e = _r : e = t : e = bg, this.traceCondition_ = e;
  }
  setMap(t) {
  ...
  startDrawing_(t) {
    ...
    for (; t.length < n; )
      t.push(0);
    this.finishCoordinate_ = t, this.mode_ === "Point" ? this.sketchCoords_ = t.slice() : this.mode_ === "Polygon" ? (this.sketchCoords_ = [[t.slice(), t.slice()]], this.sketchLineCoords_ = this.sketchCoords_[0]) : this.sketchCoords_ = [t.slice(), t.slice()], this.sketchLineCoords_ && (this.sketchLine_ = new Te(new xi(this.sketchLineCoords_)));
...
const W0 = $0, hl = 0, Wn = 1, ll = [0, 0, 0, 0], an = [], mo = {
...
class j0 extends si {
  constructor(t) {
    super(t), this.on, this.once, this.un, this.boundHandleFeatureChange_ = this.handleFeatureChange_.bind(this), this.condition_ = t.condition ? t.condition : Rc, this.defaultDeleteCondition_ = function(n) {
      return wg(n) && Ig(n);
    }, this.deleteCondition_ = t.deleteCondition ? t.deleteCondition : this.defaultDeleteCondition_, this.insertVertexCondition_ = t.insertVertexCondition ? t.insertVertexCondition : _r, this.vertexFeature_ = null, this.vertexSegments_ = null, this.lastPixel_ = [0, 0], this.ignoreNextSingleClick_ = !1, this.featuresBeingModified_ = null, this.rBush_ = new yr(), this.pixelTolerance_ = t.pixelTolerance !== void 0 ? t.pixelTolerance : 10, this.snappedToVertex_ = !1, this.changingFeature_ = !1, this.dragSegments_ = [], this.overlay_ = new Ti({
      source: new Ri({
        useSpatialIndex: !1,
        wrapX: !!t.wrapX
      }),
  ...
  handlePointerAtPixel_(t, e, n) {
    ...
    if (!o) {
      const h = Ue(
        Ks(s, ll)
      ), l = e.getView().getResolution() * this.pixelTolerance_, c = ya(
        Pr(h, l, ll)
      );
    ...
    if (o && o.length > 0) {
      ...
      if (a || d <= this.pixelTolerance_) {
        ...
        if (f[j(l)] = !0, this.snapToPointer_ || (this.delta_[0] = c[0] - s[0], this.delta_[1] = c[1] - s[1]), h.geometry.getType() === "Circle" && h.index === Wn)
          ...
          const g = e.getPixelFromCoordinate(l[0]), _ = e.getPixelFromCoordinate(l[1]), m = be(u, g), y = be(u, _);
...
function cl(i, t, e) {
  ...
  const s = rt(i);
  return an[0] = rt(t.segment[0]), an[1] = rt(t.segment[1]), Wd(s, an);
}
function ul(i, t, e) {
  const n = t.geometry;
...
class V0 extends si {
  constructor(t) {
    t = t || {};
    const e = t;
    e.handleDownEvent || (e.handleDownEvent = Mi), e.stopDown || (e.stopDown = Pi), super(e), this.source_ = t.source ? t.source : null, this.vertex_ = t.vertex !== void 0 ? t.vertex : !0, this.edge_ = t.edge !== void 0 ? t.edge : !0, this.features_ = t.features ? t.features : null, this.featuresListenerKeys_ = [], this.featureChangeListenerKeys_ = {}, this.indexedFeaturesExtents_ = {}, this.pendingFeatures_ = {}, this.pixelTolerance_ = t.pixelTolerance !== void 0 ? t.pixelTolerance : 10, this.rBush_ = new yr(), this.GEOMETRY_SEGMENTERS_ = {
    ...
    if (this.edge_) {
      for (let _ = 0; _ < h; ++_) {
        ...
        if (y.feature.getGeometry().getType() === "Circle") {
          ...
          const [p, x] = y.segment;
          x && (po[0] = rt(p), po[1] = rt(x), m = ca(l, po));
        }
        if (m) {
          const p = be(l, m);
          p < u && (c = m, u = p);
...
const q0 = V0, K0 = 0.5, H0 = 10, fl = 0.25;
class Z0 {
  constructor(t, e, n, s, r, o) {
    ...
    const l = Oi(n), c = Dr(n), u = Fr(n), d = Or(n), f = this.transformInv_(l), g = this.transformInv_(c), _ = this.transformInv_(u), m = this.transformInv_(d), y = H0 + (o ? Math.max(
      0,
      Math.ceil(
        Math.log2(
          To(n) / (o * o * 256 * 256)
  ...
  addQuad_(t, e, n, s, r, o, a, h, l) {
    ...
    if (l > 0) {
      if (this.targetProj_.isGlobal() && this.targetWorldWidth_) {
        const m = Et([t, e, n, s]);
        g = ot(m) / this.targetWorldWidth_ > fl || g;
      }
      !f && this.sourceProj_.isGlobal() && u && (g = u > fl || g);
    }
    ...
    if (l > 0) {
      if (!g) {
        ...
        let p;
        f ? p = (yi(r[0], d) + yi(a[0], d)) / 2 - yi(y[0], d) : p = (r[0] + a[0]) / 2 - y[0];
...
function Q0() {
  if (xo === void 0) {
    ...
    i.globalCompositeOperation = "lighter", i.fillStyle = "rgba(210, 0, 0, 0.75)", gl(i, 4, 5, 4, 0), gl(i, 4, 5, 0, 5);
    const t = i.getImageData(0, 0, 3, 3).data;
    xo = vo(t, 0) || vo(t, 4) || vo(t, 8);
  }
  return xo;
}
function _l(i, t, e, n) {
...
function tm(i, t, e, n) {
  ...
  return (!isFinite(r) || r <= 0) && oa(e, function(o) {
    return r = _l(
      i,
      t,
      o,
...
function em(i, t, e, n, s, r, o, a, h, l, c, u) {
  const d = jt(
    Math.round(e * i),
    Math.round(e * t),
    tu
...
class im extends Uc {
  ...
  release() {
    this.canvas_ && (sc(this.canvas_.getContext("2d")), tu.push(this.canvas_), this.canvas_ = null), super.release();
  }
}
const Bo = im, Mo = {
...
class sm {
  constructor(t) {
    ...
    const n = t.extent;
    n !== void 0 && !this.origin_ && !this.origins_ && (this.origin_ = Oi(n)), Y(
      !this.origin_ && this.origins_ || this.origin_ && !this.origins_,
      18
    ), this.tileSizes_ = null, t.tileSizes !== void 0 && (this.tileSizes_ = t.tileSizes, Y(this.tileSizes_.length == this.resolutions_.length, 19)), this.tileSize_ = t.tileSize !== void 0 ? t.tileSize : this.tileSizes_ ? null : fa, Y(
  ...
  forEachTileCoordParentTileRange(t, e, n, s) {
    ...
    for (this.zoomFactor_ === 2 ? (o = t[1], a = t[2]) : h = this.getTileCoordExtent(t, s); l >= this.minZoom; ) {
      if (this.zoomFactor_ === 2 ? (o = Math.floor(o / 2), a = Math.floor(a / 2), r = Ui(o, o, a, a, n)) : r = this.getTileRangeForExtentAndZ(
        h,
        l,
        n
      ), e(l, r))
  ...
  getTileRangeForExtentAndZ(t, e, n) {
    ...
    const r = s[1], o = s[2];
    return this.getTileCoordForXYAndZ_(t[2], t[1], e, !0, s), Ui(
      r,
      s[1],
      o,
      s[2],
  ...
  getTileCoordForXYAndResolution_(t, e, n, s, r) {
    ...
    return s ? (c = Ps(c, $e) - 1, u = Ps(u, $e) - 1) : (c = As(c, $e), u = As(u, $e)), il(o, c, u, r);
  }
  getTileCoordForXYAndZ_(t, e, n, s, r) {
    ...
    return s ? (l = Ps(l, $e) - 1, c = Ps(c, $e) - 1) : (l = As(l, $e), c = As(c, $e)), il(n, l, c, r);
  }
...
function iu(i) {
  ...
  return t || (t = hm(i), i.setDefaultTileGrid(t)), t;
}
function rm(i, t, e) {
  const n = t[0], s = i.getTileCoordCenter(t), r = nu(e);
  if (Lr(r, s))
    return t;
  {
...
function am(i, t, e, n) {
  t = t !== void 0 ? t : gf, e = zt(e !== void 0 ? e : fa);
  const s = ue(i), r = ot(i);
...
class lm extends jc {
  constructor(t) {
    ...
    const e = [256, 256];
    this.tileGrid && zt(this.tileGrid.getTileSize(this.tileGrid.getMinZoom()), e), this.tileCache = new Vc(t.cacheSize || 0), this.tmpSize = [0, 0], this.key_ = t.key || "", this.tileOptions = {
  ...
  forEachLoadedTile(t, e, n, s) {
    ...
    for (let c = n.minX; c <= n.maxX; ++c)
      for (let u = n.minY; u <= n.maxY; ++u)
        h = Wr(e, c, u), l = !1, r.containsKey(h) && (a = r.get(h), l = a.getState() === k.LOADED, l && (l = s(a) !== !1)), l || (o = !1);
    return o;
  }
  ...
  getTileCoordForTileUrlFunction(t, e) {
    ...
    return this.getWrapX() && e.isGlobal() && (t = rm(n, t, e)), w0(t, n) ? t : null;
  }
  clear() {
...
class Xa extends um {
  constructor(t) {
    ...
    }), this.generateTileUrlFunction_ = this.tileUrlFunction === Xa.prototype.tileUrlFunction, this.tileLoadFunction = t.tileLoadFunction, t.tileUrlFunction && (this.tileUrlFunction = t.tileUrlFunction), this.urls = null, t.urls ? this.setUrls(t.urls) : t.url && this.setUrl(t.url), this.tileLoadingKeys_ = {};
  }
  getTileLoadFunction() {
  ...
  handleTileChange(t) {
    ...
    let r;
    s == k.LOADING ? (this.tileLoadingKeys_[n] = !0, r = Mo.TILELOADSTART) : n in this.tileLoadingKeys_ && (delete this.tileLoadingKeys_[n], r = s == k.ERROR ? Mo.TILELOADERROR : s == k.LOADED ? Mo.TILELOADEND : void 0), r != null && this.dispatchEvent(new cm(r, e));
  }
  ...
  setUrls(t) {
    ...
    const e = t.join(`
`);
    this.generateTileUrlFunction_ ? this.setTileUrlFunction(fm(t, this.tileGrid), e) : this.setKey(e);
  }
...
class _m extends gm {
  constructor(t) {
    super({
      ...
      state: t.state,
      tileGrid: t.tileGrid,
      tileLoadFunction: t.tileLoadFunction ? t.tileLoadFunction : mm,
      tilePixelRatio: t.tilePixelRatio,
      ...
      attributionsCollapsible: t.attributionsCollapsible,
      zDirection: t.zDirection
    }), this.crossOrigin = t.crossOrigin !== void 0 ? t.crossOrigin : null, this.tileClass = t.tileClass !== void 0 ? t.tileClass : Xc, this.tileCacheForProjection = {}, this.tileGridForProjection = {}, this.reprojectionErrorThreshold_ = t.reprojectionErrorThreshold, this.renderReprojectionEdges_ = !1;
  }
  canExpireCache() {
  ...
  getGutterForProjection(t) {
    return this.getProjection() && t && !we(this.getProjection(), t) ? 0 : this.getGutter();
  }
  getGutter() {
    return 0;
  }
  ...
  getOpaque(t) {
    return this.getProjection() && t && !we(this.getProjection(), t) ? !1 : super.getOpaque(t);
  }
  getTileGridForProjection(t) {
    const e = this.getProjection();
    if (this.tileGrid && (!e || we(e, t)))
      return this.tileGrid;
    {
      const n = j(t);
  ...
  getTileCacheForProjection(t) {
    ...
    {
      const n = j(t);
      return n in this.tileCacheForProjection || (this.tileCacheForProjection[n] = new Vc(
  ...
  getTileInternal(t, e, n, s, r) {
    let o = null;
    const a = Wr(t, e, n), h = this.getKey();
...
class vm extends zc {
  constructor(t) {
    super(t), this.extentChanged = !0, this.renderedExtent_ = null, this.renderedPixelRatio, this.renderedProjection = null, this.renderedRevision, this.renderedTiles = [], this.newTiles_ = !1, this.tmpExtent = Wt(), this.tmpTileRange_ = new Kc(0, 0, 0, 0);
  }
  isDrawableTile(t) {
  ...
  getData(t) {
    ...
    for (let d = c.getZForResolution(h.resolution); d >= c.getMinZoom(); --d) {
      ...
      if (!(g instanceof Xc || g instanceof Bo) || g instanceof Bo && g.getState() === k.EMPTY)
        return null;
  ...
  renderFrame(t, e) {
      ...
      for (let K = P.minY; K <= P.maxY; ++K) {
        ...
        if (this.isDrawableTile(it)) {
          ...
          if (it.getState() == k.LOADED) {
            ...
            let _e = it.inTransition(Mt);
            _e && n.opacity !== 1 && (it.endTransition(Mt), _e = !1), !this.newTiles_ && (_e || !this.renderedTiles.includes(it)) && (this.newTiles_ = !0);
          }
    ...
    const O = Yl(this.pixelTransform);
    this.useContainer(e, O, this.getBackground(t));
    const I = this.context, X = I.canvas;
    sa(this.inversePixelTransform, this.pixelTransform), Je(
      this.tempTransform,
      x / 2,
      v / 2,
      L,
    ...
    for (let kt = ct.length - 1; kt >= 0; --kt) {
      const K = ct[kt], it = u.getTilePixelSize(
        ...
        l,
        r
      ), ne = f.getResolution(K) / _, Mt = it[0] * ne * L, _e = it[1] * ne * L, Di = f.getTileCoordForCoordAndZ(
        Oi(T),
        K
      ), Ms = f.getTileCoordExtent(Di), Ni = yt(this.tempTransform, [
        p * (Ms[0] - T[0]) / _,
        p * (T[3] - Ms[3]) / _
      ]), Cs = p * u.getGutterForProjection(r), Oe = F[K];
      for (const wn in Oe) {
        const Fe = Oe[wn], Es = Fe.tileCoord, Ss = Di[1] - Es[1], ws = Math.round(Ni[0] - (Ss - 1) * Mt), ki = Di[2] - Es[2], Yr = Math.round(Ni[1] - (ki - 1) * _e), Lt = Math.round(Ni[0] - Ss * Mt), Ut = Math.round(Ni[1] - ki * _e), Ht = ws - Lt, me = Yr - Ut, Gi = g === K, ri = Gi && Fe.getAlpha(j(this), t.time) !== 1;
        let De = !1;
        if (!ri)
          if (nt) {
            w = [Lt, Ut, Lt + Ht, Ut, Lt + Ht, Ut + me, Lt, Ut + me];
            for (let $i = 0, Ts = nt.length; $i < Ts; ++$i)
              if (g !== K && K < gt[$i]) {
                const Rt = nt[$i];
                At(
                  [Lt, Ut, Lt + Ht, Ut + me],
  ...
  manageTilePyramid(t, e, n, s, r, o, a, h, l) {
    ...
    const u = t.wantedTiles[c], d = t.tileQueue, f = n.getMinZoom(), g = t.viewState.rotation, _ = g ? bo(
      t.viewState.center,
...
class Tm extends ym {
  constructor(t) {
    ...
    let s = t.urls;
    s === void 0 && t.url !== void 0 && (s = su(t.url)), super({
      attributions: t.attributions,
      attributionsCollapsible: t.attributionsCollapsible,
      cacheSize: t.cacheSize,
...
`);
  ...
  createFromWMTSTemplate(t) {
    ...
    e == "KVP" && Object.assign(n, {
      ...
      Format: this.format_
    }), t = e == "KVP" ? ml(t, n) : t.replace(/\{(\w+?)\}/g, function(o, a) {
    ...
    return function(o, a, h) {
      if (o) {
        ...
        Object.assign(l, r);
        let c = t;
        return e == "KVP" ? c = ml(c, l) : c = c.replace(/\{(\w+?)\}/g, function(u, d) {
          return l[d];
        }), c;
      } else
        return;
...
function bm(i, t) {
  ...
  n.TileMatrixSetLink.length > 1 ? "projection" in t ? r = n.TileMatrixSetLink.findIndex(function(R) {
    ...
    return L && O ? we(L, O) : tt == t.projection;
...
function ru(i, t, e) {
  ...
  let r;
  if (n && s && !we(n, s) ? r = (t ? i.clone() : i).transform(
    t ? n : s,
    t ? s : n
...
class Lm extends Pm {
  ...
  readFeatureFromObject(t, e) {
    ...
    const s = jo(n.geometry, e), r = new Te();
  ...
  writeFeatureObject(t, e) {
    ...
    return o && (n.geometry = Uo(o, e), delete r[t.getGeometryName()]), gn(r) || (n.properties = r), n;
  }
  writeFeaturesObject(t, e) {
    e = this.adaptOptions(e);
    const n = [];
...
function Dm(i) {
  return new xi(i.coordinates);
}
function Nm(i) {
  return new Ba(i.coordinates);
}
function km(i) {
  return new ja(i.coordinates);
}
function Gm(i) {
  return new Ua(i.coordinates);
}
function $m(i) {
...
class qm {
  constructor(t, e, n) {
    this.nbDraw = 0, this.maxNbDrwa = -1, this.map = t, this.drawElement = e, this.maxNbDrwa = n, this.source = new Ri(), this.vector = new Ti({
      source: this.source,
      style: new wi({
        fill: new Qe({
    ...
    }), this.map.addLayer(this.vector), this.modify = new Y0({ source: this.source }), this.map.addInteraction(this.modify), this.addInteraction();
  }
  removeInteraction() {
  ...
  addInteraction() {
    ...
    }), this.map.addInteraction(this.draw), this.snap = new q0({ source: this.source }), this.map.addInteraction(this.snap), this.draw.addEventListener("drawstart", this.couldContinueToDraw.bind(this));
  }
}
class Km {
  constructor(t, e) {
    this.data = {}, this.vectorSource = new Ri(), this.vectorLayer = new Ti(), this.map = t, fetch(e).then((n) => n.json()).then((n) => {
      this.vectorSource = new Ri({
        features: new Vm().readFeatures(n)
      }), this.vectorLayer = new Ti({
  ...
  styleFunction() {
    return new wi({
      image: new Fi({
        radius: 5,
        fill: void 0,
        stroke: new Ae({ color: "red", width: 1 })
      })
    });
  }
}
...
function at(i, t, e, n, s) {
  return n.push(i), Zm(t, e, n, s), n.pop();
}
function Jm(i) {
...
var bi = 1, Ii = 2, Hs = 3, Qm = 4, Yo = 5, yl = 6378137, ty = 6356752314e-3, pl = 0.0066943799901413165, jn = 484813681109536e-20, E = Math.PI / 2, ey = 0.16666666666666666, iy = 0.04722222222222222, ny = 0.022156084656084655, b = 1e-10, Ct = 0.017453292519943295, oe = 57.29577951308232, H = Math.PI / 4, ss = Math.PI * 2, ut = 3.14159265359, Dt = {};
Dt.greenwich = 0;
...
function ti(i, t) {
  if (i[t])
    return i[t];
  for (var e = Object.keys(i), n = t.toLowerCase().replace(xl, ""), s = -1, r, o; ++s < e.length; )
    if (r = e[s], o = r.toLowerCase().replace(xl, ""), o === n)
      return i[r];
}
function Vo(i) {
...
var rs = 1, hu = 2, lu = 3, Mr = 4, cu = 5, Va = -1, ry = /\s/, oy = /[A-Za-z]/, ay = /[A-Za-z84_]/, Ur = /[,\]]/, uu = /[\d\.E\-\+]/;
function Pe(i) {
  if (typeof i != "string")
...
Pe.prototype.afterItem = function(i) {
  ...
  if (i === "]") {
    this.level--, this.word !== null && (this.currentObject.push(this.word), this.word = null), this.state = rs, this.currentObject = this.stack.pop(), this.currentObject || (this.state = Va);
    return;
  }
};
...
function uy(i) {
  ...
  var a = function(l) {
    ...
    ["latitude_of_center", "Latitude_of_center"],
    ["lat0", "latitude_of_center", Me],
    ["longitude_of_center", "Longitude_Of_Center"],
    ["longitude_of_center", "Longitude_of_center"],
    ["longc", "longitude_of_center", Me],
    ["x0", "false_easting", o],
    ["y0", "false_northing", o],
    ["long0", "central_meridian", Me],
    ["lat0", "latitude_of_origin", Me],
    ["lat0", "standard_parallel_1", Me],
    ["lat1", "standard_parallel_1", Me],
    ["lat2", "standard_parallel_2", Me],
    ["azimuth", "Azimuth"],
    ["alpha", "azimuth", Me],
    ["srsCode", "name"]
  ];
  h.forEach(a), !i.long0 && i.longc && (i.projName === "Albers_Conic_Equal_Area" || i.projName === "Lambert_Azimuthal_Equal_Area") && (i.long0 = i.longc), !i.lat_ts && i.lat1 && (i.projName === "Stereographic_South_Pole" || i.projName === "Polar Stereographic (variant B)") && (i.lat0 = Me(i.lat1 > 0 ? 90 : -90), i.lat_ts = i.lat1);
}
function du(i) {
  var t = hy(i), e = t.shift(), n = t.shift();
  t.unshift(["name", n]), t.unshift(["type", e]);
  var s = {};
  return tn(t, s), uy(s), s;
}
function It(i) {
  var t = this;
  if (arguments.length === 2) {
    var e = arguments[1];
    typeof e == "string" ? e.charAt(0) === "+" ? It[i] = Vo(arguments[1]) : It[i] = du(arguments[1]) : It[i] = e;
...
var gy = ["PROJECTEDCRS", "PROJCRS", "GEOGCS", "GEOCCS", "PROJCS", "LOCAL_CS", "GEODCRS", "GEODETICCRS", "GEODETICDATUM", "ENGCRS", "ENGINEERINGCRS"];
function _y(i) {
  return gy.some(function(t) {
    return i.indexOf(t) > -1;
  });
}
var my = ["3857", "900913", "3785", "102113"];
function yy(i) {
  var t = ti(i, "authority");
  if (!!t) {
    var e = ti(t, "epsg");
    return e && my.indexOf(e) > -1;
  }
}
function py(i) {
...
function Fy(i, t, e, n) {
  ...
  n ? (i *= 1 - o * (ey + o * (iy + o * ny)), s = i * i, o = 0) : a = Math.sqrt(o);
  var h = (s - r) / r;
  return {
    es: o,
    e: a,
...
function Wy(i, t, e) {
  for (var n = 176, s = [], r = 0; r < t.nSubgrids; r++) {
    var o = Uy(i, n, e), a = Xy(i, n, o, e), h = Math.round(
      1 + (o.upperLongitude - o.lowerLongitude) / o.longitudeInterval
    ), l = Math.round(
      1 + (o.upperLatitude - o.lowerLatitude) / o.latitudeInterval
    );
    s.push({
      ll: [en(o.lowerLongitude), en(o.lowerLatitude)],
      del: [en(o.longitudeInterval), en(o.latitudeInterval)],
      lim: [h, l],
...
function jy(i) {
  return i.map(function(t) {
    return [en(t.longitudeShift), en(t.latitudeShift)];
  });
}
function Uy(i, t, e) {
  return {
    name: qo(i, t + 8, t + 16).trim(),
    parent: qo(i, t + 24, t + 24 + 8).trim(),
...
function ce(i, t) {
  ...
  var r = Dy(e.a, e.b, e.rf, e.ellps, e.sphere), o = Fy(r.a, r.b, r.rf, e.R_A), a = Gy(e.nadgrids), h = e.datum || Ny(
    e.datumCode,
    e.datum_params,
    r.a,
    r.b,
  ...
  Ml(this, e), Ml(this, n), this.a = r.a, this.b = r.b, this.rf = r.rf, this.sphere = r.sphere, this.es = o.es, this.e = o.e, this.ep2 = o.ep2, this.datum = h, this.init(), t(null, this);
}
ce.projections = Ly;
ce.projections.start();
function Yy(i, t) {
  return i.datum_type !== t.datum_type || i.a !== t.a || Math.abs(i.es - t.es) > 5e-11 ? !1 : i.datum_type === bi ? i.datum_params[0] === t.datum_params[0] && i.datum_params[1] === t.datum_params[1] && i.datum_params[2] === t.datum_params[2] : i.datum_type === Ii ? i.datum_params[0] === t.datum_params[0] && i.datum_params[1] === t.datum_params[1] && i.datum_params[2] === t.datum_params[2] && i.datum_params[3] === t.datum_params[3] && i.datum_params[4] === t.datum_params[4] && i.datum_params[5] === t.datum_params[5] && i.datum_params[6] === t.datum_params[6] : !0;
}
function _u(i, t, e) {
...
function mu(i, t, e, n) {
  var s = 1e-12, r = s * s, o = 30, a, h, l, c, u, d, f, g, _, m, y, p, x, v = i.x, M = i.y, C = i.z ? i.z : 0, S, T, P;
...
function Ky(i, t, e) {
  if (Yy(i, t) || i.datum_type === Yo || t.datum_type === Yo)
    return e;
  var n = i.a, s = i.es;
  if (i.datum_type === Hs) {
    var r = El(i, !1, e);
  ...
  if (t.datum_type === Hs && (o = yl, a = ty, h = pl), s === h && n === o && !Ys(i.datum_type) && !Ys(t.datum_type))
    return e;
  if (e = _u(e, s, n), Ys(i.datum_type) && (e = Vy(e, i.datum_type, i.datum_params)), Ys(t.datum_type) && (e = qy(e, t.datum_type, t.datum_params)), e = mu(e, h, o, a), t.datum_type === Hs) {
    var l = El(t, !0, e);
    if (l !== 0)
      return;
  }
...
function El(i, t, e) {
  ...
  for (var n = { x: -e.x, y: e.y }, s = { x: Number.NaN, y: Number.NaN }, r = [], o = 0; o < i.grids.length; o++) {
    ...
    if (!(u > n.y || c > n.x || f < n.y || d < n.x) && (s = Hy(n, t, h), !isNaN(s.x)))
      break;
  }
...
function Jy(i, t) {
  return (i.datum.datum_type === bi || i.datum.datum_type === Ii) && t.datumCode !== "WGS84" || (t.datum.datum_type === bi || t.datum.datum_type === Ii) && i.datumCode !== "WGS84";
}
function Er(i, t, e, n) {
  var s;
  if (Array.isArray(e) && (e = yu(e)), Zy(e), i.datum && t.datum && Jy(i, t) && (s = new ce("WGS84"), e = Er(i, s, e, n), i = s), n && i.axis !== "enu" && (e = wl(i, !1, e)), i.projName === "longlat")
    e = {
      x: e.x * Ct,
      y: e.y * Ct,
      z: e.z || 0
...
function Tt(i, t, e) {
  i = bl(i);
  var n = !1, s;
  return typeof t > "u" ? (t = i, i = Rl, n = !0) : (typeof t.x < "u" || Array.isArray(t)) && (e = t, t = i, i = Rl, n = !0), t = bl(t), e ? Co(i, t, e) : (s = {
...
var Il = 6, pu = "AJSAJS", xu = "AFAFAF", nn = 65, Ft = 73, Vt = 79, Nn = 86, kn = 90;
const Qy = {
  forward: vu,
  inverse: tp,
  toPoint: Mu
...
function np(i, t) {
  ...
  return i.zoneNumber + i.zoneLetter + sp(i.easting, i.northing, i.zoneNumber) + e.substr(e.length - 5, t) + n.substr(n.length - 5, t);
}
function sp(i, t, e) {
  var n = Cu(e), s = Math.floor(i / 1e5), r = Math.floor(t / 1e5) % 20;
  return rp(s, r, n);
}
function Cu(i) {
  var t = i % Il;
...
function rp(i, t, e) {
  var n = e - 1, s = pu.charCodeAt(n), r = xu.charCodeAt(n), o = s + i - 1, a = r + t, h = !1;
  o > kn && (o = o - kn + nn - 1, h = !0), (o === Ft || s < Ft && o > Ft || (o > Ft || s < Ft) && h) && o++, (o === Vt || s < Vt && o > Vt || (o > Vt || s < Vt) && h) && (o++, o === Ft && o++), o > kn && (o = o - kn + nn - 1), a > Nn ? (a = a - Nn + nn - 1, h = !0) : h = !1, (a === Ft || r < Ft && a > Ft || (a > Ft || r < Ft) && h) && a++, (a === Vt || r < Vt && a > Vt || (a > Vt || r < Vt) && h) && (a++, a === Ft && a++), a > Nn && (a = a - Nn + nn - 1);
...
function Eu(i) {
  ...
  e = i.substring(r, r += 2);
  for (var h = Cu(o), l = op(e.charAt(0), h), c = ap(e.charAt(1), h); c < hp(a); )
    c += 2e6;
  var u = t - r;
  if (u % 2 !== 0)
...
function op(i, t) {
  for (var e = pu.charCodeAt(t - 1), n = 1e5, s = !1; e !== i.charCodeAt(0); ) {
...
function ap(i, t) {
  ...
  for (var e = xu.charCodeAt(t - 1), n = 0, s = !1; e !== i.charCodeAt(0); ) {
...
xn.prototype.toMGRS = function(i) {
  return vu([this.x, this.y], i);
};
var lp = 1, cp = 0.25, Pl = 0.046875, Ll = 0.01953125, Ol = 0.01068115234375, up = 0.75, dp = 0.46875, fp = 0.013020833333333334, gp = 0.007120768229166667, _p = 0.3645833333333333, mp = 0.005696614583333333, yp = 0.3076171875;
function Su(i) {
  var t = [];
  t[0] = lp - i * (cp + i * (Pl + i * (Ll + i * Ol))), t[1] = i * (up - i * (Pl + i * (Ll + i * Ol)));
  var e = i * i;
  return t[2] = e * (dp - i * (fp + i * gp)), e *= i, t[3] = e * (_p - i * mp), t[4] = e * i * yp, t;
}
function Xr(i, t, e, n) {
...
var pp = 20;
function wu(i, t, e) {
  for (var n = 1 / (1 - t), s = i, r = pp; r; --r) {
    var o = Math.sin(s), a = 1 - t * o * o;
    if (a = (Xr(s, o, Math.cos(s), e) - i) * (a * Math.sqrt(a)) * n, s -= a, Math.abs(a) < b)
      return s;
  }
  return s;
}
function xp() {
  this.x0 = this.x0 !== void 0 ? this.x0 : 0, this.y0 = this.y0 !== void 0 ? this.y0 : 0, this.long0 = this.long0 !== void 0 ? this.long0 : 0, this.lat0 = this.lat0 !== void 0 ? this.lat0 : 0, this.es && (this.en = Su(this.es), this.ml0 = Xr(this.lat0, Math.sin(this.lat0), Math.cos(this.lat0), this.en));
}
function vp(i) {
...
function Mp(i) {
  ...
  if (this.es)
    if (t = this.ml0 + o / this.k0, e = wu(t, this.es, this.en), Math.abs(e) < E) {
...
var Cp = ["Fast_Transverse_Mercator", "Fast Transverse Mercator"];
const Js = {
  init: xp,
  forward: vp,
  inverse: Mp,
...
function Sp(i) {
  var t = Math.abs(i);
  return t = Ep(t * (1 + t / (Qt(1, t) + 1))), i < 0 ? -t : t;
}
function Ka(i, t) {
...
function Ru(i, t, e) {
  for (var n = Math.sin(t), s = Math.cos(t), r = Tu(e), o = Tp(e), a = 2 * s * o, h = -2 * n * r, l = i.length - 1, c = i[l], u = 0, d = 0, f = 0, g, _; --l >= 0; )
...
function Rp() {
  ...
  var n = Ka(this.cbg, this.lat0);
  this.Zb = -this.Qn * (n + wp(this.gtu, 2 * n));
}
function bp(i) {
  var t = A(i.x - this.long0), e = i.y;
  e = Ka(this.cbg, e);
  var n = Math.sin(e), s = Math.cos(e), r = Math.sin(t), o = Math.cos(t);
  e = Math.atan2(n, o * s), t = Math.atan2(r * s, Qt(n, s * o)), t = Sp(Math.tan(t));
  var a = Ru(this.gtu, 2 * e, 2 * t);
  e = e + a[0], t = t + a[1];
  var h, l;
...
function Ip(i) {
  ...
  if (Math.abs(t) <= 2.623395162778) {
    var r = Ru(this.utg, 2 * e, 2 * t);
    e = e + r[0], t = t + r[1], t = Math.atan(Tu(t));
    var o = Math.sin(e), a = Math.cos(e), h = Math.sin(t), l = Math.cos(t);
    e = Math.atan2(o * l, Qt(h, l * a)), t = Math.atan2(h, l * a), n = A(t + this.long0), s = Ka(this.cgb, e);
  } else
    n = 1 / 0, s = 1 / 0;
  return i.x = n, i.y = s, i;
}
var Ap = ["Extended_Transverse_Mercator", "Extended Transverse Mercator", "etmerc", "Transverse_Mercator", "Transverse Mercator", "tmerc"];
const Qs = {
  init: Rp,
  forward: bp,
  inverse: Ip,
...
var Fp = ["Universal Transverse Mercator System", "utm"];
const Dp = {
  init: Op,
  names: Fp,
  dependsOn: Lp
...
function kp() {
  ...
  t *= t, this.rc = Math.sqrt(1 - this.es) / (1 - this.es * i * i), this.C = Math.sqrt(1 + this.es * t * t / (1 - this.es)), this.phic0 = Math.asin(i / this.C), this.ratexp = 0.5 * this.C * this.e, this.K = Math.tan(0.5 * this.phic0 + H) / (Math.pow(Math.tan(0.5 * this.lat0 + H), this.C) * Ha(this.e * i, this.ratexp));
}
function Gp(i) {
  var t = i.x, e = i.y;
  return i.y = 2 * Math.atan(this.K * Math.pow(Math.tan(0.5 * e + H), this.C) * Ha(this.e * Math.sin(e), this.ratexp)) - E, i.x = this.C * t, i;
}
function $p(i) {
  for (var t = 1e-14, e = i.x / this.C, n = i.y, s = Math.pow(Math.tan(0.5 * n + H) / this.K, 1 / this.C), r = Np; r > 0 && (n = 2 * Math.atan(s * Ha(this.e * Math.sin(i.y), -0.5 * this.e)) - E, !(Math.abs(n - i.y) < t)); --r)
    i.y = n;
...
function Bp() {
  Za.init.apply(this), this.rc && (this.sinc0 = Math.sin(this.phic0), this.cosc0 = Math.cos(this.phic0), this.R2 = 2 * this.rc, this.title || (this.title = "Oblique Stereographic Alternative"));
}
function Wp(i) {
  var t, e, n, s;
  return i.x = A(i.x - this.long0), Za.forward.apply(this, [i]), t = Math.sin(i.y), e = Math.cos(i.y), n = Math.cos(i.x), s = this.k0 * this.R2 / (1 + this.sinc0 * t + this.cosc0 * e * n), i.x = s * e * Math.sin(i.x), i.y = s * (this.cosc0 * t - this.sinc0 * e * n), i.x = this.a * i.x + this.x0, i.y = this.a * i.y + this.y0, i;
}
function jp(i) {
  var t, e, n, s, r;
  if (i.x = (i.x - this.x0) / this.a, i.y = (i.y - this.y0) / this.a, i.x /= this.k0, i.y /= this.k0, r = Math.sqrt(i.x * i.x + i.y * i.y)) {
    ...
    s = this.phic0, n = 0;
  return i.x = n, i.y = s, Za.inverse.apply(this, [i]), i.x = A(i.x + this.long0), i;
}
var Up = ["Stereographic_North_Pole", "Oblique_Stereographic", "Polar_Stereographic", "sterea", "Oblique Stereographic Alternative", "Double_Stereographic"];
const Xp = {
  init: Bp,
  forward: Wp,
  inverse: jp,
...
var Hp = ["stere", "Stereographic_South_Pole", "Polar Stereographic (variant B)"];
const Zp = {
  init: Vp,
  forward: qp,
  inverse: Kp,
...
function s1() {
  ...
  this.no_off = n1(this), this.no_rot = "no_rot" in this;
  var p = !1;
  "alpha" in this && (p = !0);
  var x = !1;
  if ("rectified_grid_angle" in this && (x = !0), p && (y = this.alpha), x && (c = this.rectified_grid_angle * Ct), p || x)
    d = this.longc;
  else if (f = this.long1, _ = this.lat1, g = this.long2, m = this.lat2, Math.abs(_ - m) <= Hi || (i = Math.abs(_)) <= Hi || Math.abs(i - E) <= Hi || Math.abs(Math.abs(this.lat0) - E) <= Hi || Math.abs(Math.abs(m) - E) <= Hi)
    throw new Error();
  var v = 1 - this.es;
...
function r1(i) {
  ...
  if (i.x = i.x - this.lam0, Math.abs(Math.abs(i.y) - E) > b) {
    if (o = this.E / Math.pow(te(this.e, i.y, Math.sin(i.y)), this.B), a = 1 / o, e = 0.5 * (o - a), n = 0.5 * (o + a), r = Math.sin(this.B * i.x), s = (e * this.singam - r * this.cosgam) / n, Math.abs(Math.abs(s) - 1) < b)
      throw new Error();
    l = 0.5 * this.ArB * Math.log((1 - s) / (1 + s)), a = Math.cos(this.B * i.x), Math.abs(a) < Hi ? h = this.A * i.x : h = this.ArB * Math.atan2(e * this.cosgam + r * this.singam, a);
  } else
...
var a1 = ["Hotine_Oblique_Mercator", "Hotine Oblique Mercator", "Hotine_Oblique_Mercator_Azimuth_Natural_Origin", "Hotine_Oblique_Mercator_Two_Point_Natural_Origin", "Hotine_Oblique_Mercator_Azimuth_Center", "Oblique_Mercator", "omerc"];
const h1 = {
  init: s1,
  forward: r1,
  inverse: o1,
...
var C1 = ["Cassini", "Cassini_Soldner", "cass"];
const E1 = {
  init: x1,
  forward: v1,
  inverse: M1,
...
function b1() {
  ...
  if (Math.abs(i - E) < b ? this.mode = this.lat0 < 0 ? this.S_POLE : this.N_POLE : Math.abs(i) < b ? this.mode = this.EQUIT : this.mode = this.OBLIQ, this.es > 0) {
    var t;
    switch (this.qp = He(this.e, 1), this.mmf = 0.5 / (1 - this.es), this.apa = k1(this.es), this.mode) {
      case this.N_POLE:
        this.dd = 1;
        break;
      case this.S_POLE:
...
function A1(i) {
  ...
  if (this.sphere) {
    ...
    n = Math.atan2(t, e), s = G1(Math.asin(l), this.apa);
  }
  return i.x = A(this.long0 + n), i.y = s, i;
}
var P1 = 0.3333333333333333, L1 = 0.17222222222222222, O1 = 0.10257936507936508, F1 = 0.06388888888888888, D1 = 0.0664021164021164, N1 = 0.016415012942191543;
function k1(i) {
  var t, e = [];
  return e[0] = i * P1, t = i * i, e[0] += t * L1, e[1] = t * F1, t *= i, e[0] += t * O1, e[1] += t * D1, e[2] = t * N1, e;
}
function G1(i, t) {
  var e = i + i;
  return i + t[0] * Math.sin(e) + t[1] * Math.sin(e + e) + t[2] * Math.sin(e + e + e);
}
var $1 = ["Lambert Azimuthal Equal Area", "Lambert_Azimuthal_Equal_Area", "laea"];
const z1 = {
  init: b1,
  forward: I1,
  inverse: A1,
...
var X1 = ["Albers_Conic_Equal_Area", "Albers", "aea"];
const Y1 = {
  init: B1,
  forward: W1,
  inverse: j1,
...
function ex(i) {
  i.x -= this.x0, i.y -= this.y0;
  var t, e;
  return this.sphere ? (t = A(this.long0 + i.x / this.a / Math.cos(this.lat_ts)), e = Math.asin(i.y / this.a * Math.cos(this.lat_ts))) : (e = J1(this.e, 2 * i.y * this.k0 / this.a), t = A(this.long0 + i.x / (this.a * this.k0))), i.x = t, i.y = e, i;
}
var ix = ["cea"];
const nx = {
  init: Q1,
...
var ax = ["Equirectangular", "Equidistant_Cylindrical", "eqc"];
const hx = {
  init: sx,
  forward: rx,
  inverse: ox,
...
var yx = ["New_Zealand_Map_Grid", "nzmg"];
const px = {
  init: gx,
  forward: _x,
  inverse: mx,
...
var Cx = ["Miller_Cylindrical", "mill"];
const Ex = {
  init: xx,
  forward: vx,
  inverse: Mx,
...
var Sx = 20;
function wx() {
  this.sphere ? (this.n = 1, this.m = 0, this.es = 0, this.C_y = Math.sqrt((this.m + 1) / this.n), this.C_x = this.C_y / (this.m + 1)) : this.en = Su(this.es);
}
function Tx(i) {
  var t, e, n = i.x, s = i.y;
  if (n = A(n - this.long0), this.sphere) {
    if (!this.m)
      ...
      for (var r = this.n * Math.sin(s), o = Sx; o; --o) {
...
var jx = ["Van_der_Grinten_I", "VanDerGrinten", "vandg"];
const Ux = {
  init: zx,
  forward: Bx,
  inverse: Wx,
...
var sv = ["Quadrilateralized Spherical Cube", "Quadrilateralized_Spherical_Cube", "qsc"];
const rv = {
  init: ev,
  forward: iv,
  inverse: nv,
...
], bu = 0.8487, Iu = 1.3523, Au = oe / 5, ov = 1 / Au, sn = 18, wr = function(i, t) {
...
function cv(i) {
  var t = A(i.x - this.long0), e = Math.abs(i.y), n = Math.floor(e * Au);
  n < 0 ? n = 0 : n >= sn && (n = sn - 1), e = oe * (e - ov * n);
  var s = {
    x: wr(Ko[n], e) * t,
    y: wr(Gn[n], e)
  };
  return i.y < 0 && (s.y = -s.y), s.x = s.x * this.a * bu + this.x0, s.y = s.y * this.a * Iu + this.y0, s;
}
function uv(i) {
  var t = {
    x: (i.x - this.x0) / (this.a * bu),
    y: Math.abs(i.y - this.y0) / (this.a * Iu)
  };
  if (t.y >= 1)
    t.x /= Ko[sn][0], t.y = i.y < 0 ? -E : E;
  else {
    var e = Math.floor(t.y * sn);
    for (e < 0 ? e = 0 : e >= sn && (e = sn - 1); ; )
      if (Gn[e][0] > t.y)
        --e;
    ...
    s = hv(function(r) {
      return (wr(n, r) - t.y) / av(n, r);
    }, s, b, 100), t.x /= wr(Ko[e], s), t.y = (5 * e + s) * Ct, i.y < 0 && (t.y = -t.y);
  }
  return t.x = A(t.x + this.long0), t;
}
var dv = ["Robinson", "robin"];
const fv = {
  init: lv,
  forward: cv,
  inverse: uv,
...
function _v(i) {
  var t = _u(i, this.es, this.a);
  return t;
}
function mv(i) {
  var t = mu(i, this.es, this.a, this.b);
  return t;
}
var yv = ["Geocentric", "geocentric", "geocent", "Geocent"];
const pv = {
  init: gv,
  forward: _v,
  inverse: mv,
...
var Cv = ["Tilted_Perspective", "tpers"];
const Ev = {
  init: xv,
  forward: vv,
  inverse: Mv,
...
var Rv = ["Geostationary Satellite View", "Geostationary_Satellite", "geos"];
const bv = {
  init: Sv,
  forward: wv,
  inverse: Tv,
...
function Iv(i) {
  i.Proj.projections.add(Js), i.Proj.projections.add(Qs), i.Proj.projections.add(Dp), i.Proj.projections.add(Xp), i.Proj.projections.add(Zp), i.Proj.projections.add(i1), i.Proj.projections.add(h1), i.Proj.projections.add(f1), i.Proj.projections.add(p1), i.Proj.projections.add(E1), i.Proj.projections.add(z1), i.Proj.projections.add(Y1), i.Proj.projections.add(Z1), i.Proj.projections.add(nx), i.Proj.projections.add(hx), i.Proj.projections.add(fx), i.Proj.projections.add(px), i.Proj.projections.add(Ex), i.Proj.projections.add(Ix), i.Proj.projections.add(Fx), i.Proj.projections.add($x), i.Proj.projections.add(Ux), i.Proj.projections.add(Kx), i.Proj.projections.add(tv), i.Proj.projections.add(rv), i.Proj.projections.add(fv), i.Proj.projections.add(pv), i.Proj.projections.add(Ev), i.Proj.projections.add(bv);
}
...
class Av {
  constructor(t, e, n, s) {
    ...
    Tt.defs(
      ...
      const c = au(a).getElementsByTagName(
        "wfs:FeatureCollection"
      )[0].getElementsByTagName("wfs:member");
      for (let u = 0; u < c.length; u++) {
        const _ = c[u].getElementsByTagName("ms:geom")[0].getElementsByTagName("gml:Point")[0].getElementsByTagName("gml:pos")[0].innerHTML.split(" "), m = Tt("EPSG:2056", "SR-ORG:6864", [Number(_[0]), Number(_[1])]), y = new le(m), p = new Te({
          geometry: y,
          name: u,
          myCustomeValue: c[u]
        });
        p.setStyle(
          new wi({
            image: new Fi({
              radius: 5,
              fill: void 0,
              stroke: new Ae({ color: "green", width: 1 })
            })
          })
      ...
      r.setSource(o), this.map.addLayer(r), this.map.on("click", function(u) {
        ...
        !d || Ja.sendEvent("geocity-wfs-event", d);
      });
    });
  }
}
class Pv {
  constructor(t, e) {
    var s;
    this.vectorLayer = new Ti(), this.vectorSource = new Ri(), this.map = t, this.geolocation = e;
    const n = new Te();
    n.setStyle(
      new wi({
        image: new Fi({
  ...
  read(t) {
    if (t)
      if (typeof t == "string") {
        ...
        return Hm(t) ? this.readFromDocument(t) : this.readFromNode(t);
    else
      return null;
  }
  readFromDocument(t) {
...
const Pu = Ov, Fv = "http://www.w3.org/1999/xlink";
function Qa(i) {
  return i.getAttributeNS(Fv, "href");
}
function Dv(i) {
  const t = Ya(i, !1);
  return Nv(t);
...
const Nt = [null, "http://www.opengis.net/ows/1.1"], Gv = J(Nt, {
  ServiceIdentification: N(lM),
  ServiceProvider: N(uM),
  OperationsMetadata: N(aM)
});
class $v extends Pu {
  constructor() {
    super();
...
function oM(i, t) {
  const e = i.getAttribute("name"), n = at({}, Yv, i, t);
  if (!n)
    return;
...
const fM = $v, ge = [null, "http://www.opengis.net/wmts/1.0"], Sn = [null, "http://www.opengis.net/ows/1.1"], gM = J(ge, {
  Contents: N(TM)
});
class _M extends Pu {
  constructor() {
    super(), this.owsParser_ = new fM();
  }
  readFromNode(t) {
...
const mM = J(ge, {
  ...
  TileMatrixSet: N(q),
  TileMatrixSetLimits: N(DM)
}), vM = J(ge, {
  TileMatrixLimits: Xo(NM)
}), MM = J(ge, {
  TileMatrix: N(q),
  MinTileRow: N(qe),
  MaxTileRow: N(qe),
...
function OM(i, t) {
  const e = {};
  return e.format = i.getAttribute("format"), e.href = Qa(i), e;
}
function Ho(i, t) {
  const e = q(i).split(/\s+/);
  if (!e || e.length != 2)
...
let as = class extends _i {
  ...
  closeBox() {
    clearInterval(this.interval), Ja.sendEvent("close-information-box", {});
  }
};
as.styles = [ci($M)];
th([
...
var HM = Object.defineProperty, ZM = Object.getOwnPropertyDescriptor, vs = (i, t, e, n) => {
  for (var s = n > 1 ? void 0 : n ? ZM(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (s = (n ? o(t, e, s) : o(s)) || s);
  return n && s && HM(t, e, s), s;
};
let Ai = class extends _i {
  constructor() {
    super(), this.options = {
      zoom: 15,
      minZoom: 1,
  ...
  firstUpdated() {
    ...
    if (this.options.enableGeolocation) {
      this.geolocation = new o_({
        trackingOptions: {
          enableHighAccuracy: !0
        },
        projection: this.view.getProjection()
      }), this.geolocation.setTracking(!0), new Pv(i, this.geolocation), i.addControl(new Nl("Chargement des donn\xE9es GPS"));
      const e = setInterval(() => {
        var n;
        (n = this.geolocation) != null && n.getPosition() && (clearInterval(e), i.getControls().forEach((s) => {
          s instanceof Nl && i.removeControl(s);
        }));
      }, 200);
    }
    const t = [];
    this.options.wmts.capability != "" && new GM(i, this.options.wmts), this.options.displayZoom && t.push(new Cc()), this.options.enableCenterButton && t.push(new F0(this.geolocation)), this.options.enableRotation && t.push(new Lv(i, this.view)), t.push(new WM(i, this.options.information)), t.forEach((e) => i.addControl(e)), this.options.displayScaleLine && i.addControl(new O0({ units: "metric" })), this.options.fullscreen && i.addControl(new A0()), this.options.geojson.url != "" && new Km(i, this.options.geojson.url), this.options.wfs.url != "" && new Av(i, this.options.wfs.url, this.options.wfs.projection, this.options.wfs.projectionDefinition), this.options.enableDraw && new qm(i, this.options.drawElement, this.options.maxNbDraw);
  }
  render() {
    return Jo`
    <div id="map">
...
vs([
  Qu("#map")
], Ai.prototype, "mapElement", 2);
vs([
  br()
], Ai.prototype, "view", 2);
vs([
  br()
], Ai.prototype, "geolocation", 2);
vs([
  ta({ type: Object, attribute: "options" })
], Ai.prototype, "options", 2);
Ai = vs([
  Qo("openlayers-element")
], Ai);
export {
  Ai as OpenLayersElement
};
